...
namespace Server
{
	public class LootPack
	{
		...
		public static readonly LootPackItem[] NewFilthyRichItems = new LootPackItem[]
		{
			...
			new LootPackItem(typeof(UnidentifiedArmor), 100),
			new LootPackItem(typeof(UnidentifiedShield), 100),
			new LootPackItem(typeof(UnidentifiedJewelry), 100),
			new LootPackItem(typeof(UnidentifiedClothing), 100),
			new LootPackItem(typeof(UnidentifiedWeapon), 100),
			new LootPackItem(typeof(UnidentifiedPotion), 100),
			new LootPackItem(typeof(UnidentifiedCrystal), 100),
			new LootPackItem(typeof(UnidentifiedCuriosity), 100),
			new LootPackItem(typeof(UnidentifiedMagicMap), 100),
			new LootPackItem(typeof(UnidentifiedOrb), 100),
			new LootPackItem(typeof(UnidentifiedDocument), 100),
			new LootPackItem(typeof(UnidentifiedTreasure), 100),
			new LootPackItem(typeof(UnidentifiedArmor), 100),
			new LootPackItem(typeof(UnidentifiedShield), 100),
			new LootPackItem(typeof(UnidentifiedJewelry), 100),
			new LootPackItem(typeof(UnidentifiedClothing), 100),
