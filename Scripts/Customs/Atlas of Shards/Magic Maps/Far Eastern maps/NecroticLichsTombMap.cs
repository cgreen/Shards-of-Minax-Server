...
{
    public class NecroticLichsTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public NecroticLichsTombMap()
            : base(0x14EB, "Map to Necrotic Lichs Tomb", 650)
        {
        }

        public NecroticLichsTombMap(Serial serial)
            : base(serial)
        {
        }
