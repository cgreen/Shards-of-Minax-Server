...
{
    public class LairOfTheInfernoSentinelFortressMap : MagicMapBase
    {
        ...
        {
            new Point3D(5304, 496, 0),
            new Point3D(1495, 1738, 0),
            new Point3D(5661, 1078, 40)
        };
        ...
        [Constructable]
        public LairOfTheInfernoSentinelFortressMap()
            : base(0x14EB, "Map to Lair of the Inferno Sentinel Fortress", 650)
        {
        }

        public LairOfTheInfernoSentinelFortressMap(Serial serial)
            : base(serial)
        {
        }
