...
{
    public class NebulaCatsCelestialRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public NebulaCatsCelestialRealmMap()
            : base(0x14EB, "Map to Nebula Cats Celestial Realm", 650)
        {
        }

        public NebulaCatsCelestialRealmMap(Serial serial)
            : base(serial)
        {
        }
