...
{
    public class LairOfTheLibraBalanceBearMap : MagicMapBase
    {
        ...
        {
            new Point3D(993, 1929, 0),
            new Point3D(1454, 1662, 10),
            new Point3D(5850, 1424, 0)
        };
        ...
        [Constructable]
        public LairOfTheLibraBalanceBearMap()
            : base(0x14EB, "Map to Lair of the Libra Balance Bear", 650)
        {
        }

        public LairOfTheLibraBalanceBearMap(Serial serial)
            : base(serial)
        {
        }
