...
{
    public class LairOfTheInfernalToadSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheInfernalToadSwampMap()
            : base(0x14EB, "Map to Lair of the Infernal Toad Swamp", 650)
        {
        }

        public LairOfTheInfernalToadSwampMap(Serial serial)
            : base(serial)
        {
        }
