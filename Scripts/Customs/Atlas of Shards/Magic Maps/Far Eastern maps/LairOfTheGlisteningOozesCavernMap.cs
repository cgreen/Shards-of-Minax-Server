...
{
    public class LairOfTheGlisteningOozesCavernMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(5717, 439, 15),
            new Point3D(1242, 1595, 0)
        };
        ...
        [Constructable]
        public LairOfTheGlisteningOozesCavernMap()
            : base(0x14EB, "Map to Lair of the  Glistening Oozes Cavern", 650)
        {
        }

        public LairOfTheGlisteningOozesCavernMap(Serial serial)
            : base(serial)
        {
        }
