...
{
    public class LairOfTheIbexHighlandMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheIbexHighlandMap()
            : base(0x14EB, "Map to Lair of the Ibex Highland", 650)
        {
        }

        public LairOfTheIbexHighlandMap(Serial serial)
            : base(serial)
        {
        }
