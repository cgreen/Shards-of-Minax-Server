...
{
    public class LairOfTheNefertitisTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheNefertitisTombMap()
            : base(0x14EB, "Map to Lair of the  Nefertitis Tomb", 650)
        {
        }

        public LairOfTheNefertitisTombMap(Serial serial)
            : base(serial)
        {
        }
