...
{
    public class InfernoStallionArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernoStallionArenaMap()
            : base(0x14EB, "Map to Inferno Stallion Arena", 650)
        {
        }

        public InfernoStallionArenaMap(Serial serial)
            : base(serial)
        {
        }
