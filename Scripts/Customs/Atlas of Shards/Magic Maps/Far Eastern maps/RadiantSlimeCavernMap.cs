...
{
    public class RadiantSlimeCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public RadiantSlimeCavernMap()
            : base(0x14EB, "Map to Radiant Slime Cavern", 650)
        {
        }

        public RadiantSlimeCavernMap(Serial serial)
            : base(serial)
        {
        }
