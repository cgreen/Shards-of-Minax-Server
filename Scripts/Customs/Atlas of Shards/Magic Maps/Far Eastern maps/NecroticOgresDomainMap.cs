...
{
    public class NecroticOgresDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public NecroticOgresDomainMap()
            : base(0x14EB, "Map to Necrotic Ogres Domain", 650)
        {
        }

        public NecroticOgresDomainMap(Serial serial)
            : base(serial)
        {
        }
