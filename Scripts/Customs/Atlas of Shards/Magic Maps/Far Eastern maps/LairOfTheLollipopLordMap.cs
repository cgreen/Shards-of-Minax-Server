...
{
    public class LairOfTheLollipopLordMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheLollipopLordMap()
            : base(0x14EB, "Map to Lair of the Lollipop Lord", 650)
        {
        }

        public LairOfTheLollipopLordMap(Serial serial)
            : base(serial)
        {
        }
