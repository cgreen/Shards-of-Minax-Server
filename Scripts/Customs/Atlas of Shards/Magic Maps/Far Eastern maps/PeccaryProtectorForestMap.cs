...
{
    public class PeccaryProtectorForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public PeccaryProtectorForestMap()
            : base(0x14EB, "Map to Peccary Protector Forest", 650)
        {
        }

        public PeccaryProtectorForestMap(Serial serial)
            : base(serial)
        {
        }
