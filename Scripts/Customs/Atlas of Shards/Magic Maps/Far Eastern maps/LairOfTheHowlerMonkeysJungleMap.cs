...
{
    public class LairOfTheHowlerMonkeysJungleMap : MagicMapBase
    {
        ...
        {
            new Point3D(1569, 1504, 60),
            new Point3D(5938, 1677, 40),
            new Point3D(5829, 719, 20)
        };
        ...
        [Constructable]
        public LairOfTheHowlerMonkeysJungleMap()
            : base(0x14EB, "Map to Lair of the Howler Monkeys Jungle", 650)
        {
        }

        public LairOfTheHowlerMonkeysJungleMap(Serial serial)
            : base(serial)
        {
        }
