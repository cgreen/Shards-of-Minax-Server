...
{
    public class LairOfTheLuchadorLlamaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheLuchadorLlamaMap()
            : base(0x14EB, "Map to Lair of the Luchador Llama", 650)
        {
        }

        public LairOfTheLuchadorLlamaMap(Serial serial)
            : base(serial)
        {
        }
