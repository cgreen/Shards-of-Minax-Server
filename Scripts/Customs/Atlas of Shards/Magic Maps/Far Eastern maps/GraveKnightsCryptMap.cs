...
{
    public class GraveKnightsCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public GraveKnightsCryptMap()
            : base(0x14EB, "Map to Grave Knights Crypt", 650)
        {
        }

        public GraveKnightsCryptMap(Serial serial)
            : base(serial)
        {
        }
