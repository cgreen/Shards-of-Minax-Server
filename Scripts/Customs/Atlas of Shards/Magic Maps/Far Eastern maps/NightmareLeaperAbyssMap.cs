...
{
    public class NightmareLeaperAbyssMap : MagicMapBase
    {
        ...
        [Constructable]
        public NightmareLeaperAbyssMap()
            : base(0x14EB, "Map to Nightmare Leaper Abyss", 650)
        {
        }

        public NightmareLeaperAbyssMap(Serial serial)
            : base(serial)
        {
        }
