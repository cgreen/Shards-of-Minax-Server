...
{
    public class FleshEaterOgreTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public FleshEaterOgreTombMap()
            : base(0x14EB, "Map to Flesh Eater Ogre Tomb", 650)
        {
        }

        public FleshEaterOgreTombMap(Serial serial)
            : base(serial)
        {
        }
