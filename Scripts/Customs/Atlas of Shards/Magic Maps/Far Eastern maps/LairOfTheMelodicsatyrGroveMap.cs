...
{
    public class LairOfTheMelodicsatyrGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMelodicsatyrGroveMap()
            : base(0x14EB, "Map to Lair of the MelodicSatyr Grove", 650)
        {
        }

        public LairOfTheMelodicsatyrGroveMap(Serial serial)
            : base(serial)
        {
        }
