...
{
    public class LairOfTheInfernalLichCitadelMap : MagicMapBase
    {
        ...
        {
            new Point3D(5745, 2149, 10),
            new Point3D(5307, 141, 20),
        ...
        [Constructable]
        public LairOfTheInfernalLichCitadelMap()
            : base(0x14EB, "Map to Lair of the Infernal Lich Citadel", 650)
        {
        }

        public LairOfTheInfernalLichCitadelMap(Serial serial)
            : base(serial)
        {
        }
