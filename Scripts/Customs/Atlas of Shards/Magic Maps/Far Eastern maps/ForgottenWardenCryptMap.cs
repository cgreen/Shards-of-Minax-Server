...
{
    public class ForgottenWardenCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForgottenWardenCryptMap()
            : base(0x14EB, "Map to Forgotten Warden Crypt", 650)
        {
        }

        public ForgottenWardenCryptMap(Serial serial)
            : base(serial)
        {
        }
