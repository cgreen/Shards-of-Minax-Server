...
{
    public class PlasmaJuggernautsForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public PlasmaJuggernautsForgeMap()
            : base(0x14EB, "Map to Plasma Juggernauts Forge", 650)
        {
        }

        public PlasmaJuggernautsForgeMap(Serial serial)
            : base(serial)
        {
        }
