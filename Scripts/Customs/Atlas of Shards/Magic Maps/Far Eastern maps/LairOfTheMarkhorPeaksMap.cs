...
{
    public class LairOfTheMarkhorPeaksMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMarkhorPeaksMap()
            : base(0x14EB, "Map to Lair of the Markhor Peaks", 650)
        {
        }

        public LairOfTheMarkhorPeaksMap(Serial serial)
            : base(serial)
        {
        }
