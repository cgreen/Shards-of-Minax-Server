...
{
    public class QuantumGuardiansRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public QuantumGuardiansRealmMap()
            : base(0x14EB, "Map to Quantum Guardians Realm", 650)
        {
        }

        public QuantumGuardiansRealmMap(Serial serial)
            : base(serial)
        {
        }
