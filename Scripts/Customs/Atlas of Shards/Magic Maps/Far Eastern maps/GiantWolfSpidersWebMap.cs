...
{
    public class GiantWolfSpidersWebMap : MagicMapBase
    {
        ...
        [Constructable]
        public GiantWolfSpidersWebMap()
            : base(0x14EB, "Map to Giant Wolf Spiders Web", 650)
        {
        }

        public GiantWolfSpidersWebMap(Serial serial)
            : base(serial)
        {
        }
