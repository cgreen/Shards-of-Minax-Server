...
{
    public class RedtailedSquirrelGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public RedtailedSquirrelGroveMap()
            : base(0x14EB, "Map to Red-Tailed Squirrel Grove", 650)
        {
        }

        public RedtailedSquirrelGroveMap(Serial serial)
            : base(serial)
        {
        }
