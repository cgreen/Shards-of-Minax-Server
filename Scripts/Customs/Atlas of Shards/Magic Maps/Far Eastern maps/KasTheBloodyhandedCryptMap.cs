...
{
    public class KasTheBloodyhandedCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public KasTheBloodyhandedCryptMap()
            : base(0x14EB, "Map to Kas the Bloody-Handed Crypt", 650)
        {
        }

        public KasTheBloodyhandedCryptMap(Serial serial)
            : base(serial)
        {
        }
