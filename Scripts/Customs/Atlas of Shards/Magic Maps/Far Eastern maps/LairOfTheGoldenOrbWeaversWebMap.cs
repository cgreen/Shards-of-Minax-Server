...
{
    public class LairOfTheGoldenOrbWeaversWebMap : MagicMapBase
    {
        ...
        {
            new Point3D(5414, 2743, 0),
            new Point3D(5661, 1078, 40),
            new Point3D(5231, 706, 0)
        };
        ...
        [Constructable]
        public LairOfTheGoldenOrbWeaversWebMap()
            : base(0x14EB, "Map to Lair of the  Golden Orb Weavers Web", 650)
        {
        }

        public LairOfTheGoldenOrbWeaversWebMap(Serial serial)
            : base(serial)
        {
        }
