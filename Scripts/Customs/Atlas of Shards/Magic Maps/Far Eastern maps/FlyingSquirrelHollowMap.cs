...
{
    public class FlyingSquirrelHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public FlyingSquirrelHollowMap()
            : base(0x14EB, "Map to Flying Squirrel Hollow", 650)
        {
        }

        public FlyingSquirrelHollowMap(Serial serial)
            : base(serial)
        {
        }
