...
{
    public class PhantomAutomatonVaultMap : MagicMapBase
    {
        ...
        [Constructable]
        public PhantomAutomatonVaultMap()
            : base(0x14EB, "Map to Phantom Automaton Vault", 650)
        {
        }

        public PhantomAutomatonVaultMap(Serial serial)
            : base(serial)
        {
        }
