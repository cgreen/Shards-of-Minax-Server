...
{
    public class MireSpawnerMarshMap : MagicMapBase
    {
        ...
        [Constructable]
        public MireSpawnerMarshMap()
            : base(0x14EB, "Map to Mire Spawner Marsh", 650)
        {
        }

        public MireSpawnerMarshMap(Serial serial)
            : base(serial)
        {
        }
