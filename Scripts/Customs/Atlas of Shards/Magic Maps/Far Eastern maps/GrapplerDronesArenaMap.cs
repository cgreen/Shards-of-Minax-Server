...
{
    public class GrapplerDronesArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public GrapplerDronesArenaMap()
            : base(0x14EB, "Map to Grappler Drones Arena", 650)
        {
        }

        public GrapplerDronesArenaMap(Serial serial)
            : base(serial)
        {
        }
