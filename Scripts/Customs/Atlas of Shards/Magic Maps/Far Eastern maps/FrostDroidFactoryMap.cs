...
{
    public class FrostDroidFactoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostDroidFactoryMap()
            : base(0x14EB, "Map to Frost Droid Factory", 650)
        {
        }

        public FrostDroidFactoryMap(Serial serial)
            : base(serial)
        {
        }
