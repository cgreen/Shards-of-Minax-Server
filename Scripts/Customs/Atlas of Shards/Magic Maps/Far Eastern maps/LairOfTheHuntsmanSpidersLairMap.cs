...
{
    public class LairOfTheHuntsmanSpidersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheHuntsmanSpidersLairMap()
            : base(0x14EB, "Map to Lair of the Huntsman Spiders Lair", 650)
        {
        }

        public LairOfTheHuntsmanSpidersLairMap(Serial serial)
            : base(serial)
        {
        }
