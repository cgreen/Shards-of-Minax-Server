...
{
    public class IroncladDefendersFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public IroncladDefendersFortressMap()
            : base(0x14EB, "Map to Ironclad Defenders Fortress", 650)
        {
        }

        public IroncladDefendersFortressMap(Serial serial)
            : base(serial)
        {
        }
