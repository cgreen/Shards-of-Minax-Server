...
{
    public class LairOfTheMuckGolemMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMuckGolemMap()
            : base(0x14EB, "Map to Lair of the Muck Golem", 650)
        {
        }

        public LairOfTheMuckGolemMap(Serial serial)
            : base(serial)
        {
        }
