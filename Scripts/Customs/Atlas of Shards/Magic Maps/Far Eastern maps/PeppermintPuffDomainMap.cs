...
{
    public class PeppermintPuffDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public PeppermintPuffDomainMap()
            : base(0x14EB, "Map to Peppermint Puff Domain", 650)
        {
        }

        public PeppermintPuffDomainMap(Serial serial)
            : base(serial)
        {
        }
