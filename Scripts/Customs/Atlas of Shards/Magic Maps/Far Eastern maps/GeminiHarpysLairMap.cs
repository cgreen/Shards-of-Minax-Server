...
{
    public class GeminiHarpysLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public GeminiHarpysLairMap()
            : base(0x14EB, "Map to Gemini Harpys Lair", 650)
        {
        }

        public GeminiHarpysLairMap(Serial serial)
            : base(serial)
        {
        }
