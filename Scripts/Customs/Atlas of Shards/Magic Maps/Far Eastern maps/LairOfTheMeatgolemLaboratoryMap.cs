...
{
    public class LairOfTheMeatgolemLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMeatgolemLaboratoryMap()
            : base(0x14EB, "Map to Lair of the MeatGolem Laboratory", 650)
        {
        }

        public LairOfTheMeatgolemLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
