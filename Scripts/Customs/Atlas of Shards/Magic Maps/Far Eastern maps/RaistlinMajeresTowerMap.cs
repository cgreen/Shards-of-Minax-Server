...
{
    public class RaistlinMajeresTowerMap : MagicMapBase
    {
        ...
        [Constructable]
        public RaistlinMajeresTowerMap()
            : base(0x14EB, "Map to Raistlin Majeres Tower", 650)
        {
        }

        public RaistlinMajeresTowerMap(Serial serial)
            : base(serial)
        {
        }
