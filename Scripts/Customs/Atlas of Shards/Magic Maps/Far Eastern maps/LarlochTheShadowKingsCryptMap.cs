...
{
    public class LarlochTheShadowKingsCryptMap : MagicMapBase
    {
        ...
        {
            new Point3D(1023, 1509, 0),
            new Point3D(707, 1666, 15),
            new Point3D(1517, 1453, 0)
        };
        ...
        [Constructable]
        public LarlochTheShadowKingsCryptMap()
            : base(0x14EB, "Map to Larloch the Shadow Kings Crypt", 650)
        {
        }

        public LarlochTheShadowKingsCryptMap(Serial serial)
            : base(serial)
        {
        }
