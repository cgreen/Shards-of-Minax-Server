...
{
    public class LairOfTheMysticSatyrMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMysticSatyrMap()
            : base(0x14EB, "Map to Lair of the Mystic Satyr", 650)
        {
        }

        public LairOfTheMysticSatyrMap(Serial serial)
            : base(serial)
        {
        }
