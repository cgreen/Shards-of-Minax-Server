...
{
    public class FrostboundChampionsHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostboundChampionsHallMap()
            : base(0x14EB, "Map to Frostbound Champions Hall", 650)
        {
        }

        public FrostboundChampionsHallMap(Serial serial)
            : base(serial)
        {
        }
