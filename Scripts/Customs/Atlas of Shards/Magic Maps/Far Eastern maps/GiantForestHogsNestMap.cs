...
{
    public class GiantForestHogsNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public GiantForestHogsNestMap()
            : base(0x14EB, "Map to Giant Forest Hogs Nest", 650)
        {
        }

        public GiantForestHogsNestMap(Serial serial)
            : base(serial)
        {
        }
