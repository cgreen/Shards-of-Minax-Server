...
{
    public class KelthuzadsFrozenCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public KelthuzadsFrozenCitadelMap()
            : base(0x14EB, "Map to KelThuzads Frozen Citadel", 650)
        {
        }

        public KelthuzadsFrozenCitadelMap(Serial serial)
            : base(serial)
        {
        }
