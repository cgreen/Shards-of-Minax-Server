...
{
    public class IronGolemsWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public IronGolemsWorkshopMap()
            : base(0x14EB, "Map to Iron Golems Workshop", 650)
        {
        }

        public IronGolemsWorkshopMap(Serial serial)
            : base(serial)
        {
        }
