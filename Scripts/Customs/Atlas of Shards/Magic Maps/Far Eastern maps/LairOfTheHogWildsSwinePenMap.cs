...
{
    public class LairOfTheHogWildsSwinePenMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(579, 1375, 0),
            new Point3D(5268, 2019, -1)
        };
        ...
        [Constructable]
        public LairOfTheHogWildsSwinePenMap()
            : base(0x14EB, "Map to Lair of the Hog Wilds Swine Pen", 650)
        {
        }

        public LairOfTheHogWildsSwinePenMap(Serial serial)
            : base(serial)
        {
        }
