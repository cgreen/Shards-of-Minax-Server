...
{
    public class LairOfTheMalariaratDenMap : MagicMapBase
    {
        ...
        {
            new Point3D(864, 860, 0),
            new Point3D(707, 1666, 15),
            new Point3D(637, 742, 2)
        };
        ...
        [Constructable]
        public LairOfTheMalariaratDenMap()
            : base(0x14EB, "Map to Lair of the MalariaRat Den", 650)
        {
        }

        public LairOfTheMalariaratDenMap(Serial serial)
            : base(serial)
        {
        }
