...
{
    public class InfinitePouncersDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfinitePouncersDenMap()
            : base(0x14EB, "Map to Infinite Pouncers Den", 650)
        {
        }

        public InfinitePouncersDenMap(Serial serial)
            : base(serial)
        {
        }
