...
{
    public class GummySheepsPastureMap : MagicMapBase
    {
        ...
        [Constructable]
        public GummySheepsPastureMap()
            : base(0x14EB, "Map to Gummy Sheeps Pasture", 650)
        {
        }

        public GummySheepsPastureMap(Serial serial)
            : base(serial)
        {
        }
