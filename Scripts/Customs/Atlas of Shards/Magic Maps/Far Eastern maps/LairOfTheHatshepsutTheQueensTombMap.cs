...
{
    public class LairOfTheHatshepsutTheQueensTombMap : MagicMapBase
    {
        ...
        {
            new Point3D(1495, 1738, 0),
            new Point3D(5838, 188, 20),
            new Point3D(5737, 3011, 0)
        };
        ...
        [Constructable]
        public LairOfTheHatshepsutTheQueensTombMap()
            : base(0x14EB, "Map to Lair of the Hatshepsut the Queens Tomb", 650)
        {
        }

        public LairOfTheHatshepsutTheQueensTombMap(Serial serial)
            : base(serial)
        {
        }
