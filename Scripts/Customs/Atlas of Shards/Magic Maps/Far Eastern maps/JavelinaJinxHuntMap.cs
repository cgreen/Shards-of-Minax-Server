...
{
    public class JavelinaJinxHuntMap : MagicMapBase
    {
        ...
        [Constructable]
        public JavelinaJinxHuntMap()
            : base(0x14EB, "Map to Javelina Jinx Hunt", 650)
        {
        }

        public JavelinaJinxHuntMap(Serial serial)
            : base(serial)
        {
        }
