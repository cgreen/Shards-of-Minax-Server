...
{
    public class LeoTheSunBearsDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public LeoTheSunBearsDenMap()
            : base(0x14EB, "Map to Leo the Sun Bears Den", 650)
        {
        }

        public LeoTheSunBearsDenMap(Serial serial)
            : base(serial)
        {
        }
