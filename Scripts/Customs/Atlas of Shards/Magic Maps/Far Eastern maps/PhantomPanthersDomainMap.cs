...
{
    public class PhantomPanthersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public PhantomPanthersDomainMap()
            : base(0x14EB, "Map to Phantom Panthers Domain", 650)
        {
        }

        public PhantomPanthersDomainMap(Serial serial)
            : base(serial)
        {
        }
