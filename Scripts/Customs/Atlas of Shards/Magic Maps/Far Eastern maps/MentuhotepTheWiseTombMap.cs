...
{
    public class MentuhotepTheWiseTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public MentuhotepTheWiseTombMap()
            : base(0x14EB, "Map to Mentuhotep the Wise Tomb", 650)
        {
        }

        public MentuhotepTheWiseTombMap(Serial serial)
            : base(serial)
        {
        }
