...
{
    public class JellybeanJestersCarnivalMap : MagicMapBase
    {
        ...
        [Constructable]
        public JellybeanJestersCarnivalMap()
            : base(0x14EB, "Map to Jellybean Jesters Carnival", 650)
        {
        }

        public JellybeanJestersCarnivalMap(Serial serial)
            : base(serial)
        {
        }
