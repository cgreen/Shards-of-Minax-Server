...
{
    public class LairOfTheGloomWolfsDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheGloomWolfsDenMap()
            : base(0x14EB, "Map to Lair of the  Gloom Wolfs Den", 650)
        {
        }

        public LairOfTheGloomWolfsDenMap(Serial serial)
            : base(serial)
        {
        }
