...
{
    public class NecroticGeneralsBattlefieldMap : MagicMapBase
    {
        ...
        {
            new Point3D(5763, 1123, 0),
            new Point3D(5550, 106, 20),
            new Point3D(5238, 3682, 0)
        };
        ...
        [Constructable]
        public NecroticGeneralsBattlefieldMap()
            : base(0x14EB, "Map to Necrotic Generals Battlefield", 650)
        {
        }

        public NecroticGeneralsBattlefieldMap(Serial serial)
            : base(serial)
        {
        }
