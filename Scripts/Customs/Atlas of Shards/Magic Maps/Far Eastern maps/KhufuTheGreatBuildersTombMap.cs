...
{
    public class KhufuTheGreatBuildersTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public KhufuTheGreatBuildersTombMap()
            : base(0x14EB, "Map to Khufu the Great Builders Tomb", 650)
        {
        }

        public KhufuTheGreatBuildersTombMap(Serial serial)
            : base(serial)
        {
        }
