...
{
    public class NemesisUnitFacilityMap : MagicMapBase
    {
        ...
        [Constructable]
        public NemesisUnitFacilityMap()
            : base(0x14EB, "Map to Nemesis Unit Facility", 650)
        {
        }

        public NemesisUnitFacilityMap(Serial serial)
            : base(serial)
        {
        }
