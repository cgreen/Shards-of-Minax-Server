...
{
    public class IronSteedStablesMap : MagicMapBase
    {
        ...
        [Constructable]
        public IronSteedStablesMap()
            : base(0x14EB, "Map to Iron Steed Stables", 650)
        {
        }

        public IronSteedStablesMap(Serial serial)
            : base(serial)
        {
        }
