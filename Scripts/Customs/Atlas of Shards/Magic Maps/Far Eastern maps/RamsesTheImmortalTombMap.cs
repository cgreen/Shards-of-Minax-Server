...
{
    public class RamsesTheImmortalTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public RamsesTheImmortalTombMap()
            : base(0x14EB, "Map to Ramses the Immortal Tomb", 650)
        {
        }

        public RamsesTheImmortalTombMap(Serial serial)
            : base(serial)
        {
        }
