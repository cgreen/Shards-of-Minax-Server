...
{
    public class LairOfTheGibbonMysticsGroveMap : MagicMapBase
    {
        ...
        {
            new Point3D(5550, 106, 20),
            new Point3D(1701, 1630, 40),
        ...
        [Constructable]
        public LairOfTheGibbonMysticsGroveMap()
            : base(0x14EB, "Map to Lair of the  Gibbon Mystics Grove", 650)
        {
        }

        public LairOfTheGibbonMysticsGroveMap(Serial serial)
            : base(serial)
        {
        }
