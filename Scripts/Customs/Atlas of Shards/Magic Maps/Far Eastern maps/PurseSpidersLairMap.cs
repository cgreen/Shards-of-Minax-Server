...
{
    public class PurseSpidersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public PurseSpidersLairMap()
            : base(0x14EB, "Map to Purse Spiders Lair", 650)
        {
        }

        public PurseSpidersLairMap(Serial serial)
            : base(serial)
        {
        }
