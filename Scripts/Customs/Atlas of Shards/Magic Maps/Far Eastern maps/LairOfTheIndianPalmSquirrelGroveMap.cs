...
{
    public class LairOfTheIndianPalmSquirrelGroveMap : MagicMapBase
    {
        ...
        {
            new Point3D(5473, 965, 5),
            new Point3D(1408, 1505, 0),
            new Point3D(1454, 1662, 10)
        };
        ...
        [Constructable]
        public LairOfTheIndianPalmSquirrelGroveMap()
            : base(0x14EB, "Map to Lair of the Indian Palm Squirrel Grove", 650)
        {
        }

        public LairOfTheIndianPalmSquirrelGroveMap(Serial serial)
            : base(serial)
        {
        }
