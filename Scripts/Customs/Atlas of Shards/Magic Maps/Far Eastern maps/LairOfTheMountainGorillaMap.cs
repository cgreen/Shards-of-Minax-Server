...
{
    public class LairOfTheMountainGorillaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMountainGorillaMap()
            : base(0x14EB, "Map to Lair of the Mountain Gorilla", 650)
        {
        }

        public LairOfTheMountainGorillaMap(Serial serial)
            : base(serial)
        {
        }
