...
{
    public class FrostbiteWolfsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostbiteWolfsDomainMap()
            : base(0x14EB, "Map to Frostbite Wolfs Domain", 650)
        {
        }

        public FrostbiteWolfsDomainMap(Serial serial)
            : base(serial)
        {
        }
