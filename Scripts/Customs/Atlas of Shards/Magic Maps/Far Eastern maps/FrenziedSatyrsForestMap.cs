...
{
    public class FrenziedSatyrsForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrenziedSatyrsForestMap()
            : base(0x14EB, "Map to Frenzied Satyrs Forest", 650)
        {
        }

        public FrenziedSatyrsForestMap(Serial serial)
            : base(serial)
        {
        }
