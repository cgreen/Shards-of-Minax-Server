...
{
    public class GeminiTwinBearsDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public GeminiTwinBearsDenMap()
            : base(0x14EB, "Map to Gemini Twin Bears Den", 650)
        {
        }

        public GeminiTwinBearsDenMap(Serial serial)
            : base(serial)
        {
        }
