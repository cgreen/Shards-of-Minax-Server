...
{
    public class NightmarePanthersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public NightmarePanthersDomainMap()
            : base(0x14EB, "Map to Nightmare Panthers Domain", 650)
        {
        }

        public NightmarePanthersDomainMap(Serial serial)
            : base(serial)
        {
        }
