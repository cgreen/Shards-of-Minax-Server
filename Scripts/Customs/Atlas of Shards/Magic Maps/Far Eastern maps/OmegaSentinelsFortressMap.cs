...
{
    public class OmegaSentinelsFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public OmegaSentinelsFortressMap()
            : base(0x14EB, "Map to Omega Sentinels Fortress", 650)
        {
        }

        public OmegaSentinelsFortressMap(Serial serial)
            : base(serial)
        {
        }
