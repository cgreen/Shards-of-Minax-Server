...
{
    public class LairOfTheLibraHarpyMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheLibraHarpyMap()
            : base(0x14EB, "Map to Lair of the Libra Harpy", 650)
        {
        }

        public LairOfTheLibraHarpyMap(Serial serial)
            : base(serial)
        {
        }
