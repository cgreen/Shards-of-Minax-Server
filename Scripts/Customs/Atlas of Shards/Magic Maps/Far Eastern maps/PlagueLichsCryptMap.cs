...
{
    public class PlagueLichsCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public PlagueLichsCryptMap()
            : base(0x14EB, "Map to Plague Lichs Crypt", 650)
        {
        }

        public PlagueLichsCryptMap(Serial serial)
            : base(serial)
        {
        }
