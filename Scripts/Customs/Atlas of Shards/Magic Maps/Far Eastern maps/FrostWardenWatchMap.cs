...
{
    public class FrostWardenWatchMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostWardenWatchMap()
            : base(0x14EB, "Map to Frost Warden Watch", 650)
        {
        }

        public FrostWardenWatchMap(Serial serial)
            : base(serial)
        {
        }
