...
{
    public class GoliathBirdeatersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public GoliathBirdeatersLairMap()
            : base(0x14EB, "Map to Goliath Birdeaters Lair", 650)
        {
        }

        public GoliathBirdeatersLairMap(Serial serial)
            : base(serial)
        {
        }
