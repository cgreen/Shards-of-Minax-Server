...
{
    public class LeoTheHarpysLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public LeoTheHarpysLairMap()
            : base(0x14EB, "Map to Leo the Harpys Lair", 650)
        {
        }

        public LeoTheHarpysLairMap(Serial serial)
            : base(serial)
        {
        }
