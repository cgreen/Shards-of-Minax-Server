...
{
    public class LairOfTheMysticFallowMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheMysticFallowMap()
            : base(0x14EB, "Map to Lair of the Mystic Fallow", 650)
        {
        }

        public LairOfTheMysticFallowMap(Serial serial)
            : base(serial)
        {
        }
