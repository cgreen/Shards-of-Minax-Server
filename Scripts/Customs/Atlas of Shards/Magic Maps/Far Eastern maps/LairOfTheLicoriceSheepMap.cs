...
{
    public class LairOfTheLicoriceSheepMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheLicoriceSheepMap()
            : base(0x14EB, "Map to Lair of the Licorice Sheep", 650)
        {
        }

        public LairOfTheLicoriceSheepMap(Serial serial)
            : base(serial)
        {
        }
