...
{
    public class MetallicWindsteedPeaksMap : MagicMapBase
    {
        ...
        [Constructable]
        public MetallicWindsteedPeaksMap()
            : base(0x14EB, "Map to Metallic Windsteed Peaks", 650)
        {
        }

        public MetallicWindsteedPeaksMap(Serial serial)
            : base(serial)
        {
        }
