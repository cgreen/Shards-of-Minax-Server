...
{
    public class IroncladOgresDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public IroncladOgresDomainMap()
            : base(0x14EB, "Map to Ironclad Ogres Domain", 650)
        {
        }

        public IroncladOgresDomainMap(Serial serial)
            : base(serial)
        {
        }
