...
{
    public class OverlordMkiiStrongholdMap : MagicMapBase
    {
        ...
        [Constructable]
        public OverlordMkiiStrongholdMap()
            : base(0x14EB, "Map to Overlord MkII Stronghold", 650)
        {
        }

        public OverlordMkiiStrongholdMap(Serial serial)
            : base(serial)
        {
        }
