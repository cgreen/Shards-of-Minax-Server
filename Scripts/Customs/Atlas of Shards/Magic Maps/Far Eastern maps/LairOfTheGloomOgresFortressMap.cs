...
{
    public class LairOfTheGloomOgresFortressMap : MagicMapBase
    {
        ...
        {
            new Point3D(5473, 1144, 5),
            new Point3D(5938, 1677, 40),
            new Point3D(846, 1773, 0)
        };
        ...
        [Constructable]
        public LairOfTheGloomOgresFortressMap()
            : base(0x14EB, "Map to Lair of the  Gloom Ogres Fortress", 650)
        {
        }

        public LairOfTheGloomOgresFortressMap(Serial serial)
            : base(serial)
        {
        }
