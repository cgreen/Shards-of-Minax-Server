...
{
    public class LairOfTheHydrokineticWardensWaterShrineMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(621, 1884, 32),
            new Point3D(1141, 1421, 0)
        };
        ...
        [Constructable]
        public LairOfTheHydrokineticWardensWaterShrineMap()
            : base(0x14EB, "Map to Lair of the Hydrokinetic Wardens Water Shrine", 650)
        {
        }

        public LairOfTheHydrokineticWardensWaterShrineMap(Serial serial)
            : base(serial)
        {
        }
