...
{
    public class LairOfTheMandrillshamanJungleMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(749, 1493, 0),
            new Point3D(1397, 1941, 0)
        };
        ...
        [Constructable]
        public LairOfTheMandrillshamanJungleMap()
            : base(0x14EB, "Map to Lair of the MandrillShaman Jungle", 650)
        {
        }

        public LairOfTheMandrillshamanJungleMap(Serial serial)
            : base(serial)
        {
        }
