...
{
    public class OrangutanSageGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public OrangutanSageGroveMap()
            : base(0x14EB, "Map to Orangutan Sage Grove", 650)
        {
        }

        public OrangutanSageGroveMap(Serial serial)
            : base(serial)
        {
        }
