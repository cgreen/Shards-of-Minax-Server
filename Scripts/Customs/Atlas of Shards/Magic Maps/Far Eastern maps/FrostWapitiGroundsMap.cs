...
{
    public class FrostWapitiGroundsMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostWapitiGroundsMap()
            : base(0x14EB, "Map to Frost Wapiti Grounds", 650)
        {
        }

        public FrostWapitiGroundsMap(Serial serial)
            : base(serial)
        {
        }
