...
{
    public class ScorpioHarpysLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScorpioHarpysLairMap()
            : base(0x14EB, "Map to Scorpio Harpys Lair", 650)
        {
        }

        public ScorpioHarpysLairMap(Serial serial)
            : base(serial)
        {
        }
