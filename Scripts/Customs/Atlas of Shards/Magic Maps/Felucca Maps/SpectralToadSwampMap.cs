...
{
    public class SpectralToadSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpectralToadSwampMap()
            : base(0x14EB, "Map to Spectral Toad Swamp", 650)
        {
        }

        public SpectralToadSwampMap(Serial serial)
            : base(serial)
        {
        }
