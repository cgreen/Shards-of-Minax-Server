...
{
    public class GrymalkinTheWatchersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public GrymalkinTheWatchersDomainMap()
            : base(0x14EB, "Map to Grymalkin the Watchers Domain", 650)
        {
        }

        public GrymalkinTheWatchersDomainMap(Serial serial)
            : base(serial)
        {
        }
