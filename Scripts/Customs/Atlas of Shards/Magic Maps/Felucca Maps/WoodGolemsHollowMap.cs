...
{
    public class WoodGolemsHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public WoodGolemsHollowMap()
            : base(0x14EB, "Map to Wood Golems Hollow", 650)
        {
        }

        public WoodGolemsHollowMap(Serial serial)
            : base(serial)
        {
        }
