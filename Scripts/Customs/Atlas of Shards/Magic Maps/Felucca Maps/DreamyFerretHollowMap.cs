...
{
    public class DreamyFerretHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public DreamyFerretHollowMap()
            : base(0x14EB, "Map to Dreamy Ferret Hollow", 650)
        {
        }

        public DreamyFerretHollowMap(Serial serial)
            : base(serial)
        {
        }
