...
{
    public class VenomousWolfsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousWolfsLairMap()
            : base(0x14EB, "Map to Venomous Wolfs Lair", 650)
        {
        }

        public VenomousWolfsLairMap(Serial serial)
            : base(serial)
        {
        }
