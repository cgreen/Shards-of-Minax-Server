...
{
    public class LairOfTheYinsteedForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheYinsteedForestMap()
            : base(0x14EB, "Map to Lair of the YinSteed Forest", 650)
        {
        }

        public LairOfTheYinsteedForestMap(Serial serial)
            : base(serial)
        {
        }
