...
{
    public class GuernseyGuardianKeepMap : MagicMapBase
    {
        ...
        [Constructable]
        public GuernseyGuardianKeepMap()
            : base(0x14EB, "Map to Guernsey Guardian Keep", 650)
        {
        }

        public GuernseyGuardianKeepMap(Serial serial)
            : base(serial)
        {
        }
