...
{
    public class CycloneDemonPlainsMap : MagicMapBase
    {
        ...
        [Constructable]
        public CycloneDemonPlainsMap()
            : base(0x14EB, "Map to Cyclone Demon Plains", 650)
        {
        }

        public CycloneDemonPlainsMap(Serial serial)
            : base(serial)
        {
        }
