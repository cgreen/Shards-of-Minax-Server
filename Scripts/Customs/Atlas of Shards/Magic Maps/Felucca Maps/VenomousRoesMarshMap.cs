...
{
    public class VenomousRoesMarshMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousRoesMarshMap()
            : base(0x14EB, "Map to Venomous Roes Marsh", 650)
        {
        }

        public VenomousRoesMarshMap(Serial serial)
            : base(serial)
        {
        }
