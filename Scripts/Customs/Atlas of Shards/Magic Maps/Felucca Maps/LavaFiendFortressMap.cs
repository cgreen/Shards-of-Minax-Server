...
{
    public class LavaFiendFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public LavaFiendFortressMap()
            : base(0x14EB, "Map to Lava Fiend Fortress", 650)
        {
        }

        public LavaFiendFortressMap(Serial serial)
            : base(serial)
        {
        }
