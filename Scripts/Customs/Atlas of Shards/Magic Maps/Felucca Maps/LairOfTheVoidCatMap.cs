...
{
    public class LairOfTheVoidCatMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVoidCatMap()
            : base(0x14EB, "Map to Lair of the Void Cat", 650)
        {
        }

        public LairOfTheVoidCatMap(Serial serial)
            : base(serial)
        {
        }
