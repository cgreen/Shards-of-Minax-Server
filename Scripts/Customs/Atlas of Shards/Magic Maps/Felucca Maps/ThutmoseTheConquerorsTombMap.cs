...
{
    public class ThutmoseTheConquerorsTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThutmoseTheConquerorsTombMap()
            : base(0x14EB, "Map to Thutmose the Conquerors Tomb", 650)
        {
        }

        public ThutmoseTheConquerorsTombMap(Serial serial)
            : base(serial)
        {
        }
