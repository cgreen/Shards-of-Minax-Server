...
{
    public class TaffyTitansArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public TaffyTitansArenaMap()
            : base(0x14EB, "Map to Taffy Titans Arena", 650)
        {
        }

        public TaffyTitansArenaMap(Serial serial)
            : base(serial)
        {
        }
