...
{
    public class LairOfTheTempestsatyrsStormMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheTempestsatyrsStormMap()
            : base(0x14EB, "Map to Lair of the TempestSatyrs Storm", 650)
        {
        }

        public LairOfTheTempestsatyrsStormMap(Serial serial)
            : base(serial)
        {
        }
