...
{
    public class SagittariusArcherBearForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public SagittariusArcherBearForestMap()
            : base(0x14EB, "Map to Sagittarius Archer Bear Forest", 650)
        {
        }

        public SagittariusArcherBearForestMap(Serial serial)
            : base(serial)
        {
        }
