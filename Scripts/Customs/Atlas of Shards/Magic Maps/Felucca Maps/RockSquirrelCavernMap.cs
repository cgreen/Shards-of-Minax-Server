...
{
    public class RockSquirrelCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public RockSquirrelCavernMap()
            : base(0x14EB, "Map to Rock Squirrel Cavern", 650)
        {
        }

        public RockSquirrelCavernMap(Serial serial)
            : base(serial)
        {
        }
