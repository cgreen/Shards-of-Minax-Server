...
{
    public class MilkingDemonStablesMap : MagicMapBase
    {
        ...
        [Constructable]
        public MilkingDemonStablesMap()
            : base(0x14EB, "Map to Milking Demon Stables", 650)
        {
        }

        public MilkingDemonStablesMap(Serial serial)
            : base(serial)
        {
        }
