...
{
    public class GraniteColossusCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public GraniteColossusCavernMap()
            : base(0x14EB, "Map to Granite Colossus Cavern", 650)
        {
        }

        public GraniteColossusCavernMap(Serial serial)
            : base(serial)
        {
        }
