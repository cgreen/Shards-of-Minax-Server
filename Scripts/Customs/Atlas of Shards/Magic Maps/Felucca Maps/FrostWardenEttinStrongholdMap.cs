...
{
    public class FrostWardenEttinStrongholdMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostWardenEttinStrongholdMap()
            : base(0x14EB, "Map to Frost Warden Ettin Stronghold", 650)
        {
        }

        public FrostWardenEttinStrongholdMap(Serial serial)
            : base(serial)
        {
        }
