...
{
    public class GiantTrapdoorSpiderLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public GiantTrapdoorSpiderLairMap()
            : base(0x14EB, "Map to Giant Trapdoor Spider Lair", 650)
        {
        }

        public GiantTrapdoorSpiderLairMap(Serial serial)
            : base(serial)
        {
        }
