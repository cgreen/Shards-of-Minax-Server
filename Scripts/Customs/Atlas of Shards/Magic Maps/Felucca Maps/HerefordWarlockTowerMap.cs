...
{
    public class HerefordWarlockTowerMap : MagicMapBase
    {
        ...
        [Constructable]
        public HerefordWarlockTowerMap()
            : base(0x14EB, "Map to Hereford Warlock Tower", 650)
        {
        }

        public HerefordWarlockTowerMap(Serial serial)
            : base(serial)
        {
        }
