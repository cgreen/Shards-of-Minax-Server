...
{
    public class LairOfTheSoulEaterLichMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSoulEaterLichMap()
            : base(0x14EB, "Map to Lair of the Soul Eater Lich", 650)
        {
        }

        public LairOfTheSoulEaterLichMap(Serial serial)
            : base(serial)
        {
        }
