...
{
    public class ScorpioVenomBearsDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScorpioVenomBearsDenMap()
            : base(0x14EB, "Map to Scorpio Venom Bear’s Den", 650)
        {
        }

        public ScorpioVenomBearsDenMap(Serial serial)
            : base(serial)
        {
        }
