...
{
    public class TsunamiTitansDeepMap : MagicMapBase
    {
        ...
        [Constructable]
        public TsunamiTitansDeepMap()
            : base(0x14EB, "Map to Tsunami Titans Deep", 650)
        {
        }

        public TsunamiTitansDeepMap(Serial serial)
            : base(serial)
        {
        }
