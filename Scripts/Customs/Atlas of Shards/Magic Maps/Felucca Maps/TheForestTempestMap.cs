...
{
    public class TheForestTempestMap : MagicMapBase
    {
        ...
        [Constructable]
        public TheForestTempestMap()
            : base(0x14EB, "Map to The Forest Tempest", 650)
        {
        }

        public TheForestTempestMap(Serial serial)
            : base(serial)
        {
        }
