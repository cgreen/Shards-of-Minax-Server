...
{
    public class HuntsmanSpidersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public HuntsmanSpidersLairMap()
            : base(0x14EB, "Map to Huntsman Spiders Lair", 650)
        {
        }

        public HuntsmanSpidersLairMap(Serial serial)
            : base(serial)
        {
        }
