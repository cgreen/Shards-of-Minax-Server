...
{
    public class ShadowbladeAssassinsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowbladeAssassinsLairMap()
            : base(0x14EB, "Map to Shadowblade Assassins Lair", 650)
        {
        }

        public ShadowbladeAssassinsLairMap(Serial serial)
            : base(serial)
        {
        }
