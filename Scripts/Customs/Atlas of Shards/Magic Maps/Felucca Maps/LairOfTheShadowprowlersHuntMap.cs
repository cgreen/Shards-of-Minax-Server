...
{
    public class LairOfTheShadowprowlersHuntMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheShadowprowlersHuntMap()
            : base(0x14EB, "Map to Lair of the ShadowProwlers Hunt", 650)
        {
        }

        public LairOfTheShadowprowlersHuntMap(Serial serial)
            : base(serial)
        {
        }
