...
{
    public class WoodlandChargerDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public WoodlandChargerDomainMap()
            : base(0x14EB, "Map to Woodland Charger Domain", 650)
        {
        }

        public WoodlandChargerDomainMap(Serial serial)
            : base(serial)
        {
        }
