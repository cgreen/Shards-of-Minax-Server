...
{
    public class EmberSerpentLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public EmberSerpentLairMap()
            : base(0x14EB, "Map to Ember Serpent Lair", 650)
        {
        }

        public EmberSerpentLairMap(Serial serial)
            : base(serial)
        {
        }
