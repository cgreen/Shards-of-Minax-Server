...
{
    public class LairOfTheSombreroDeSolLlamaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSombreroDeSolLlamaMap()
            : base(0x14EB, "Map to Lair of the Sombrero de Sol Llama", 650)
        {
        }

        public LairOfTheSombreroDeSolLlamaMap(Serial serial)
            : base(serial)
        {
        }
