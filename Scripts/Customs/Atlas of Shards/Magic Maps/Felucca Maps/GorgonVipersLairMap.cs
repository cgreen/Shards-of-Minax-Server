...
{
    public class GorgonVipersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public GorgonVipersLairMap()
            : base(0x14EB, "Map to Gorgon Vipers Lair", 650)
        {
        }

        public GorgonVipersLairMap(Serial serial)
            : base(serial)
        {
        }
