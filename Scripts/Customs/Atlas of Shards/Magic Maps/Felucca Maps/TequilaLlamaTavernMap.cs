...
{
    public class TequilaLlamaTavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public TequilaLlamaTavernMap()
            : base(0x14EB, "Map to Tequila Llama Tavern", 650)
        {
        }

        public TequilaLlamaTavernMap(Serial serial)
            : base(serial)
        {
        }
