...
{
    public class ElderTendrilSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public ElderTendrilSwampMap()
            : base(0x14EB, "Map to Elder Tendril Swamp", 650)
        {
        }

        public ElderTendrilSwampMap(Serial serial)
            : base(serial)
        {
        }
