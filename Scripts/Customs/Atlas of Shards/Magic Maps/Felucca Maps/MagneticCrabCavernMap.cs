...
{
    public class MagneticCrabCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public MagneticCrabCavernMap()
            : base(0x14EB, "Map to Magnetic Crab Cavern", 650)
        {
        }

        public MagneticCrabCavernMap(Serial serial)
            : base(serial)
        {
        }
