...
{
    public class StormBoneFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormBoneFortressMap()
            : base(0x14EB, "Map to Storm Bone Fortress", 650)
        {
        }

        public StormBoneFortressMap(Serial serial)
            : base(serial)
        {
        }
