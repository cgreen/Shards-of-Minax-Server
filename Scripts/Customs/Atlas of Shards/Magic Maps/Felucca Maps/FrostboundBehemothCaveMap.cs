...
{
    public class FrostboundBehemothCaveMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostboundBehemothCaveMap()
            : base(0x14EB, "Map to Frostbound Behemoth Cave", 650)
        {
        }

        public FrostboundBehemothCaveMap(Serial serial)
            : base(serial)
        {
        }
