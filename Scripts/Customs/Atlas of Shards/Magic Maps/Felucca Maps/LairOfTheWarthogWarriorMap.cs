...
{
    public class LairOfTheWarthogWarriorMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheWarthogWarriorMap()
            : base(0x14EB, "Map to Lair of the Warthog Warrior", 650)
        {
        }

        public LairOfTheWarthogWarriorMap(Serial serial)
            : base(serial)
        {
        }
