...
{
    public class HarmonyFerretGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public HarmonyFerretGroveMap()
            : base(0x14EB, "Map to Harmony Ferret Grove", 650)
        {
        }

        public HarmonyFerretGroveMap(Serial serial)
            : base(serial)
        {
        }
