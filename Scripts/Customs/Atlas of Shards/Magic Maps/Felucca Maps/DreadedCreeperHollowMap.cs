...
{
    public class DreadedCreeperHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public DreadedCreeperHollowMap()
            : base(0x14EB, "Map to Dreaded Creeper Hollow", 650)
        {
        }

        public DreadedCreeperHollowMap(Serial serial)
            : base(serial)
        {
        }
