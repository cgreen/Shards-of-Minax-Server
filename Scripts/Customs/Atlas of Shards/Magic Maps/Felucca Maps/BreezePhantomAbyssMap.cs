...
{
    public class BreezePhantomAbyssMap : MagicMapBase
    {
        ...
        [Constructable]
        public BreezePhantomAbyssMap()
            : base(0x14EB, "Map to Breeze Phantom Abyss", 650)
        {
        }

        public BreezePhantomAbyssMap(Serial serial)
            : base(serial)
        {
        }
