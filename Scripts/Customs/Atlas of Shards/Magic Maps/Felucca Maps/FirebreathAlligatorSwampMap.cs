...
{
    public class FirebreathAlligatorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public FirebreathAlligatorSwampMap()
            : base(0x14EB, "Map to Firebreath Alligator Swamp", 650)
        {
        }

        public FirebreathAlligatorSwampMap(Serial serial)
            : base(serial)
        {
        }
