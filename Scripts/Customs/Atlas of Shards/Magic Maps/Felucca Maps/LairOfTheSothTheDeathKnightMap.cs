...
{
    public class LairOfTheSothTheDeathKnightMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSothTheDeathKnightMap()
            : base(0x14EB, "Map to Lair of the Soth the Death Knight", 650)
        {
        }

        public LairOfTheSothTheDeathKnightMap(Serial serial)
            : base(serial)
        {
        }
