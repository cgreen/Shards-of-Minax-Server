...
{
    public class TacticalEnforcerOperationsMap : MagicMapBase
    {
        ...
        [Constructable]
        public TacticalEnforcerOperationsMap()
            : base(0x14EB, "Map to Tactical Enforcer Operations", 650)
        {
        }

        public TacticalEnforcerOperationsMap(Serial serial)
            : base(serial)
        {
        }
