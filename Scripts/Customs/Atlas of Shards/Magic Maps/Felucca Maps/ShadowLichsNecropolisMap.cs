...
{
    public class ShadowLichsNecropolisMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowLichsNecropolisMap()
            : base(0x14EB, "Map to Shadow Lichs Necropolis", 650)
        {
        }

        public ShadowLichsNecropolisMap(Serial serial)
            : base(serial)
        {
        }
