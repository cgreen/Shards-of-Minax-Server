...
{
    public class IllusionistEttinsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public IllusionistEttinsDomainMap()
            : base(0x14EB, "Map to Illusionist Ettins Domain", 650)
        {
        }

        public IllusionistEttinsDomainMap(Serial serial)
            : base(serial)
        {
        }
