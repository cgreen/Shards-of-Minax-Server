...
{
    public class SpiderMonkeyJungleMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpiderMonkeyJungleMap()
            : base(0x14EB, "Map to Spider Monkey Jungle", 650)
        {
        }

        public SpiderMonkeyJungleMap(Serial serial)
            : base(serial)
        {
        }
