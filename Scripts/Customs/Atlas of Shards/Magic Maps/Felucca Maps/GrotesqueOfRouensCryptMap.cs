...
{
    public class GrotesqueOfRouensCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public GrotesqueOfRouensCryptMap()
            : base(0x14EB, "Map to Grotesque of Rouens Crypt", 650)
        {
        }

        public GrotesqueOfRouensCryptMap(Serial serial)
            : base(serial)
        {
        }
