...
{
    public class CrystalDragonCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrystalDragonCavernMap()
            : base(0x14EB, "Map to Crystal Dragon Cavern", 650)
        {
        }

        public CrystalDragonCavernMap(Serial serial)
            : base(serial)
        {
        }
