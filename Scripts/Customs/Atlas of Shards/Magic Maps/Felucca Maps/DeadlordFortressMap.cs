...
{
    public class DeadlordFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public DeadlordFortressMap()
            : base(0x14EB, "Map to Deadlord Fortress", 650)
        {
        }

        public DeadlordFortressMap(Serial serial)
            : base(serial)
        {
        }
