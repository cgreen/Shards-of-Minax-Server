...
{
    public class ToxicSludgeSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public ToxicSludgeSwampMap()
            : base(0x14EB, "Map to Toxic Sludge Swamp", 650)
        {
        }

        public ToxicSludgeSwampMap(Serial serial)
            : base(serial)
        {
        }
