...
{
    public class JerseyEnchantressCovenMap : MagicMapBase
    {
        ...
        [Constructable]
        public JerseyEnchantressCovenMap()
            : base(0x14EB, "Map to Jersey Enchantress Coven", 650)
        {
        }

        public JerseyEnchantressCovenMap(Serial serial)
            : base(serial)
        {
        }
