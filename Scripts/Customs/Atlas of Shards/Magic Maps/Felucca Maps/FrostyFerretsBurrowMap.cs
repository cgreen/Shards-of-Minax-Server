...
{
    public class FrostyFerretsBurrowMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostyFerretsBurrowMap()
            : base(0x14EB, "Map to Frosty Ferrets Burrow", 650)
        {
        }

        public FrostyFerretsBurrowMap(Serial serial)
            : base(serial)
        {
        }
