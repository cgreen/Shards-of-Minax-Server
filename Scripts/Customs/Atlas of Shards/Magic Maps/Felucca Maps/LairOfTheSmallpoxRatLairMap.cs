...
{
    public class LairOfTheSmallpoxRatLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSmallpoxRatLairMap()
            : base(0x14EB, "Map to Lair of the Smallpox Rat Lair", 650)
        {
        }

        public LairOfTheSmallpoxRatLairMap(Serial serial)
            : base(serial)
        {
        }
