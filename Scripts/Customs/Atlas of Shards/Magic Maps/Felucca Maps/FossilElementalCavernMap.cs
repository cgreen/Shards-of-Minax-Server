...
{
    public class FossilElementalCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public FossilElementalCavernMap()
            : base(0x14EB, "Map to Fossil Elemental Cavern", 650)
        {
        }

        public FossilElementalCavernMap(Serial serial)
            : base(serial)
        {
        }
