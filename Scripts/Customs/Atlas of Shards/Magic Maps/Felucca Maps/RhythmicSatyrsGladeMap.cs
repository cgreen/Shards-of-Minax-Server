...
{
    public class RhythmicSatyrsGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public RhythmicSatyrsGladeMap()
            : base(0x14EB, "Map to Rhythmic Satyr’s Glade", 650)
        {
        }

        public RhythmicSatyrsGladeMap(Serial serial)
            : base(serial)
        {
        }
