...
{
    public class WickedSatyrsForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public WickedSatyrsForestMap()
            : base(0x14EB, "Map to Wicked Satyrs Forest", 650)
        {
        }

        public WickedSatyrsForestMap(Serial serial)
            : base(serial)
        {
        }
