...
{
    public class CinderWraithRuinsMap : MagicMapBase
    {
        ...
        [Constructable]
        public CinderWraithRuinsMap()
            : base(0x14EB, "Map to Cinder Wraith Ruins", 650)
        {
        }

        public CinderWraithRuinsMap(Serial serial)
            : base(serial)
        {
        }
