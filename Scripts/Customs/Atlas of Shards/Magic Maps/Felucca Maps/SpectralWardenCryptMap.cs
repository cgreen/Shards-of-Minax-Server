...
{
    public class SpectralWardenCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpectralWardenCryptMap()
            : base(0x14EB, "Map to Spectral Warden Crypt", 650)
        {
        }

        public SpectralWardenCryptMap(Serial serial)
            : base(serial)
        {
        }
