...
{
    public class LairOfTheVortexConstructMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVortexConstructMap()
            : base(0x14EB, "Map to Lair of the Vortex Construct", 650)
        {
        }

        public LairOfTheVortexConstructMap(Serial serial)
            : base(serial)
        {
        }
