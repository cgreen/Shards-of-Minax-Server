...
{
    public class SagittariusHarpysPerchMap : MagicMapBase
    {
        ...
        [Constructable]
        public SagittariusHarpysPerchMap()
            : base(0x14EB, "Map to Sagittarius Harpy’s Perch", 650)
        {
        }

        public SagittariusHarpysPerchMap(Serial serial)
            : base(serial)
        {
        }
