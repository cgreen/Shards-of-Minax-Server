...
{
    public class TyphusRatInfestationMap : MagicMapBase
    {
        ...
        [Constructable]
        public TyphusRatInfestationMap()
            : base(0x14EB, "Map to Typhus Rat Infestation", 650)
        {
        }

        public TyphusRatInfestationMap(Serial serial)
            : base(serial)
        {
        }
