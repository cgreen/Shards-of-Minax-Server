...
{
    public class FrostbiteAlligatorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostbiteAlligatorSwampMap()
            : base(0x14EB, "Map to Frostbite Alligator Swamp", 650)
        {
        }

        public FrostbiteAlligatorSwampMap(Serial serial)
            : base(serial)
        {
        }
