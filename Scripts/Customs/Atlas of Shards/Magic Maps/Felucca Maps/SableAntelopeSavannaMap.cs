...
{
    public class SableAntelopeSavannaMap : MagicMapBase
    {
        ...
        [Constructable]
        public SableAntelopeSavannaMap()
            : base(0x14EB, "Map to Sable Antelope Savanna", 650)
        {
        }

        public SableAntelopeSavannaMap(Serial serial)
            : base(serial)
        {
        }
