...
{
    public class WhisperingPookaGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public WhisperingPookaGroveMap()
            : base(0x14EB, "Map to Whispering Pooka Grove", 650)
        {
        }

        public WhisperingPookaGroveMap(Serial serial)
            : base(serial)
        {
        }
