...
{
    public class FlameWardenEttinFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public FlameWardenEttinFortressMap()
            : base(0x14EB, "Map to Flame Warden Ettin Fortress", 650)
        {
        }

        public FlameWardenEttinFortressMap(Serial serial)
            : base(serial)
        {
        }
