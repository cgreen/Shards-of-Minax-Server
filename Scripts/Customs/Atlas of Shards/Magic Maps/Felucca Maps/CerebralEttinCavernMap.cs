...
{
    public class CerebralEttinCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public CerebralEttinCavernMap()
            : base(0x14EB, "Map to Cerebral Ettin Cavern", 650)
        {
        }

        public CerebralEttinCavernMap(Serial serial)
            : base(serial)
        {
        }
