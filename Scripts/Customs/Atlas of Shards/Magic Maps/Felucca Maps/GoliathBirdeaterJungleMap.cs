...
{
    public class GoliathBirdeaterJungleMap : MagicMapBase
    {
        ...
        [Constructable]
        public GoliathBirdeaterJungleMap()
            : base(0x14EB, "Map to Goliath Birdeater Jungle", 650)
        {
        }

        public GoliathBirdeaterJungleMap(Serial serial)
            : base(serial)
        {
        }
