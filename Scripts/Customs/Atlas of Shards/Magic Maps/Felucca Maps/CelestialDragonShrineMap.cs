...
{
    public class CelestialDragonShrineMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialDragonShrineMap()
            : base(0x14EB, "Map to Celestial Dragon Shrine", 650)
        {
        }

        public CelestialDragonShrineMap(Serial serial)
            : base(serial)
        {
        }
