...
{
    public class BubbleFerretForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public BubbleFerretForestMap()
            : base(0x14EB, "Map to Bubble Ferret Forest", 650)
        {
        }

        public BubbleFerretForestMap(Serial serial)
            : base(serial)
        {
        }
