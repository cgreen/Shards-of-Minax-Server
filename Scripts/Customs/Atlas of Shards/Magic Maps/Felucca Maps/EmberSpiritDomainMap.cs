...
{
    public class EmberSpiritDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public EmberSpiritDomainMap()
            : base(0x14EB, "Map to Ember Spirit Domain", 650)
        {
        }

        public EmberSpiritDomainMap(Serial serial)
            : base(serial)
        {
        }
