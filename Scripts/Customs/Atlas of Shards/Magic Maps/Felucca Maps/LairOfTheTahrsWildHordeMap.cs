...
{
    public class LairOfTheTahrsWildHordeMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheTahrsWildHordeMap()
            : base(0x14EB, "Map to Lair of the Tahrs Wild Horde", 650)
        {
        }

        public LairOfTheTahrsWildHordeMap(Serial serial)
            : base(serial)
        {
        }
