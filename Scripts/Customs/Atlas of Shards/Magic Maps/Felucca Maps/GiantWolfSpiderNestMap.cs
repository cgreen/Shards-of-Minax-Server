...
{
    public class GiantWolfSpiderNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public GiantWolfSpiderNestMap()
            : base(0x14EB, "Map to Giant Wolf Spider Nest", 650)
        {
        }

        public GiantWolfSpiderNestMap(Serial serial)
            : base(serial)
        {
        }
