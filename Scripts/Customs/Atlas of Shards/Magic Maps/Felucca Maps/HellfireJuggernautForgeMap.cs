...
{
    public class HellfireJuggernautForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public HellfireJuggernautForgeMap()
            : base(0x14EB, "Map to Hellfire Juggernaut Forge", 650)
        {
        }

        public HellfireJuggernautForgeMap(Serial serial)
            : base(serial)
        {
        }
