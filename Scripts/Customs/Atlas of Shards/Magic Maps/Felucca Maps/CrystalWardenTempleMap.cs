...
{
    public class CrystalWardenTempleMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrystalWardenTempleMap()
            : base(0x14EB, "Map to Crystal Warden Temple", 650)
        {
        }

        public CrystalWardenTempleMap(Serial serial)
            : base(serial)
        {
        }
