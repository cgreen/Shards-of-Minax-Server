...
{
    public class LairOfTheShadowtoadsBogMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheShadowtoadsBogMap()
            : base(0x14EB, "Map to Lair of the ShadowToads Bog", 650)
        {
        }

        public LairOfTheShadowtoadsBogMap(Serial serial)
            : base(serial)
        {
        }
