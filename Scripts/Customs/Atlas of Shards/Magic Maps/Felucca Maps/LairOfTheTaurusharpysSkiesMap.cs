...
{
    public class LairOfTheTaurusharpysSkiesMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheTaurusharpysSkiesMap()
            : base(0x14EB, "Map to Lair of the TaurusHarpys Skies", 650)
        {
        }

        public LairOfTheTaurusharpysSkiesMap(Serial serial)
            : base(serial)
        {
        }
