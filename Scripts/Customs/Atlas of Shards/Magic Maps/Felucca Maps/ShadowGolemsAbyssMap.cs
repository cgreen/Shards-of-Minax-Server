...
{
    public class ShadowGolemsAbyssMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowGolemsAbyssMap()
            : base(0x14EB, "Map to Shadow Golems Abyss", 650)
        {
        }

        public ShadowGolemsAbyssMap(Serial serial)
            : base(serial)
        {
        }
