...
{
    public class SynthroidPrimeFactoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public SynthroidPrimeFactoryMap()
            : base(0x14EB, "Map to Synthroid Prime Factory", 650)
        {
        }

        public SynthroidPrimeFactoryMap(Serial serial)
            : base(serial)
        {
        }
