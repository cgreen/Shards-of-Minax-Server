...
{
    public class LairOfTheVolcaniccHargerMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVolcaniccHargerMap()
            : base(0x14EB, "Map to Lair of the VolcanicC harger", 650)
        {
        }

        public LairOfTheVolcaniccHargerMap(Serial serial)
            : base(serial)
        {
        }
