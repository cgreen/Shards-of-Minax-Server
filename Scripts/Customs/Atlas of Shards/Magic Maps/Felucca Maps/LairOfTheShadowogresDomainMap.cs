...
{
    public class LairOfTheShadowogresDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheShadowogresDomainMap()
            : base(0x14EB, "Map to Lair of the ShadowOgres Domain", 650)
        {
        }

        public LairOfTheShadowogresDomainMap(Serial serial)
            : base(serial)
        {
        }
