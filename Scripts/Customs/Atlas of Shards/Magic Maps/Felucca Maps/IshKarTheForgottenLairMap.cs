...
{
    public class IshKarTheForgottenLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public IshKarTheForgottenLairMap()
            : base(0x14EB, "Map to Ish Kar the Forgotten Lair", 650)
        {
        }

        public IshKarTheForgottenLairMap(Serial serial)
            : base(serial)
        {
        }
