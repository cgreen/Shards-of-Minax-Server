...
{
    public class GlimmeringFerretBurrowMap : MagicMapBase
    {
        ...
        [Constructable]
        public GlimmeringFerretBurrowMap()
            : base(0x14EB, "Map to Glimmering Ferret Burrow", 650)
        {
        }

        public GlimmeringFerretBurrowMap(Serial serial)
            : base(serial)
        {
        }
