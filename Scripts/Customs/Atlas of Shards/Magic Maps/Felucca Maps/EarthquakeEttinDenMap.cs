...
{
    public class EarthquakeEttinDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public EarthquakeEttinDenMap()
            : base(0x14EB, "Map to Earthquake Ettin Den", 650)
        {
        }

        public EarthquakeEttinDenMap(Serial serial)
            : base(serial)
        {
        }
