...
{
    public class LairOfTheTaurusearthbearsDominionMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheTaurusearthbearsDominionMap()
            : base(0x14EB, "Map to Lair of the TaurusEarthBears Dominion", 650)
        {
        }

        public LairOfTheTaurusearthbearsDominionMap(Serial serial)
            : base(serial)
        {
        }
