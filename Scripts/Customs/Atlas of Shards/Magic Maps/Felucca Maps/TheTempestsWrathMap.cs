...
{
    public class TheTempestsWrathMap : MagicMapBase
    {
        ...
        [Constructable]
        public TheTempestsWrathMap()
            : base(0x14EB, "Map to The Tempests Wrath", 650)
        {
        }

        public TheTempestsWrathMap(Serial serial)
            : base(serial)
        {
        }
