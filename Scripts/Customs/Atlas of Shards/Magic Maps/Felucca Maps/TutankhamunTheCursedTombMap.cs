...
{
    public class TutankhamunTheCursedTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public TutankhamunTheCursedTombMap()
            : base(0x14EB, "Map to Tutankhamun The Cursed Tomb", 650)
        {
        }

        public TutankhamunTheCursedTombMap(Serial serial)
            : base(serial)
        {
        }
