...
{
    public class SteamLeviathanAbyssMap : MagicMapBase
    {
        ...
        [Constructable]
        public SteamLeviathanAbyssMap()
            : base(0x14EB, "Map to Steam Leviathan Abyss", 650)
        {
        }

        public SteamLeviathanAbyssMap(Serial serial)
            : base(serial)
        {
        }
