...
{
    public class FrostSerpentLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public FrostSerpentLairMap()
            : base(0x14EB, "Map to Frost Serpent Lair", 650)
        {
        }

        public FrostSerpentLairMap(Serial serial)
            : base(serial)
        {
        }
