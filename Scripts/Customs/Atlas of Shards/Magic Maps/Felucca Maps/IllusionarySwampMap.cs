...
{
    public class IllusionarySwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public IllusionarySwampMap()
            : base(0x14EB, "Map to Illusionary Swamp", 650)
        {
        }

        public IllusionarySwampMap(Serial serial)
            : base(serial)
        {
        }
