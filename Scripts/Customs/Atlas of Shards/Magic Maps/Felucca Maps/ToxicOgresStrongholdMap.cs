...
{
    public class ToxicOgresStrongholdMap : MagicMapBase
    {
        ...
        [Constructable]
        public ToxicOgresStrongholdMap()
            : base(0x14EB, "Map to Toxic Ogres Stronghold", 650)
        {
        }

        public ToxicOgresStrongholdMap(Serial serial)
            : base(serial)
        {
        }
