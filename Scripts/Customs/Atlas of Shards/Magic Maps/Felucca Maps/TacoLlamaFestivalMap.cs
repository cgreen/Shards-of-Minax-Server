...
{
    public class TacoLlamaFestivalMap : MagicMapBase
    {
        ...
        [Constructable]
        public TacoLlamaFestivalMap()
            : base(0x14EB, "Map to Taco Llama Festival", 650)
        {
        }

        public TacoLlamaFestivalMap(Serial serial)
            : base(serial)
        {
        }
