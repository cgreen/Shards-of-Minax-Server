...
{
    public class TheWrathOfTheThunderKingMap : MagicMapBase
    {
        ...
        [Constructable]
        public TheWrathOfTheThunderKingMap()
            : base(0x14EB, "Map to The Wrath of the Thunder King", 650)
        {
        }

        public TheWrathOfTheThunderKingMap(Serial serial)
            : base(serial)
        {
        }
