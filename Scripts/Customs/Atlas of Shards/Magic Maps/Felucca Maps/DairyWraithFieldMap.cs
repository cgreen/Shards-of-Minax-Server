...
{
    public class DairyWraithFieldMap : MagicMapBase
    {
        ...
        [Constructable]
        public DairyWraithFieldMap()
            : base(0x14EB, "Map to Dairy Wraith Field", 650)
        {
        }

        public DairyWraithFieldMap(Serial serial)
            : base(serial)
        {
        }
