...
{
    public class LairOfTheVoidSlimeMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVoidSlimeMap()
            : base(0x14EB, "Map to Lair of the Void Slime", 650)
        {
        }

        public LairOfTheVoidSlimeMap(Serial serial)
            : base(serial)
        {
        }
