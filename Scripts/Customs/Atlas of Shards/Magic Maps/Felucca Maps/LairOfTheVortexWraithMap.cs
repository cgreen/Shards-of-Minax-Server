...
{
    public class LairOfTheVortexWraithMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVortexWraithMap()
            : base(0x14EB, "Map to Lair of the Vortex Wraith", 650)
        {
        }

        public LairOfTheVortexWraithMap(Serial serial)
            : base(serial)
        {
        }
