...
{
    public class LairOfTheVirgoPurityBearMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVirgoPurityBearMap()
            : base(0x14EB, "Map to Lair of the Virgo Purity Bear", 650)
        {
        }

        public LairOfTheVirgoPurityBearMap(Serial serial)
            : base(serial)
        {
        }
