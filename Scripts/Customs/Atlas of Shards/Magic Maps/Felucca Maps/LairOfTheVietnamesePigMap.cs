...
{
    public class LairOfTheVietnamesePigMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVietnamesePigMap()
            : base(0x14EB, "Map to Lair of the Vietnamese Pig", 650)
        {
        }

        public LairOfTheVietnamesePigMap(Serial serial)
            : base(serial)
        {
        }
