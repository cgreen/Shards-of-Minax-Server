...
{
    public class SpectralAutomatonForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpectralAutomatonForgeMap()
            : base(0x14EB, "Map to Spectral Automaton Forge", 650)
        {
        }

        public SpectralAutomatonForgeMap(Serial serial)
            : base(serial)
        {
        }
