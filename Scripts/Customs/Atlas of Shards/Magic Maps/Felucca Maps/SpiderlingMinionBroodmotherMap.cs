...
{
    public class SpiderlingMinionBroodmotherMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpiderlingMinionBroodmotherMap()
            : base(0x14EB, "Map to Spiderling Minion Broodmother", 650)
        {
        }

        public SpiderlingMinionBroodmotherMap(Serial serial)
            : base(serial)
        {
        }
