...
{
    public class GoldenOrbWeaverCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public GoldenOrbWeaverCavernMap()
            : base(0x14EB, "Map to Golden Orb Weaver Cavern", 650)
        {
        }

        public GoldenOrbWeaverCavernMap(Serial serial)
            : base(serial)
        {
        }
