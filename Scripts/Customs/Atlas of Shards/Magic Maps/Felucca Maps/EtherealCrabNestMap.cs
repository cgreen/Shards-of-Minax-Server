...
{
    public class EtherealCrabNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public EtherealCrabNestMap()
            : base(0x14EB, "Map to Ethereal Crab Nest", 650)
        {
        }

        public EtherealCrabNestMap(Serial serial)
            : base(serial)
        {
        }
