...
{
    public class LairOfTheTalonmachinesForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheTalonmachinesForgeMap()
            : base(0x14EB, "Map to Lair of the TalonMachines Forge", 650)
        {
        }

        public LairOfTheTalonmachinesForgeMap(Serial serial)
            : base(serial)
        {
        }
