...
{
    public class LairOfTheVileToadMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVileToadMap()
            : base(0x14EB, "Map to Lair of the Vile Toad", 650)
        {
        }

        public LairOfTheVileToadMap(Serial serial)
            : base(serial)
        {
        }
