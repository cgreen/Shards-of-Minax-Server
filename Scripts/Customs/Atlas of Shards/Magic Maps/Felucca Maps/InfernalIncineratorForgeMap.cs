...
{
    public class InfernalIncineratorForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernalIncineratorForgeMap()
            : base(0x14EB, "Map to Infernal Incinerator Forge", 650)
        {
        }

        public InfernalIncineratorForgeMap(Serial serial)
            : base(serial)
        {
        }
