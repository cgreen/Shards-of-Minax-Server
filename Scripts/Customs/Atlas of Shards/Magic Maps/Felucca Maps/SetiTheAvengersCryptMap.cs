...
{
    public class SetiTheAvengersCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public SetiTheAvengersCryptMap()
            : base(0x14EB, "Map to Seti the Avengers Crypt", 650)
        {
        }

        public SetiTheAvengersCryptMap(Serial serial)
            : base(serial)
        {
        }
