...
{
    public class WoodlandSpiritHorseMeadowMap : MagicMapBase
    {
        ...
        [Constructable]
        public WoodlandSpiritHorseMeadowMap()
            : base(0x14EB, "Map to Woodland Spirit Horse Meadow", 650)
        {
        }

        public WoodlandSpiritHorseMeadowMap(Serial serial)
            : base(serial)
        {
        }
