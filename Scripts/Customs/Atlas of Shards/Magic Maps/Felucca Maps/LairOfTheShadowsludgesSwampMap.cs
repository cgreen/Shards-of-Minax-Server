...
{
    public class LairOfTheShadowsludgesSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheShadowsludgesSwampMap()
            : base(0x14EB, "Map to Lair of the ShadowSludges Swamp", 650)
        {
        }

        public LairOfTheShadowsludgesSwampMap(Serial serial)
            : base(serial)
        {
        }
