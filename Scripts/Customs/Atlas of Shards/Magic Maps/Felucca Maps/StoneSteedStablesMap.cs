...
{
    public class StoneSteedStablesMap : MagicMapBase
    {
        ...
        [Constructable]
        public StoneSteedStablesMap()
            : base(0x14EB, "Map to Stone Steed Stables", 650)
        {
        }

        public StoneSteedStablesMap(Serial serial)
            : base(serial)
        {
        }
