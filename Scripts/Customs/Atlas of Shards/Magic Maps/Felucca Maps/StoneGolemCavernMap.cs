...
{
    public class StoneGolemCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public StoneGolemCavernMap()
            : base(0x14EB, "Map to Stone Golem Cavern", 650)
        {
        }

        public StoneGolemCavernMap(Serial serial)
            : base(serial)
        {
        }
