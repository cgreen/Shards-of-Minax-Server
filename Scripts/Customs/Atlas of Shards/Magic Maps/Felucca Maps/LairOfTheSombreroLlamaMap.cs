...
{
    public class LairOfTheSombreroLlamaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSombreroLlamaMap()
            : base(0x14EB, "Map to Lair of the Sombrero Llama", 650)
        {
        }

        public LairOfTheSombreroLlamaMap(Serial serial)
            : base(serial)
        {
        }
