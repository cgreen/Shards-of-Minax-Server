...
{
    public class TrapdoorSpiderNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrapdoorSpiderNestMap()
            : base(0x14EB, "Map to Trapdoor Spider Nest", 650)
        {
        }

        public TrapdoorSpiderNestMap(Serial serial)
            : base(serial)
        {
        }
