...
{
    public class IllusionHensParadiseMap : MagicMapBase
    {
        ...
        [Constructable]
        public IllusionHensParadiseMap()
            : base(0x14EB, "Map to Illusion Hens Paradise", 650)
        {
        }

        public IllusionHensParadiseMap(Serial serial)
            : base(serial)
        {
        }
