...
{
    public class InfernoPythonPitMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernoPythonPitMap()
            : base(0x14EB, "Map to Inferno Python Pit", 650)
        {
        }

        public InfernoPythonPitMap(Serial serial)
            : base(serial)
        {
        }
