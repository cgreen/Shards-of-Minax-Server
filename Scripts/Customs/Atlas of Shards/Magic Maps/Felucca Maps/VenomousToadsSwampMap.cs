...
{
    public class VenomousToadsSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousToadsSwampMap()
            : base(0x14EB, "Map to Venomous Toads Swamp", 650)
        {
        }

        public VenomousToadsSwampMap(Serial serial)
            : base(serial)
        {
        }
