...
{
    public class ScorpionSpidersHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScorpionSpidersHollowMap()
            : base(0x14EB, "Map to Scorpion Spider’s Hollow", 650)
        {
        }

        public ScorpionSpidersHollowMap(Serial serial)
            : base(serial)
        {
        }
