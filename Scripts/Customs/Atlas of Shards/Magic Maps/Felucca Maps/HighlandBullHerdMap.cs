...
{
    public class HighlandBullHerdMap : MagicMapBase
    {
        ...
        [Constructable]
        public HighlandBullHerdMap()
            : base(0x14EB, "Map to Highland Bull Herd", 650)
        {
        }

        public HighlandBullHerdMap(Serial serial)
            : base(serial)
        {
        }
