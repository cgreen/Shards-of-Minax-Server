...
{
    public class InfernoDrakonsRoostMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernoDrakonsRoostMap()
            : base(0x14EB, "Map to Inferno Drakons Roost", 650)
        {
        }

        public InfernoDrakonsRoostMap(Serial serial)
            : base(serial)
        {
        }
