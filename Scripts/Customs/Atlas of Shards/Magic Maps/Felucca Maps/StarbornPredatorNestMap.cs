...
{
    public class StarbornPredatorNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public StarbornPredatorNestMap()
            : base(0x14EB, "Map to Starborn Predator Nest", 650)
        {
        }

        public StarbornPredatorNestMap(Serial serial)
            : base(serial)
        {
        }
