...
{
    public class CursedHarbingerCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public CursedHarbingerCryptMap()
            : base(0x14EB, "Map to Cursed Harbinger Crypt", 650)
        {
        }

        public CursedHarbingerCryptMap(Serial serial)
            : base(serial)
        {
        }
