...
{
    public class LairOfTheWraithlichCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheWraithlichCryptMap()
            : base(0x14EB, "Map to Lair of the WraithLich Crypt", 650)
        {
        }

        public LairOfTheWraithlichCryptMap(Serial serial)
            : base(serial)
        {
        }
