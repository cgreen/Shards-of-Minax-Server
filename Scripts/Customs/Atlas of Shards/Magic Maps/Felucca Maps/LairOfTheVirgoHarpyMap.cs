...
{
    public class LairOfTheVirgoHarpyMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheVirgoHarpyMap()
            : base(0x14EB, "Map to Lair of the Virgo Harpy", 650)
        {
        }

        public LairOfTheVirgoHarpyMap(Serial serial)
            : base(serial)
        {
        }
