...
{
    public class InfernoWardensFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernoWardensFortressMap()
            : base(0x14EB, "Map to Inferno Wardens Fortress", 650)
        {
        }

        public InfernoWardensFortressMap(Serial serial)
            : base(serial)
        {
        }
