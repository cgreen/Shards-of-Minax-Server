...
{
    public class LairOfTheSifakawarriorsJungleMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheSifakawarriorsJungleMap()
            : base(0x14EB, "Map to Lair of the SifakaWarriors Jungle", 650)
        {
        }

        public LairOfTheSifakawarriorsJungleMap(Serial serial)
            : base(serial)
        {
        }
