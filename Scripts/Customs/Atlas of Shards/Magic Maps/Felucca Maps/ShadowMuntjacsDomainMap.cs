...
{
    public class ShadowMuntjacsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowMuntjacsDomainMap()
            : base(0x14EB, "Map to Shadow Muntjacs Domain", 650)
        {
        }

        public ShadowMuntjacsDomainMap(Serial serial)
            : base(serial)
        {
        }
