...
{
    public class InfernalDukesCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernalDukesCitadelMap()
            : base(0x14EB, "Map to Infernal Dukes Citadel", 650)
        {
        }

        public InfernalDukesCitadelMap(Serial serial)
            : base(serial)
        {
        }
