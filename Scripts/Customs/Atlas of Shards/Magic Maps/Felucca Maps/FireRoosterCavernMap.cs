...
{
    public class FireRoosterCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public FireRoosterCavernMap()
            : base(0x14EB, "Map to Fire Rooster Cavern", 650)
        {
        }

        public FireRoosterCavernMap(Serial serial)
            : base(serial)
        {
        }
