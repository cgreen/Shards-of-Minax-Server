...
{
    public class SzassTamsNecropolisMap : MagicMapBase
    {
        ...
        [Constructable]
        public SzassTamsNecropolisMap()
            : base(0x14EB, "Map to Szass Tams Necropolis", 650)
        {
        }

        public SzassTamsNecropolisMap(Serial serial)
            : base(serial)
        {
        }
