...
{
    public class ForestRangerOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForestRangerOutpostMap()
            : base(0x14EB, "Map to Forest Ranger Outpost", 450)
        {
        }

        public ForestRangerOutpostMap(Serial serial)
            : base(serial)
        {
        }
