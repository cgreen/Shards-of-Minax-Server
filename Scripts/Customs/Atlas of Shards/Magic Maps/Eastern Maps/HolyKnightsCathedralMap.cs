...
{
    public class HolyKnightsCathedralMap : MagicMapBase
    {
        ...
        [Constructable]
        public HolyKnightsCathedralMap()
            : base(0x14EB, "Map to Holy Knight’s Cathedral", 450)
        {
        }

        public HolyKnightsCathedralMap(Serial serial)
            : base(serial)
        {
        }
