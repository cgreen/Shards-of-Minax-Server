...
{
    public class PirateOfTheStarsOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public PirateOfTheStarsOutpostMap()
            : base(0x14EB, "Map to Pirate of the Stars Outpost", 450)
        {
        }

        public PirateOfTheStarsOutpostMap(Serial serial)
            : base(serial)
        {
        }
