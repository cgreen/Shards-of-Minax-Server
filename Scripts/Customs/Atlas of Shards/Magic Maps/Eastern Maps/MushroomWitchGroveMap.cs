...
{
    public class MushroomWitchGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public MushroomWitchGroveMap()
            : base(0x14EB, "Map to Mushroom Witch Grove", 450)
        {
        }

        public MushroomWitchGroveMap(Serial serial)
            : base(serial)
        {
        }
