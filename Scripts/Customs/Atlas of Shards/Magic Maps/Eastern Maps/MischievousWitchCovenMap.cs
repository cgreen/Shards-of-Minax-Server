...
{
    public class MischievousWitchCovenMap : MagicMapBase
    {
        ...
        [Constructable]
        public MischievousWitchCovenMap()
            : base(0x14EB, "Map to Mischievous Witch Coven", 450)
        {
        }

        public MischievousWitchCovenMap(Serial serial)
            : base(serial)
        {
        }
