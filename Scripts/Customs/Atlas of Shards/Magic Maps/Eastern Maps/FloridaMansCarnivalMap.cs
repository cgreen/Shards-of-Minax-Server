...
{
    public class FloridaMansCarnivalMap : MagicMapBase
    {
        ...
        [Constructable]
        public FloridaMansCarnivalMap()
            : base(0x14EB, "Map to Florida Man’s Carnival", 450)
        {
        }

        public FloridaMansCarnivalMap(Serial serial)
            : base(serial)
        {
        }
