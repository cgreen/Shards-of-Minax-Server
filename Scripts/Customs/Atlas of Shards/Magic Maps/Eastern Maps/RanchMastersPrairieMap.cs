...
{
    public class RanchMastersPrairieMap : MagicMapBase
    {
        ...
        [Constructable]
        public RanchMastersPrairieMap()
            : base(0x14EB, "Map to Ranch Masters Prairie", 450)
        {
        }

        public RanchMastersPrairieMap(Serial serial)
            : base(serial)
        {
        }
