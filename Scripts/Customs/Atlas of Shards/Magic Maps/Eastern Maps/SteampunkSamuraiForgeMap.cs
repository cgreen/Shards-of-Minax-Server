...
{
    public class SteampunkSamuraiForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public SteampunkSamuraiForgeMap()
            : base(0x14EB, "Map to Steampunk Samurai Forge", 450)
        {
        }

        public SteampunkSamuraiForgeMap(Serial serial)
            : base(serial)
        {
        }
