...
{
    public class RetroAndroidWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public RetroAndroidWorkshopMap()
            : base(0x14EB, "Map to Retro Android Workshop", 450)
        {
        }

        public RetroAndroidWorkshopMap(Serial serial)
            : base(serial)
        {
        }
