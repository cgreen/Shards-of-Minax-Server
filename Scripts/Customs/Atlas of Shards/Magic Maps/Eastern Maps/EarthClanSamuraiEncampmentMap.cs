...
{
    public class EarthClanSamuraiEncampmentMap : MagicMapBase
    {
        ...
        [Constructable]
        public EarthClanSamuraiEncampmentMap()
            : base(0x14EB, "Map to Earth Clan Samurai Encampment", 450)
        {
        }

        public EarthClanSamuraiEncampmentMap(Serial serial)
            : base(serial)
        {
        }
