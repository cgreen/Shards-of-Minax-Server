...
{
    public class StarCitizenOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public StarCitizenOutpostMap()
            : base(0x14EB, "Map to Star Citizen Outpost", 450)
        {
        }

        public StarCitizenOutpostMap(Serial serial)
            : base(serial)
        {
        }
