...
{
    public class DuelistPoetArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public DuelistPoetArenaMap()
            : base(0x14EB, "Map to Duelist Poet Arena", 450)
        {
        }

        public DuelistPoetArenaMap(Serial serial)
            : base(serial)
        {
        }
