...
{
    public class InsaneRoboticistWorkshopMap : MagicMapBase
    {
        ...
        {
            new Point3D(440, 2809, 0),
            new Point3D(192, 3695, 5),
            new Point3D(75, 2658, -28)
        };
        ...
        [Constructable]
        public InsaneRoboticistWorkshopMap()
            : base(0x14EB, "Map to Insane Roboticist Workshop", 450)
        {
        }

        public InsaneRoboticistWorkshopMap(Serial serial)
            : base(serial)
        {
        }
