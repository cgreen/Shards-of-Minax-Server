...
{
    public class EvilAlchemistLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public EvilAlchemistLaboratoryMap()
            : base(0x14EB, "Map to Evil Alchemist Laboratory", 450)
        {
        }

        public EvilAlchemistLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
