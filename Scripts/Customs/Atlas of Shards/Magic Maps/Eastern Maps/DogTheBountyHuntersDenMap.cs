...
{
    public class DogTheBountyHuntersDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public DogTheBountyHuntersDenMap()
            : base(0x14EB, "Map to Dog the Bounty Hunters Den", 450)
        {
        }

        public DogTheBountyHuntersDenMap(Serial serial)
            : base(serial)
        {
        }
