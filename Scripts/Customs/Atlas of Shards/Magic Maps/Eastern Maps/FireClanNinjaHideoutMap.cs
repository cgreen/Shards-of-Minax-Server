...
{
    public class FireClanNinjaHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public FireClanNinjaHideoutMap()
            : base(0x14EB, "Map to Fire Clan Ninja Hideout", 450)
        {
        }

        public FireClanNinjaHideoutMap(Serial serial)
            : base(serial)
        {
        }
