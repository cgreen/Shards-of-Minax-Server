...
{
    public class WaterClanNinjaHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public WaterClanNinjaHideoutMap()
            : base(0x14EB, "Map to Water Clan Ninja Hideout", 450)
        {
        }

        public WaterClanNinjaHideoutMap(Serial serial)
            : base(serial)
        {
        }
