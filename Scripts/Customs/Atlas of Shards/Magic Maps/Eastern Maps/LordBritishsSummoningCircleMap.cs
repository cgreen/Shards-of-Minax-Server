...
{
    public class LordBritishsSummoningCircleMap : MagicMapBase
    {
        ...
        [Constructable]
        public LordBritishsSummoningCircleMap()
            : base(0x14EB, "Map to Lord Britishs Summoning Circle", 450)
        {
        }

        public LordBritishsSummoningCircleMap(Serial serial)
            : base(serial)
        {
        }
