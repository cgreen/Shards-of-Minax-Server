...
{
    public class PinupPandemoniumParlorMap : MagicMapBase
    {
        ...
        [Constructable]
        public PinupPandemoniumParlorMap()
            : base(0x14EB, "Map to Pinup Pandemonium Parlor", 450)
        {
        }

        public PinupPandemoniumParlorMap(Serial serial)
            : base(serial)
        {
        }
