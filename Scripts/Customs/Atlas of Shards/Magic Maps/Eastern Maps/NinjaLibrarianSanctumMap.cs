...
{
    public class NinjaLibrarianSanctumMap : MagicMapBase
    {
        ...
        [Constructable]
        public NinjaLibrarianSanctumMap()
            : base(0x14EB, "Map to Ninja Librarian Sanctum", 450)
        {
        }

        public NinjaLibrarianSanctumMap(Serial serial)
            : base(serial)
        {
        }
