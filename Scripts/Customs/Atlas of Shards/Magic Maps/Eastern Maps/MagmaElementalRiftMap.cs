...
{
    public class MagmaElementalRiftMap : MagicMapBase
    {
        ...
        [Constructable]
        public MagmaElementalRiftMap()
            : base(0x14EB, "Map to Magma Elemental Rift", 450)
        {
        }

        public MagmaElementalRiftMap(Serial serial)
            : base(serial)
        {
        }
