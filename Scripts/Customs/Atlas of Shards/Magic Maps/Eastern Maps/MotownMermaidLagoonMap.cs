...
{
    public class MotownMermaidLagoonMap : MagicMapBase
    {
        ...
        [Constructable]
        public MotownMermaidLagoonMap()
            : base(0x14EB, "Map to Motown Mermaid Lagoon", 450)
        {
        }

        public MotownMermaidLagoonMap(Serial serial)
            : base(serial)
        {
        }
