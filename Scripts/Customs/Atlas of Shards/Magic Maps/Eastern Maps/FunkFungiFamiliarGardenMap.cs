...
{
    public class FunkFungiFamiliarGardenMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(935, 1153, 3),
            new Point3D(438, 3322, 0)
        };
        ...
        [Constructable]
        public FunkFungiFamiliarGardenMap()
            : base(0x14EB, "Map to Funk Fungi Familiar Garden", 450)
        {
        }

        public FunkFungiFamiliarGardenMap(Serial serial)
            : base(serial)
        {
        }
