...
{
    public class WildWestWizardCanyonMap : MagicMapBase
    {
        ...
        [Constructable]
        public WildWestWizardCanyonMap()
            : base(0x14EB, "Map to Wild West Wizard Canyon", 450)
        {
        }

        public WildWestWizardCanyonMap(Serial serial)
            : base(serial)
        {
        }
