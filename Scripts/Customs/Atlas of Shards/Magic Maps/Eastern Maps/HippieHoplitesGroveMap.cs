...
{
    public class HippieHoplitesGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public HippieHoplitesGroveMap()
            : base(0x14EB, "Map to Hippie Hoplite’s Grove", 450)
        {
        }

        public HippieHoplitesGroveMap(Serial serial)
            : base(serial)
        {
        }
