...
{
    public class NoirDetectiveHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public NoirDetectiveHideoutMap()
            : base(0x14EB, "Map to Noir Detective Hideout", 450)
        {
        }

        public NoirDetectiveHideoutMap(Serial serial)
            : base(serial)
        {
        }
