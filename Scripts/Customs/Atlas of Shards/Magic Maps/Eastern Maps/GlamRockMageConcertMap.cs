...
{
    public class GlamRockMageConcertMap : MagicMapBase
    {
        ...
        [Constructable]
        public GlamRockMageConcertMap()
            : base(0x14EB, "Map to Glam Rock Mage Concert", 450)
        {
        }

        public GlamRockMageConcertMap(Serial serial)
            : base(serial)
        {
        }
