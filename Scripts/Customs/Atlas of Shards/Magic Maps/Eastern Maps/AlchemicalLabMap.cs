...
{
    public class AlchemicalLabMap : MagicMapBase
    {
        ...
        [Constructable]
        public AlchemicalLabMap()
            : base(0x14EB, "Map to Alchemical Lab", 450)
        {
        }

        public AlchemicalLabMap(Serial serial)
            : base(serial)
        {
        }
