...
{
    public class LineDragonsAscentMap : MagicMapBase
    {
        ...
        [Constructable]
        public LineDragonsAscentMap()
            : base(0x14EB, "Map to Line Dragon’s Ascent", 450)
        {
        }

        public LineDragonsAscentMap(Serial serial)
            : base(serial)
        {
        }
