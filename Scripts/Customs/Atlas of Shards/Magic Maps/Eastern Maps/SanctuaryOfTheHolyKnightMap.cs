...
{
    public class SanctuaryOfTheHolyKnightMap : MagicMapBase
    {
        ...
        {
            new Point3D(323, 2807, 0),
            new Point3D(849, 2395, -28),
            new Point3D(1051, 2380, 2)
        };
        ...
        [Constructable]
        public SanctuaryOfTheHolyKnightMap()
            : base(0x14EB, "Map to Sanctuary of the Holy Knight", 450)
        {
        }

        public SanctuaryOfTheHolyKnightMap(Serial serial)
            : base(serial)
        {
        }
