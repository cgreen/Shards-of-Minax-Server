...
{
    public class SurferSummonerCoveMap : MagicMapBase
    {
        ...
        [Constructable]
        public SurferSummonerCoveMap()
            : base(0x14EB, "Map to Surfer Summoner Cove", 450)
        {
        }

        public SurferSummonerCoveMap(Serial serial)
            : base(serial)
        {
        }
