...
{
    public class AncientAlligatorMap : MagicMapBase
    {
        ...
        [Constructable]
        public AncientAlligatorMap()
            : base(0x14EB, "Map to Ancient Alligator", 450)
        {
        }

        public AncientAlligatorMap(Serial serial)
            : base(serial)
        {
        }
