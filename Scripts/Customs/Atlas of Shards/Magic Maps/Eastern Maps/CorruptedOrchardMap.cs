...
{
    public class CorruptedOrchardMap : MagicMapBase
    {
        ...
        [Constructable]
        public CorruptedOrchardMap()
            : base(0x14EB, "Map to Corrupted Orchard", 450)
        {
        }

        public CorruptedOrchardMap(Serial serial)
            : base(serial)
        {
        }
