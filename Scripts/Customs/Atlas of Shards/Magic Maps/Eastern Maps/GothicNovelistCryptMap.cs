...
{
    public class GothicNovelistCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public GothicNovelistCryptMap()
            : base(0x14EB, "Map to Gothic Novelist Crypt", 450)
        {
        }

        public GothicNovelistCryptMap(Serial serial)
            : base(serial)
        {
        }
