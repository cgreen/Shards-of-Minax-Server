...
{
    public class TwistedCultistHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public TwistedCultistHideoutMap()
            : base(0x14EB, "Map to Twisted Cultist Hideout", 450)
        {
        }

        public TwistedCultistHideoutMap(Serial serial)
            : base(serial)
        {
        }
