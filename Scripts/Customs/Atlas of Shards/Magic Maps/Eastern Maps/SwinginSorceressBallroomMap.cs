...
{
    public class SwinginSorceressBallroomMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(282, 447, 15),
            new Point3D(548, 3291, 0)
        };
        ...
        [Constructable]
        public SwinginSorceressBallroomMap()
            : base(0x14EB, "Map to Swingin Sorceress Ballroom", 450)
        {
        }

        public SwinginSorceressBallroomMap(Serial serial)
            : base(serial)
        {
        }
