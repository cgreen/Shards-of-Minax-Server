...
{
    public class WastelandBikerCompoundMap : MagicMapBase
    {
        ...
        [Constructable]
        public WastelandBikerCompoundMap()
            : base(0x14EB, "Map to Wasteland Biker Compound", 450)
        {
        }

        public WastelandBikerCompoundMap(Serial serial)
            : base(serial)
        {
        }
