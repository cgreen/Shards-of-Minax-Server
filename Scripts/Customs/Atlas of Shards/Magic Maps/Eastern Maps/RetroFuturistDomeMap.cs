...
{
    public class RetroFuturistDomeMap : MagicMapBase
    {
        ...
        [Constructable]
        public RetroFuturistDomeMap()
            : base(0x14EB, "Map to Retro Futurist Dome", 450)
        {
        }

        public RetroFuturistDomeMap(Serial serial)
            : base(serial)
        {
        }
