...
{
    public class AncientDragonsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public AncientDragonsLairMap()
            : base(0x14EB, "Map to Ancient Dragons Lair", 450)
        {
        }

        public AncientDragonsLairMap(Serial serial)
            : base(serial)
        {
        }
