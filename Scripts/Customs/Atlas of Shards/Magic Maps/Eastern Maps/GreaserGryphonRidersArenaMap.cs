...
{
    public class GreaserGryphonRidersArenaMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(727, 921, -2),
            new Point3D(1142, 2161, -28)
        };
        ...
        [Constructable]
        public GreaserGryphonRidersArenaMap()
            : base(0x14EB, "Map to Greaser Gryphon Rider’s Arena", 450)
        {
        }

        public GreaserGryphonRidersArenaMap(Serial serial)
            : base(serial)
        {
        }
