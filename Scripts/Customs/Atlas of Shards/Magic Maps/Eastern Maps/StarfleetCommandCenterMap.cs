...
{
    public class StarfleetCommandCenterMap : MagicMapBase
    {
        ...
        [Constructable]
        public StarfleetCommandCenterMap()
            : base(0x14EB, "Map to Starfleet Command Center", 450)
        {
        }

        public StarfleetCommandCenterMap(Serial serial)
            : base(serial)
        {
        }
