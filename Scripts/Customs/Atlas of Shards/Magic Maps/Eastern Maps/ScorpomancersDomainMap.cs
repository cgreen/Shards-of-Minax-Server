...
{
    public class ScorpomancersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScorpomancersDomainMap()
            : base(0x14EB, "Map to Scorpomancers Domain", 450)
        {
        }

        public ScorpomancersDomainMap(Serial serial)
            : base(serial)
        {
        }
