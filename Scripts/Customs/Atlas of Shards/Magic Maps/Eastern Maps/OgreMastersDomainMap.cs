...
{
    public class OgreMastersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public OgreMastersDomainMap()
            : base(0x14EB, "Map to Ogre Masters Domain", 450)
        {
        }

        public OgreMastersDomainMap(Serial serial)
            : base(serial)
        {
        }
