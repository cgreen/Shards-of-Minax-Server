...
{
    public class GraffitiGargoyleAlleyMap : MagicMapBase
    {
        ...
        [Constructable]
        public GraffitiGargoyleAlleyMap()
            : base(0x14EB, "Map to Graffiti Gargoyle Alley", 450)
        {
        }

        public GraffitiGargoyleAlleyMap(Serial serial)
            : base(serial)
        {
        }
