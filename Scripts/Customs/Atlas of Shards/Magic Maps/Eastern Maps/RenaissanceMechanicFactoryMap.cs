...
{
    public class RenaissanceMechanicFactoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public RenaissanceMechanicFactoryMap()
            : base(0x14EB, "Map to Renaissance Mechanic Factory", 450)
        {
        }

        public RenaissanceMechanicFactoryMap(Serial serial)
            : base(serial)
        {
        }
