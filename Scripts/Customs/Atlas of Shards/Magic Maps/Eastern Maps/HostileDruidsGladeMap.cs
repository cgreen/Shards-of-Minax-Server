...
{
    public class HostileDruidsGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public HostileDruidsGladeMap()
            : base(0x14EB, "Map to Hostile Druid’s Glade", 450)
        {
        }

        public HostileDruidsGladeMap(Serial serial)
            : base(serial)
        {
        }
