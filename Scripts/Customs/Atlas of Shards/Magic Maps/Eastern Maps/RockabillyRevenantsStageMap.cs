...
{
    public class RockabillyRevenantsStageMap : MagicMapBase
    {
        ...
        [Constructable]
        public RockabillyRevenantsStageMap()
            : base(0x14EB, "Map to Rockabilly Revenants Stage", 450)
        {
        }

        public RockabillyRevenantsStageMap(Serial serial)
            : base(serial)
        {
        }
