...
{
    public class EvilClownCarnivalMap : MagicMapBase
    {
        ...
        [Constructable]
        public EvilClownCarnivalMap()
            : base(0x14EB, "Map to Evil Clown Carnival", 450)
        {
        }

        public EvilClownCarnivalMap(Serial serial)
            : base(serial)
        {
        }
