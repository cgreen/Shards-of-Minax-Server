...
{
    public class VaudevilleValkyrieStageMap : MagicMapBase
    {
        ...
        [Constructable]
        public VaudevilleValkyrieStageMap()
            : base(0x14EB, "Map to Vaudeville Valkyrie Stage", 450)
        {
        }

        public VaudevilleValkyrieStageMap(Serial serial)
            : base(serial)
        {
        }
