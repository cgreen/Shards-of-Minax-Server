...
{
    public class AbyssinianTrackerMap : MagicMapBase
    {
        ...
        [Constructable]
        public AbyssinianTrackerMap()
            : base(0x14EB, "Map to Abyssinian Tracker", 450)
        {
        }

        public AbyssinianTrackerMap(Serial serial)
            : base(serial)
        {
        }
