...
{
    public class NeovictorianVampireCourtMap : MagicMapBase
    {
        ...
        [Constructable]
        public NeovictorianVampireCourtMap()
            : base(0x14EB, "Map to NeoVictorian Vampire Court", 450)
        {
        }

        public NeovictorianVampireCourtMap(Serial serial)
            : base(serial)
        {
        }
