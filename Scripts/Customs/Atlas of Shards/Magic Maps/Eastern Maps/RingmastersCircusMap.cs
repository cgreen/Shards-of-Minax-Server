...
{
    public class RingmastersCircusMap : MagicMapBase
    {
        ...
        [Constructable]
        public RingmastersCircusMap()
            : base(0x14EB, "Map to Ringmasters Circus", 450)
        {
        }

        public RingmastersCircusMap(Serial serial)
            : base(serial)
        {
        }
