...
{
    public class RapRangersJungleMap : MagicMapBase
    {
        ...
        {
            new Point3D(521, 49, 21),
            new Point3D(728, 2572, -28),
        ...
        [Constructable]
        public RapRangersJungleMap()
            : base(0x14EB, "Map to Rap Rangers Jungle", 450)
        {
        }

        public RapRangersJungleMap(Serial serial)
            : base(serial)
        {
        }
