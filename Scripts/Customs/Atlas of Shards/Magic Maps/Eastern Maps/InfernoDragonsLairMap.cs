...
{
    public class InfernoDragonsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfernoDragonsLairMap()
            : base(0x14EB, "Map to Inferno Dragon’s Lair", 450)
        {
        }

        public InfernoDragonsLairMap(Serial serial)
            : base(serial)
        {
        }
