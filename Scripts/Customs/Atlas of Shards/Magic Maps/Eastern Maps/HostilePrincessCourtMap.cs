...
{
    public class HostilePrincessCourtMap : MagicMapBase
    {
        ...
        [Constructable]
        public HostilePrincessCourtMap()
            : base(0x14EB, "Map to Hostile Princess’ Court", 450)
        {
        }

        public HostilePrincessCourtMap(Serial serial)
            : base(serial)
        {
        }
