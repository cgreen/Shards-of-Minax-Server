...
{
    public class SilverSlimeCavernsMap : MagicMapBase
    {
        ...
        [Constructable]
        public SilverSlimeCavernsMap()
            : base(0x14EB, "Map to Silver Slime Caverns", 450)
        {
        }

        public SilverSlimeCavernsMap(Serial serial)
            : base(serial)
        {
        }
