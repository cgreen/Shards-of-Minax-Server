...
{
    public class FlapperElementalistAltarMap : MagicMapBase
    {
        ...
        {
            new Point3D(157, 617, 52),
            new Point3D(747, 1978, -28),
            new Point3D(1058, 2593, -1)
        };
        ...
        [Constructable]
        public FlapperElementalistAltarMap()
            : base(0x14EB, "Map to Flapper Elementalist Altar", 450)
        {
        }

        public FlapperElementalistAltarMap(Serial serial)
            : base(serial)
        {
        }
