...
{
    public class PhoenixStyleMastersArenaMap : MagicMapBase
    {
        ...
        {
            new Point3D(100, 3379, 0),
            new Point3D(192, 3695, 5),
            new Point3D(229, 1342, 0)
        };
        ...
        [Constructable]
        public PhoenixStyleMastersArenaMap()
            : base(0x14EB, "Map to Phoenix Style Masters Arena", 450)
        {
        }

        public PhoenixStyleMastersArenaMap(Serial serial)
            : base(serial)
        {
        }
