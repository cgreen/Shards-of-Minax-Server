...
{
    public class SkeletonLordCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public SkeletonLordCryptMap()
            : base(0x14EB, "Map to Skeleton Lord Crypt", 450)
        {
        }

        public SkeletonLordCryptMap(Serial serial)
            : base(serial)
        {
        }
