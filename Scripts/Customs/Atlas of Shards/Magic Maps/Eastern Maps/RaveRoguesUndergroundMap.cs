...
{
    public class RaveRoguesUndergroundMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(1139, 2370, -28),
            new Point3D(689, 2251, -27)
        };
        ...
        [Constructable]
        public RaveRoguesUndergroundMap()
            : base(0x14EB, "Map to Rave Rogues Underground", 450)
        {
        }

        public RaveRoguesUndergroundMap(Serial serial)
            : base(serial)
        {
        }
