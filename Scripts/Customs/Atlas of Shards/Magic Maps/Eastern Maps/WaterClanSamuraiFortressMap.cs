...
{
    public class WaterClanSamuraiFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public WaterClanSamuraiFortressMap()
            : base(0x14EB, "Map to Water Clan Samurai Fortress", 450)
        {
        }

        public WaterClanSamuraiFortressMap(Serial serial)
            : base(serial)
        {
        }
