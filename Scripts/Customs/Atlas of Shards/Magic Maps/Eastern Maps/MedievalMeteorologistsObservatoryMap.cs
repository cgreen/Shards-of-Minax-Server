...
{
    public class MedievalMeteorologistsObservatoryMap : MagicMapBase
    {
        ...
        {
            new Point3D(610, 3620, 26),
            new Point3D(1000, 2170, -28),
            new Point3D(569, 3358, 0)
        };
        ...
        [Constructable]
        public MedievalMeteorologistsObservatoryMap()
            : base(0x14EB, "Map to Medieval Meteorologists Observatory", 450)
        {
        }

        public MedievalMeteorologistsObservatoryMap(Serial serial)
            : base(serial)
        {
        }
