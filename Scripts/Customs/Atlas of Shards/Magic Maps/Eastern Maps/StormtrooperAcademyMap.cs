...
{
    public class StormtrooperAcademyMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormtrooperAcademyMap()
            : base(0x14EB, "Map to Stormtrooper Academy", 450)
        {
        }

        public StormtrooperAcademyMap(Serial serial)
            : base(serial)
        {
        }
