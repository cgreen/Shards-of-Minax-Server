...
{
    public class SilentMovieStudioMap : MagicMapBase
    {
        ...
        [Constructable]
        public SilentMovieStudioMap()
            : base(0x14EB, "Map to Silent Movie Studio", 450)
        {
        }

        public SilentMovieStudioMap(Serial serial)
            : base(serial)
        {
        }
