...
{
    public class TexanRancherPrairieMap : MagicMapBase
    {
        ...
        [Constructable]
        public TexanRancherPrairieMap()
            : base(0x14EB, "Map to Texan Rancher Prairie", 450)
        {
        }

        public TexanRancherPrairieMap(Serial serial)
            : base(serial)
        {
        }
