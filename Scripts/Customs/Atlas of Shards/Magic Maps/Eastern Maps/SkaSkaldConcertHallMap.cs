...
{
    public class SkaSkaldConcertHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public SkaSkaldConcertHallMap()
            : base(0x14EB, "Map to Ska Skald Concert Hall", 450)
        {
        }

        public SkaSkaldConcertHallMap(Serial serial)
            : base(serial)
        {
        }
