...
{
    public class AngusBerserkersCampMap : MagicMapBase
    {
        ...
        [Constructable]
        public AngusBerserkersCampMap()
            : base(0x14EB, "Map to Angus Berserkers Camp", 450)
        {
        }

        public AngusBerserkersCampMap(Serial serial)
            : base(serial)
        {
        }
