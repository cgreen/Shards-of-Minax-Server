...
{
    public class AbbadonTheAbyssalMap : MagicMapBase
    {
        ...
        [Constructable]
        public AbbadonTheAbyssalMap()
            : base(0x14EB, "Map to Abbadon the Abyssal", 450)
        {
        }

        public AbbadonTheAbyssalMap(Serial serial)
            : base(serial)
        {
        }
