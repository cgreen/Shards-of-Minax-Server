...
{
    public class MinaxSorceressSanctumMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(582, 1960, -28),
            new Point3D(423, 2639, -28)
        };
        ...
        [Constructable]
        public MinaxSorceressSanctumMap()
            : base(0x14EB, "Map to Minax Sorceress Sanctum", 450)
        {
        }

        public MinaxSorceressSanctumMap(Serial serial)
            : base(serial)
        {
        }
