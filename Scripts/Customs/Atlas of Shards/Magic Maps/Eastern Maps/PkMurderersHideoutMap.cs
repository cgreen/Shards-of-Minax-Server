...
{
    public class PkMurderersHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public PkMurderersHideoutMap()
            : base(0x14EB, "Map to PK Murderers Hideout", 450)
        {
        }

        public PkMurderersHideoutMap(Serial serial)
            : base(serial)
        {
        }
