...
{
    public class FastExplorerExpeditionMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
            ...
            new Point3D(310, 2922, 0),
            new Point3D(922, 1974, -29)
        };
        ...
        [Constructable]
        public FastExplorerExpeditionMap()
            : base(0x14EB, "Map to Fast Explorer Expedition", 450)
        {
        }

        public FastExplorerExpeditionMap(Serial serial)
            : base(serial)
        {
        }
