...
{
    public class GreenNinjasHiddenLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public GreenNinjasHiddenLairMap()
            : base(0x14EB, "Map to Green Ninja’s Hidden Lair", 450)
        {
        }

        public GreenNinjasHiddenLairMap(Serial serial)
            : base(serial)
        {
        }
