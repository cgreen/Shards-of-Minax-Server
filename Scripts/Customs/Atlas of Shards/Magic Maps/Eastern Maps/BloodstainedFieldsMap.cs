...
{
    public class BloodstainedFieldsMap : MagicMapBase
    {
        ...
        [Constructable]
        public BloodstainedFieldsMap()
            : base(0x14EB, "Map to Bloodstained Fields", 450)
        {
        }

        public BloodstainedFieldsMap(Serial serial)
            : base(serial)
        {
        }
