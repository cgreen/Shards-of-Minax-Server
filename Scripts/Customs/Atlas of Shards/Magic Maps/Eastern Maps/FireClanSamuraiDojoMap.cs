...
{
    public class FireClanSamuraiDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public FireClanSamuraiDojoMap()
            : base(0x14EB, "Map to Fire Clan Samurai Dojo", 450)
        {
        }

        public FireClanSamuraiDojoMap(Serial serial)
            : base(serial)
        {
        }
