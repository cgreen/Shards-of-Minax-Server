...
{
    public class RetroRobotRomancersLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public RetroRobotRomancersLairMap()
            : base(0x14EB, "Map to Retro Robot Romancers Lair", 450)
        {
        }

        public RetroRobotRomancersLairMap(Serial serial)
            : base(serial)
        {
        }
