...
{
    public class ReggaeRunesmithWorkshopMap : MagicMapBase
    {
        ...
        {
            new Point3D(962, 2413, -28),
            new Point3D(157, 617, 52),
            new Point3D(394, 2522, 0)
        };
        ...
        [Constructable]
        public ReggaeRunesmithWorkshopMap()
            : base(0x14EB, "Map to Reggae Runesmith Workshop", 450)
        {
        }

        public ReggaeRunesmithWorkshopMap(Serial serial)
            : base(serial)
        {
        }
