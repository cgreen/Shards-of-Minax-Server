...
{
    public class GangLeadersHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public GangLeadersHideoutMap()
            : base(0x14EB, "Map to Gang Leaders Hideout", 450)
        {
        }

        public GangLeadersHideoutMap(Serial serial)
            : base(serial)
        {
        }
