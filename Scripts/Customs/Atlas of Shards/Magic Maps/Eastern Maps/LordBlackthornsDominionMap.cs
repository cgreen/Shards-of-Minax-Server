...
{
    public class LordBlackthornsDominionMap : MagicMapBase
    {
        ...
        [Constructable]
        public LordBlackthornsDominionMap()
            : base(0x14EB, "Map to Lord Blackthorns Dominion", 450)
        {
        }

        public LordBlackthornsDominionMap(Serial serial)
            : base(serial)
        {
        }
