...
{
    public class DarkSorcererDomainMap : MagicMapBase
    {
        ...
        {
			new Point3D(3570, 1420, 10),
			new Point3D(5215, 270, 0),
			new Point3D(4302, 1513, 10)
        };
        ...
        [Constructable]
        public DarkSorcererDomainMap()
            : base(0x14EB, "Map to Dark Sorcerer Domain", 250)
        {
        }

        public DarkSorcererDomainMap(Serial serial)
            : base(serial)
        {
        }
