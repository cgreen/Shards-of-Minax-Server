...
{
    public class ElectriciansWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public ElectriciansWorkshopMap()
            : base(0x14EB, "Map to Electricians Workshop", 250)
        {
        }

        public ElectriciansWorkshopMap(Serial serial)
            : base(serial)
        {
        }
