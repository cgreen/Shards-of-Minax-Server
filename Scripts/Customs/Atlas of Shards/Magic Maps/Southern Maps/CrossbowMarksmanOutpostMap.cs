...
{
    public class CrossbowMarksmanOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrossbowMarksmanOutpostMap()
            : base(0x14EB, "Map to Crossbow Marksman Outpost", 250)
        {
        }

        public CrossbowMarksmanOutpostMap(Serial serial)
            : base(serial)
        {
        }
