...
{
    public class KarateExpertDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public KarateExpertDojoMap()
            : base(0x14EB, "Map to Karate Expert Dojo", 250)
        {
        }

        public KarateExpertDojoMap(Serial serial)
            : base(serial)
        {
        }
