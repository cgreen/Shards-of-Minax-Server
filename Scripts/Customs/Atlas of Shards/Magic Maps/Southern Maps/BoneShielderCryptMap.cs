...
{
    public class BoneShielderCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public BoneShielderCryptMap()
            : base(0x14EB, "Map to Bone Shielder Crypt", 250)
        {
        }

        public BoneShielderCryptMap(Serial serial)
            : base(serial)
        {
        }
