...
{
    public class IceSorcererCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public IceSorcererCitadelMap()
            : base(0x14EB, "Map to Ice Sorcerer Citadel", 250)
        {
        }

        public IceSorcererCitadelMap(Serial serial)
            : base(serial)
        {
        }
