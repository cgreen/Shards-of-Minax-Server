...
{
    public class ChoirSingersHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public ChoirSingersHallMap()
            : base(0x14EB, "Map to Choir Singers Hall", 250)
        {
        }

        public ChoirSingersHallMap(Serial serial)
            : base(serial)
        {
        }
