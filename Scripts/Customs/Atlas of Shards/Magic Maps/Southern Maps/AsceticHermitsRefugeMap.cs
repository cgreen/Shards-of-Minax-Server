// ─────────────────────────────────────────────────────────────────────────────
//  ASCETIC HERMIT'S REFUGE MAGIC MAP  ––  just its unique data + champ‐spawn override
// ────────────────────────────────────────────────────────────────────────────
...
{
    public class AsceticHermitsRefugeMap : MagicMapBase
    {
        ...
        {
			new Point3D(5948, 3202, 0),
			new Point3D(4075, 2337, 0),
			new Point3D(5618, 3331, 0)
        };
        ...
        [Constructable]
        public AsceticHermitsRefugeMap()
            : base(0x14EB, "Map to Ascetic Hermit's Refuge", 1491)
        {
        }

        public AsceticHermitsRefugeMap(Serial serial)
            : base(serial)
        {
        }
