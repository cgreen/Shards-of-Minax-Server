...
{
    public class JungleNaturalistGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public JungleNaturalistGroveMap()
            : base(0x14EB, "Map to Jungle Naturalist Grove", 250)
        {
        }

        public JungleNaturalistGroveMap(Serial serial)
            : base(serial)
        {
        }
