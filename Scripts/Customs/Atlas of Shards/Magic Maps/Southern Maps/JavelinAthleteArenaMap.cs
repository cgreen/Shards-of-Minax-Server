...
{
    public class JavelinAthleteArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public JavelinAthleteArenaMap()
            : base(0x14EB, "Map to Javelin Athlete Arena", 250)
        {
        }

        public JavelinAthleteArenaMap(Serial serial)
            : base(serial)
        {
        }
