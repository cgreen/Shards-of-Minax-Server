...
{
    public class ElementalWizardsKeepMap : MagicMapBase
    {
        ...
        {
			new Point3D(1258, 1237, 0),
			new Point3D(3974, 1087, 0),
			new Point3D(5622, 2995, 0)
        };
        ...
        [Constructable]
        public ElementalWizardsKeepMap()
            : base(0x14EB, "Map to Elemental Wizards Keep", 250)
        {
        }

        public ElementalWizardsKeepMap(Serial serial)
            : base(serial)
        {
        }
