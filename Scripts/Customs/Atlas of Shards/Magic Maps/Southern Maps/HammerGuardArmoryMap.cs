...
{
    public class HammerGuardArmoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public HammerGuardArmoryMap()
            : base(0x14EB, "Map to Hammer Guard Armory", 250)
        {
        }

        public HammerGuardArmoryMap(Serial serial)
            : base(serial)
        {
        }
