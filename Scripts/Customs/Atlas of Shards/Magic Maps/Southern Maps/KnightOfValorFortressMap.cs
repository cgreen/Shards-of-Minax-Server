...
{
    public class KnightOfValorFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public KnightOfValorFortressMap()
            : base(0x14EB, "Map to Knight of Valor Fortress", 250)
        {
        }

        public KnightOfValorFortressMap(Serial serial)
            : base(serial)
        {
        }
