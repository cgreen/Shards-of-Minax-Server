...
{
    public class ChemistsLaboratory : MagicMapBase
    {
        ...
        [Constructable]
        public ChemistsLaboratory()
            : base(0x14EB, "Map to Chemists Laboratory", 250)
        {
        }

        public ChemistsLaboratory(Serial serial)
            : base(serial)
        {
        }
