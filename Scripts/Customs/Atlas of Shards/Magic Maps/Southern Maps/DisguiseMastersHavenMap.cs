...
{
    public class DisguiseMastersHavenMap : MagicMapBase
    {
        ...
        [Constructable]
        public DisguiseMastersHavenMap()
            : base(0x14EB, "Map to Disguise Masters Haven", 250)
        {
        }

        public DisguiseMastersHavenMap(Serial serial)
            : base(serial)
        {
        }
