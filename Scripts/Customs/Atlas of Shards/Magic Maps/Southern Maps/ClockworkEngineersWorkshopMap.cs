...
{
    public class ClockworkEngineersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public ClockworkEngineersWorkshopMap()
            : base(0x14EB, "Map to Clockwork Engineers Workshop", 250)
        {
        }

        public ClockworkEngineersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
