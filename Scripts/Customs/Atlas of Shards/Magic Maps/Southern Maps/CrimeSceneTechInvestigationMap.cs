...
{
    public class CrimeSceneTechInvestigationMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrimeSceneTechInvestigationMap()
            : base(0x14EB, "Map to Crime Scene Tech Investigation", 250)
        {
        }

        public CrimeSceneTechInvestigationMap(Serial serial)
            : base(serial)
        {
        }
