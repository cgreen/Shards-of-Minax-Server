...
{
    public class InfiltratorsHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public InfiltratorsHideoutMap()
            : base(0x14EB, "Map to Infiltrators Hideout", 250)
        {
        }

        public InfiltratorsHideoutMap(Serial serial)
            : base(serial)
        {
        }
