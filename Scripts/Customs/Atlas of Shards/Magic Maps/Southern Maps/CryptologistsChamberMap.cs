...
{
    public class CryptologistsChamberMap : MagicMapBase
    {
        ...
        [Constructable]
        public CryptologistsChamberMap()
            : base(0x14EB, "Map to Cryptologists Chamber", 250)
        {
        }

        public CryptologistsChamberMap(Serial serial)
            : base(serial)
        {
        }
