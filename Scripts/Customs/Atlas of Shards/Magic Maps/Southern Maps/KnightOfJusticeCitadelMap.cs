...
{
    public class KnightOfJusticeCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public KnightOfJusticeCitadelMap()
            : base(0x14EB, "Map to Knight of Justice Citadel", 250)
        {
        }

        public KnightOfJusticeCitadelMap(Serial serial)
            : base(serial)
        {
        }
