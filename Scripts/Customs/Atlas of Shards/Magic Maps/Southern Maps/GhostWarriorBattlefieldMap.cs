...
{
    public class GhostWarriorBattlefieldMap : MagicMapBase
    {
        ...
        [Constructable]
        public GhostWarriorBattlefieldMap()
            : base(0x14EB, "Map to Ghost Warrior Battlefield", 250)
        {
        }

        public GhostWarriorBattlefieldMap(Serial serial)
            : base(serial)
        {
        }
