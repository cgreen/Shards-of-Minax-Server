...
{
    public class KnightOfMercyChapelMap : MagicMapBase
    {
        ...
        [Constructable]
        public KnightOfMercyChapelMap()
            : base(0x14EB, "Map to Knight of Mercy Chapel", 250)
        {
        }

        public KnightOfMercyChapelMap(Serial serial)
            : base(serial)
        {
        }
