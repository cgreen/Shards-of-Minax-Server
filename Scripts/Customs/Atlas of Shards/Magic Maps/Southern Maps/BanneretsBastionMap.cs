// ─────────────────────────────────────────────────────────────────────────────
//  BANNERET'S BASTION MAGIC MAP  ––  just its unique data + champ‐spawn override
// ────────────────────────────────────────────────────────────────────────────
...
{
    public class BanneretsBastionMap : MagicMapBase
    {
        ...
        {
			new Point3D(5461, 74, 0),
			new Point3D(1322, 3453, 0),
			new Point3D(873, 3359, 25)
        };
        ...
        [Constructable]
        public BanneretsBastionMap()
            : base(0x14EB, "Map to Banneret's Bastion", 1490)
        {
        }

        public BanneretsBastionMap(Serial serial)
            : base(serial)
        {
        }
