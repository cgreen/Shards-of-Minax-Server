...
{
    public class LibrarianCustodiansArchiveMap : MagicMapBase
    {
        ...
        [Constructable]
        public LibrarianCustodiansArchiveMap()
            : base(0x14EB, "Map to Librarian Custodians Archive", 250)
        {
        }

        public LibrarianCustodiansArchiveMap(Serial serial)
            : base(serial)
        {
        }
