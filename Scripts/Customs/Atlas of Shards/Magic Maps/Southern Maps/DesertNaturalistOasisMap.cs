...
{
    public class DesertNaturalistOasisMap : MagicMapBase
    {
        ...
        [Constructable]
        public DesertNaturalistOasisMap()
            : base(0x14EB, "Map to Desert Naturalist Oasis", 250)
        {
        }

        public DesertNaturalistOasisMap(Serial serial)
            : base(serial)
        {
        }
