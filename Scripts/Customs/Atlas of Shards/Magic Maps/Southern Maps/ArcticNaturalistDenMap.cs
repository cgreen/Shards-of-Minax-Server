// ─────────────────────────────────────────────────────────────────────────────
//  ARCTIC NATURALIST DEN MAGIC MAP  ––  just its unique data + champ‐spawn override
// ────────────────────────────────────────────────────────────────────────────
...
{
    public class ArcticNaturalistDenMap : MagicMapBase
    {
        ...
        {
			new Point3D(1168, 3281, 0),
			new Point3D(1673, 1989, 0),
			new Point3D(1467, 2652, 0)
        };
        ...
        {
            MiniChampType.Encounter5  // Add the relevant types you want to use
        };
        ...
        [Constructable]
        public ArcticNaturalistDenMap()
            : base(0x14EB, "Map to Arctic Naturalist Den", 1490)
        {
        }

        public ArcticNaturalistDenMap(Serial serial)
            : base(serial)
        {
        }
