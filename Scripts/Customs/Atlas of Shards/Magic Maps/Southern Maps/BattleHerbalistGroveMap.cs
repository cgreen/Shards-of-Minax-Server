...
{
    public class BattleHerbalistGroveMap : MagicMapBase
    {
        ...
        {
			new Point3D(5265, 2543, 10),
			new Point3D(5948, 3202, 0),
			new Point3D(5756, 2497, 0)
        };
        ...
        [Constructable]
        public BattleHerbalistGroveMap()
            : base(0x14EB, "Map to Battle Herbalist Grove", 250)
        {
        }

        public BattleHerbalistGroveMap(Serial serial)
            : base(serial)
        {
        }
