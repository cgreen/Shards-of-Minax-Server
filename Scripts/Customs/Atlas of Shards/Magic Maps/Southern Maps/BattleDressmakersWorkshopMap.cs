...
{
    public class BattleDressmakersWorkshopMap : MagicMapBase
    {
        ...
        {
			new Point3D(5971, 2514, 0),
			new Point3D(5929, 2998, 0),
			new Point3D(5533, 2733, 0)
        };
        ...
        [Constructable]
        public BattleDressmakersWorkshopMap()
            : base(0x14EB, "Map to Battle Dressmakers Workshop", 250)
        {
        }

        public BattleDressmakersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
