...
{
    public class EvilMapMakersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public EvilMapMakersWorkshopMap()
            : base(0x14EB, "Map to Evil Map Makers Workshop", 250)
        {
        }

        public EvilMapMakersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
