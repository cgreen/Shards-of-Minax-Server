...
{
    public class CombatMedicsSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public CombatMedicsSanctuaryMap()
            : base(0x14EB, "Map to Combat Medics Sanctuary", 250)
        {
        }

        public CombatMedicsSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
