...
{
    public class ExplosiveDemolitionistsFoundryMap : MagicMapBase
    {
        ...
        [Constructable]
        public ExplosiveDemolitionistsFoundryMap()
            : base(0x14EB, "Map to Explosive Demolitionists Foundry", 250)
        {
        }

        public ExplosiveDemolitionistsFoundryMap(Serial serial)
            : base(serial)
        {
        }
