...
{
    public class LogiciansPuzzleHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public LogiciansPuzzleHallMap()
            : base(0x14EB, "Map to Logicians Puzzle Hall", 250)
        {
        }

        public LogiciansPuzzleHallMap(Serial serial)
            : base(serial)
        {
        }
