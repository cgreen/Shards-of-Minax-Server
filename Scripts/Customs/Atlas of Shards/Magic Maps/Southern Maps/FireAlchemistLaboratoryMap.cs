...
{
    public class FireAlchemistLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public FireAlchemistLaboratoryMap()
            : base(0x14EB, "Map to Fire Alchemist Laboratory", 250)
        {
        }

        public FireAlchemistLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
