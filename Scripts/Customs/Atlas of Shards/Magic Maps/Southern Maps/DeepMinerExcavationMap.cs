...
{
    public class DeepMinerExcavationMap : MagicMapBase
    {
        ...
        [Constructable]
        public DeepMinerExcavationMap()
            : base(0x14EB, "Map to Deep Miner Excavation", 250)
        {
        }

        public DeepMinerExcavationMap(Serial serial)
            : base(serial)
        {
        }
