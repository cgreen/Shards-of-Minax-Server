...
{
    public class DeathCultistCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public DeathCultistCryptMap()
            : base(0x14EB, "Map to Death Cultist Crypt", 250)
        {
        }

        public DeathCultistCryptMap(Serial serial)
            : base(serial)
        {
        }
