...
{
    public class ClueSeekersPuzzleGroundsMap : MagicMapBase
    {
        ...
        [Constructable]
        public ClueSeekersPuzzleGroundsMap()
            : base(0x14EB, "Map to Clue Seekers Puzzle Grounds", 250)
        {
        }

        public ClueSeekersPuzzleGroundsMap(Serial serial)
            : base(serial)
        {
        }
