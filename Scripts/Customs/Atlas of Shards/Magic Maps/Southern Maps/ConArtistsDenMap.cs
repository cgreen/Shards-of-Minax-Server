...
{
    public class ConArtistsDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public ConArtistsDenMap()
            : base(0x14EB, "Map to Con Artists Den", 250)
        {
        }

        public ConArtistsDenMap(Serial serial)
            : base(serial)
        {
        }
