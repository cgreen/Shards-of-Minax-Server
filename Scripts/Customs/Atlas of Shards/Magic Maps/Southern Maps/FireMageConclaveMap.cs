...
{
    public class FireMageConclaveMap : MagicMapBase
    {
        ...
        [Constructable]
        public FireMageConclaveMap()
            : base(0x14EB, "Map to Fire Mage Conclave", 250)
        {
        }

        public FireMageConclaveMap(Serial serial)
            : base(serial)
        {
        }
