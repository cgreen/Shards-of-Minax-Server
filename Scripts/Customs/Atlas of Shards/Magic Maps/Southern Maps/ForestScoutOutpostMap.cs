...
{
    public class ForestScoutOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForestScoutOutpostMap()
            : base(0x14EB, "Map to Forest Scout Outpost", 250)
        {
        }

        public ForestScoutOutpostMap(Serial serial)
            : base(serial)
        {
        }
