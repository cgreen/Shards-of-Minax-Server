...
{
    public class BigCatTamerJungleMap : MagicMapBase
    {
        ...
        [Constructable]
        public BigCatTamerJungleMap()
            : base(0x14EB, "Map to Big Cat Tamer Jungle", 250)
        {
        }

        public BigCatTamerJungleMap(Serial serial)
            : base(serial)
        {
        }
