...
{
    public class BattleStormCallersEyeMap : MagicMapBase
    {
        ...
        {
			new Point3D(5238, 1140, 0),
			new Point3D(5212, 257, 0),
			new Point3D(3856, 3030, 0)
        };
        ...
        [Constructable]
        public BattleStormCallersEyeMap()
            : base(0x14EB, "Map to Battle Storm Callers Eye", 250)
        {
        }

        public BattleStormCallersEyeMap(Serial serial)
            : base(serial)
        {
        }
