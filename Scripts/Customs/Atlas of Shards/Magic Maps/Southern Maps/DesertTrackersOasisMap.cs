...
{
    public class DesertTrackersOasisMap : MagicMapBase
    {
        ...
        [Constructable]
        public DesertTrackersOasisMap()
            : base(0x14EB, "Map to Desert Trackers Oasis", 250)
        {
        }

        public DesertTrackersOasisMap(Serial serial)
            : base(serial)
        {
        }
