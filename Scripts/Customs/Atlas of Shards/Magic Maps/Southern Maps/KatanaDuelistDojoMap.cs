...
{
    public class KatanaDuelistDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public KatanaDuelistDojoMap()
            : base(0x14EB, "Map to Katana Duelist Dojo", 250)
        {
        }

        public KatanaDuelistDojoMap(Serial serial)
            : base(serial)
        {
        }
