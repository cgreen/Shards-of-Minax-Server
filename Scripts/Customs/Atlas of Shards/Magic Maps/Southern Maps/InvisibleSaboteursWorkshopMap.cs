...
{
    public class InvisibleSaboteursWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public InvisibleSaboteursWorkshopMap()
            : base(0x14EB, "Map to Invisible Saboteurs Workshop", 250)
        {
        }

        public InvisibleSaboteursWorkshopMap(Serial serial)
            : base(serial)
        {
        }
