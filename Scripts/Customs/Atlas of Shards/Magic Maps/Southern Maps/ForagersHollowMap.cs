...
{
    public class ForagersHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForagersHollowMap()
            : base(0x14EB, "Map to Foragers Hollow", 250)
        {
        }

        public ForagersHollowMap(Serial serial)
            : base(serial)
        {
        }
