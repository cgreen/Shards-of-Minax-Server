...
{
    public class EscapeArtistHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public EscapeArtistHideoutMap()
            : base(0x14EB, "Map to Escape Artist Hideout", 250)
        {
        }

        public EscapeArtistHideoutMap(Serial serial)
            : base(serial)
        {
        }
