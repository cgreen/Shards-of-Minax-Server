...
{
    public class CabinetMakersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public CabinetMakersWorkshopMap()
            : base(0x14EB, "Map to Cabinet Makers Workshop", 250)
        {
        }

        public CabinetMakersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
