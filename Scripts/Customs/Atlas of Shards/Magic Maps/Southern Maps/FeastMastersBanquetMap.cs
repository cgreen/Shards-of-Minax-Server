...
{
    public class FeastMastersBanquetMap : MagicMapBase
    {
        ...
        [Constructable]
        public FeastMastersBanquetMap()
            : base(0x14EB, "Map to Feast Masters Banquet", 250)
        {
        }

        public FeastMastersBanquetMap(Serial serial)
            : base(serial)
        {
        }
