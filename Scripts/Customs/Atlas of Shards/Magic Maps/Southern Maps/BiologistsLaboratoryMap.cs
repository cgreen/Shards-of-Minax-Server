...
{
    public class BiologistsLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public BiologistsLaboratoryMap()
            : base(0x14EB, "Map to Biologists Laboratory", 250)
        {
        }

        public BiologistsLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
