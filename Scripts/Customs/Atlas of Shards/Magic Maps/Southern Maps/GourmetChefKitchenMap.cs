...
{
    public class GourmetChefKitchenMap : MagicMapBase
    {
        ...
        [Constructable]
        public GourmetChefKitchenMap()
            : base(0x14EB, "Map to Gourmet Chef Kitchen", 250)
        {
        }

        public GourmetChefKitchenMap(Serial serial)
            : base(serial)
        {
        }
