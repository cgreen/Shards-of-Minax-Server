...
{
    public class IllusionistsLabyrinthMap : MagicMapBase
    {
        ...
        {
			new Point3D(996, 872, 4),
			new Point3D(2468, 637, 4),
			new Point3D(5260, 1718, 0)
        };
        ...
        [Constructable]
        public IllusionistsLabyrinthMap()
            : base(0x14EB, "Map to Illusionists Labyrinth", 250)
        {
        }

        public IllusionistsLabyrinthMap(Serial serial)
            : base(serial)
        {
        }
