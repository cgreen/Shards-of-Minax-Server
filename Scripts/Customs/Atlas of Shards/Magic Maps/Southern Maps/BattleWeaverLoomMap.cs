...
{
    public class BattleWeaverLoomMap : MagicMapBase
    {
        ...
        [Constructable]
        public BattleWeaverLoomMap()
            : base(0x14EB, "Map to Battle Weaver Loom", 250)
        {
        }

        public BattleWeaverLoomMap(Serial serial)
            : base(serial)
        {
        }
