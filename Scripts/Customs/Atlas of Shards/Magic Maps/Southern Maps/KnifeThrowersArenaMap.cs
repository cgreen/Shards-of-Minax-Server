...
{
    public class KnifeThrowersArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public KnifeThrowersArenaMap()
            : base(0x14EB, "Map to Knife Throwers Arena", 250)
        {
        }

        public KnifeThrowersArenaMap(Serial serial)
            : base(serial)
        {
        }
