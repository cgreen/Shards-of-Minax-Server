...
{
    public class BattlefieldHealersSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public BattlefieldHealersSanctuaryMap()
            : base(0x14EB, "Map to Battlefield Healers Sanctuary", 250)
        {
        }

        public BattlefieldHealersSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
