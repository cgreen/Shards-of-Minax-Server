...
{
    public class FencingMastersArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public FencingMastersArenaMap()
            : base(0x14EB, "Map to Fencing Masters Arena", 250)
        {
        }

        public FencingMastersArenaMap(Serial serial)
            : base(serial)
        {
        }
