...
{
    public class BeastmastersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public BeastmastersDomainMap()
            : base(0x14EB, "Map to Beastmasters Domain", 250)
        {
        }

        public BeastmastersDomainMap(Serial serial)
            : base(serial)
        {
        }
