...
{
    public class ForensicAnalystsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForensicAnalystsLairMap()
            : base(0x14EB, "Map to Forensic Analysts Lair", 250)
        {
        }

        public ForensicAnalystsLairMap(Serial serial)
            : base(serial)
        {
        }
