...
{
    public class DrumBoysSpectacleMap : MagicMapBase
    {
        ...
        [Constructable]
        public DrumBoysSpectacleMap()
            : base(0x14EB, "Map to Drum Boys Spectacle", 250)
        {
        }

        public DrumBoysSpectacleMap(Serial serial)
            : base(serial)
        {
        }
