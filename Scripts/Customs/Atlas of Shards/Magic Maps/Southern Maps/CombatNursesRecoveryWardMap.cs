...
{
    public class CombatNursesRecoveryWardMap : MagicMapBase
    {
        ...
        [Constructable]
        public CombatNursesRecoveryWardMap()
            : base(0x14EB, "Map to Combat Nurses Recovery Ward", 250)
        {
        }

        public CombatNursesRecoveryWardMap(Serial serial)
            : base(serial)
        {
        }
