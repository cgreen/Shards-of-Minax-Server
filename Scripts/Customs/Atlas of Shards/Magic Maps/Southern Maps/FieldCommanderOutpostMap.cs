...
{
    public class FieldCommanderOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public FieldCommanderOutpostMap()
            : base(0x14EB, "Map to Field Commander Outpost", 250)
        {
        }

        public FieldCommanderOutpostMap(Serial serial)
            : base(serial)
        {
        }
