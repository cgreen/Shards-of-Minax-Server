...
{
    public class CryingOrphanRefugeMap : MagicMapBase
    {
        ...
        [Constructable]
        public CryingOrphanRefugeMap()
            : base(0x14EB, "Map to Crying Orphan Refuge", 250)
        {
        }

        public CryingOrphanRefugeMap(Serial serial)
            : base(serial)
        {
        }
