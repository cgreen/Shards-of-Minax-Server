...
{
    public class DemolitionExpertQuarryMap : MagicMapBase
    {
        ...
        [Constructable]
        public DemolitionExpertQuarryMap()
            : base(0x14EB, "Map to Demolition Expert Quarry", 250)
        {
        }

        public DemolitionExpertQuarryMap(Serial serial)
            : base(serial)
        {
        }
