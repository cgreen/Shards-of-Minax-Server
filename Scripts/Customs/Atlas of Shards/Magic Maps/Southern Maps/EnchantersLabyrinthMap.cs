...
{
    public class EnchantersLabyrinthMap : MagicMapBase
    {
        ...
        [Constructable]
        public EnchantersLabyrinthMap()
            : base(0x14EB, "Map to Enchanters Labyrinth", 250)
        {
        }

        public EnchantersLabyrinthMap(Serial serial)
            : base(serial)
        {
        }
