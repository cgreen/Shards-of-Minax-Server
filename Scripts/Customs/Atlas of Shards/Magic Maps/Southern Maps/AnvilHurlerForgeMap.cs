// ─────────────────────────────────────────────────────────────────────────────
//  ANVIL HURLER FORGE MAGIC MAP  ––  just its unique data + champ‐spawn override
// ────────────────────────────────────────────────────────────────────────────
...
{
    public class AnvilHurlerForgeMap : MagicMapBase
    {
            ...
            => _overridePredefinedLocations ?? new List<Point3D>
        {
			...
			new Point3D(4011, 3207, 0),
			new Point3D(5504, 1721, 0)
        };
        ...
        {
            MiniChampType.Encounter2 // Level 2
        };
        ...
        [Constructable]
        public AnvilHurlerForgeMap()
            : base(0x14EB, "Map to Anvil Hurler Forge", 1501)
        {
        }

        public AnvilHurlerForgeMap(Serial serial)
            : base(serial)
        {
        }
