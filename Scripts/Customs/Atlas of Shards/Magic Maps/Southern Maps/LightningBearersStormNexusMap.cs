...
{
    public class LightningBearersStormNexusMap : MagicMapBase
    {
        ...
        [Constructable]
        public LightningBearersStormNexusMap()
            : base(0x14EB, "Map to Lightning Bearers Storm Nexus", 250)
        {
        }

        public LightningBearersStormNexusMap(Serial serial)
            : base(serial)
        {
        }
