...
{
    public class HerbalistPoisonerGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public HerbalistPoisonerGroveMap()
            : base(0x14EB, "Map to Herbalist Poisoner Grove", 250)
        {
        }

        public HerbalistPoisonerGroveMap(Serial serial)
            : base(serial)
        {
        }
