...
{
    public class BoomerangThrowerCampMap : MagicMapBase
    {
        ...
        [Constructable]
        public BoomerangThrowerCampMap()
            : base(0x14EB, "Map to Boomerang Thrower Camp", 250)
        {
        }

        public BoomerangThrowerCampMap(Serial serial)
            : base(serial)
        {
        }
