...
{
    public class LocksmithsWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public LocksmithsWorkshopMap()
            : base(0x14EB, "Map to Locksmiths Workshop", 250)
        {
        }

        public LocksmithsWorkshopMap(Serial serial)
            : base(serial)
        {
        }
