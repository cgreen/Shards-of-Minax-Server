...
{
    public class FlameWelderForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public FlameWelderForgeMap()
            : base(0x14EB, "Map to Flame Welder Forge", 250)
        {
        }

        public FlameWelderForgeMap(Serial serial)
            : base(serial)
        {
        }
