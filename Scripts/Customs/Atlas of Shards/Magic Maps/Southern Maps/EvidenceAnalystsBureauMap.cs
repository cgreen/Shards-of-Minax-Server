...
{
    public class EvidenceAnalystsBureauMap : MagicMapBase
    {
        ...
        {
			new Point3D(5447, 919, 0),
			new Point3D(5516, 2506, 0),
			new Point3D(6045, 278, 0)
        };
        ...
        [Constructable]
        public EvidenceAnalystsBureauMap()
            : base(0x14EB, "Map to Evidence Analysts Bureau", 250)
        {
        }

        public EvidenceAnalystsBureauMap(Serial serial)
            : base(serial)
        {
        }
