...
{
    public class DecoyDeployerOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public DecoyDeployerOutpostMap()
            : base(0x14EB, "Map to Decoy Deployer Outpost", 250)
        {
        }

        public DecoyDeployerOutpostMap(Serial serial)
            : base(serial)
        {
        }
