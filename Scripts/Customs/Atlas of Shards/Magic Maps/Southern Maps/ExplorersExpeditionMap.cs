...
{
    public class ExplorersExpeditionMap : MagicMapBase
    {
        ...
        [Constructable]
        public ExplorersExpeditionMap()
            : base(0x14EB, "Map to Explorers Expedition", 250)
        {
        }

        public ExplorersExpeditionMap(Serial serial)
            : base(serial)
        {
        }
