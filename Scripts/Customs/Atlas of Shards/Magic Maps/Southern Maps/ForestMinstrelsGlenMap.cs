...
{
    public class ForestMinstrelsGlenMap : MagicMapBase
    {
        ...
        [Constructable]
        public ForestMinstrelsGlenMap()
            : base(0x14EB, "Map to Forest Minstrels Glen", 250)
        {
        }

        public ForestMinstrelsGlenMap(Serial serial)
            : base(serial)
        {
        }
