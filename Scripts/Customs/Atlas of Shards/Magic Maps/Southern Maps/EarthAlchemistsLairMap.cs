...
{
    public class EarthAlchemistsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public EarthAlchemistsLairMap()
            : base(0x14EB, "Map to Earth Alchemists Lair", 250)
        {
        }

        public EarthAlchemistsLairMap(Serial serial)
            : base(serial)
        {
        }
