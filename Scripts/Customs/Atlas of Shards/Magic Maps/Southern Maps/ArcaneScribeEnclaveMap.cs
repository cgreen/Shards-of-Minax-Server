// ─────────────────────────────────────────────────────────────────────────────
//  ARCANE SCRIBE ENCAVE MAGIC MAP  ––  just its unique data + champ‐spawn override
// ────────────────────────────────────────────────────────────────────────────
...
{
    public class ArcaneScribeEnclaveMap : MagicMapBase
    {
        ...
        {
			new Point3D(3054, 2296, 0),
			new Point3D(5284, 3240, 0),
			new Point3D(3974, 1087, 0)
        };
        ...
        [Constructable]
        public ArcaneScribeEnclaveMap()
            : base(0x14EB, "Map to Arcane Scribe Enclave", 1491)
        {
        }

        public ArcaneScribeEnclaveMap(Serial serial)
            : base(serial)
        {
        }
