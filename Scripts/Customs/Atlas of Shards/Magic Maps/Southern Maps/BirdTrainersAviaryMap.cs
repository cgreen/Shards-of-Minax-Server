...
{
    public class BirdTrainersAviaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public BirdTrainersAviaryMap()
            : base(0x14EB, "Map to Bird Trainers Aviary", 250)
        {
        }

        public BirdTrainersAviaryMap(Serial serial)
            : base(serial)
        {
        }
