...
{
    public class ContortionistsCircusMap : MagicMapBase
    {
        ...
        [Constructable]
        public ContortionistsCircusMap()
            : base(0x14EB, "Map to Contortionists Circus", 250)
        {
        }

        public ContortionistsCircusMap(Serial serial)
            : base(serial)
        {
        }
