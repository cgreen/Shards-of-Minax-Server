...
{
    public class SerpentHandlerPitMap : MagicMapBase
    {
        ...
        [Constructable]
        public SerpentHandlerPitMap()
            : base(0x14EB, "Map to Serpent Handler Pit", 350)
        {
        }

        public SerpentHandlerPitMap(Serial serial)
            : base(serial)
        {
        }
