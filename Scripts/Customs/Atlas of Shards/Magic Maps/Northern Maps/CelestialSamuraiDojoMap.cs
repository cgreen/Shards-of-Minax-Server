...
{
    public class CelestialSamuraiDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialSamuraiDojoMap()
            : base(0x14EB, "Map to Celestial Samurai Dojo", 350)
        {
        }

        public CelestialSamuraiDojoMap(Serial serial)
            : base(serial)
        {
        }
