...
{
    public class SlyStorytellersTheatreMap : MagicMapBase
    {
        ...
        [Constructable]
        public SlyStorytellersTheatreMap()
            : base(0x14EB, "Map to Sly Storytellers Theatre", 350)
        {
        }

        public SlyStorytellersTheatreMap(Serial serial)
            : base(serial)
        {
        }
