...
{
    public class ScoutArchersRefugeMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScoutArchersRefugeMap()
            : base(0x14EB, "Map to Scout Archers Refuge", 350)
        {
        }

        public ScoutArchersRefugeMap(Serial serial)
            : base(serial)
        {
        }
