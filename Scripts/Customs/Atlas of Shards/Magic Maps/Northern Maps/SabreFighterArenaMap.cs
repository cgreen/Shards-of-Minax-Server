...
{
    public class SabreFighterArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public SabreFighterArenaMap()
            : base(0x14EB, "Map to Sabre Fighter Arena", 350)
        {
        }

        public SabreFighterArenaMap(Serial serial)
            : base(serial)
        {
        }
