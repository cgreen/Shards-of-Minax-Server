...
{
    public class VenomousAssassinsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousAssassinsLairMap()
            : base(0x14EB, "Map to Venomous Assassins Lair", 350)
        {
        }

        public VenomousAssassinsLairMap(Serial serial)
            : base(serial)
        {
        }
