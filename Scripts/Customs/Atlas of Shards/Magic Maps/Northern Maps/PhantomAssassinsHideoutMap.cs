...
{
    public class PhantomAssassinsHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public PhantomAssassinsHideoutMap()
            : base(0x14EB, "Map to Phantom Assassins Hideout", 350)
        {
        }

        public PhantomAssassinsHideoutMap(Serial serial)
            : base(serial)
        {
        }
