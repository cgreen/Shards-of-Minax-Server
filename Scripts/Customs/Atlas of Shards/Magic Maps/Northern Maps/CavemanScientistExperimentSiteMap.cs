...
{
    public class CavemanScientistExperimentSiteMap : MagicMapBase
    {
        ...
        [Constructable]
        public CavemanScientistExperimentSiteMap()
            : base(0x14EB, "Map to Caveman Scientist Experiment Site", 350)
        {
        }

        public CavemanScientistExperimentSiteMap(Serial serial)
            : base(serial)
        {
        }
