...
{
    public class MasterFlutistsConcertMap : MagicMapBase
    {
        ...
        [Constructable]
        public MasterFlutistsConcertMap()
            : base(0x14EB, "Map to Master Flutists Concert", 350)
        {
        }

        public MasterFlutistsConcertMap(Serial serial)
            : base(serial)
        {
        }
