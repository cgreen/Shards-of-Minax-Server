...
{
    public class ShieldMaidensCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShieldMaidensCitadelMap()
            : base(0x14EB, "Map to Shield Maidens Citadel", 350)
        {
        }

        public ShieldMaidensCitadelMap(Serial serial)
            : base(serial)
        {
        }
