...
{
    public class StormConjurerSummitMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormConjurerSummitMap()
            : base(0x14EB, "Map to Storm Conjurer Summit", 350)
        {
        }

        public StormConjurerSummitMap(Serial serial)
            : base(serial)
        {
        }
