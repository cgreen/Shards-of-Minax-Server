...
{
    public class NymphSingerGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public NymphSingerGladeMap()
            : base(0x14EB, "Map to Nymph Singer Glade", 350)
        {
        }

        public NymphSingerGladeMap(Serial serial)
            : base(serial)
        {
        }
