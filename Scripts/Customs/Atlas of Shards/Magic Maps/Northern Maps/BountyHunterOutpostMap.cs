...
{
    public class BountyHunterOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public BountyHunterOutpostMap()
            : base(0x14EB, "Map to Bounty Hunter Outpost", 350)
        {
        }

        public BountyHunterOutpostMap(Serial serial)
            : base(serial)
        {
        }
