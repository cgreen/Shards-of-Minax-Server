...
{
    public class SamuraiMastersDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public SamuraiMastersDojoMap()
            : base(0x14EB, "Map to Samurai Masters Dojo", 350)
        {
        }

        public SamuraiMastersDojoMap(Serial serial)
            : base(serial)
        {
        }
