...
{
    public class ShadowLurkerCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowLurkerCavernMap()
            : base(0x14EB, "Map to Shadow Lurker Cavern", 350)
        {
        }

        public ShadowLurkerCavernMap(Serial serial)
            : base(serial)
        {
        }
