...
{
    public class TrapMakersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrapMakersWorkshopMap()
            : base(0x14EB, "Map to Trap Makers Workshop", 350)
        {
        }

        public TrapMakersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
