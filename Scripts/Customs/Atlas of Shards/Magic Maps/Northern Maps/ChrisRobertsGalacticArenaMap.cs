...
{
    public class ChrisRobertsGalacticArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public ChrisRobertsGalacticArenaMap()
            : base(0x14EB, "Map to Chris Roberts Galactic Arena", 350)
        {
        }

        public ChrisRobertsGalacticArenaMap(Serial serial)
            : base(serial)
        {
        }
