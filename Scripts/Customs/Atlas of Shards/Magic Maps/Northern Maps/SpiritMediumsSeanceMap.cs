...
{
    public class SpiritMediumsSeanceMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpiritMediumsSeanceMap()
            : base(0x14EB, "Map to Spirit Mediums Seance", 350)
        {
        }

        public SpiritMediumsSeanceMap(Serial serial)
            : base(serial)
        {
        }
