...
{
    public class ShadowLordsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowLordsDomainMap()
            : base(0x14EB, "Map to Shadow Lords Domain", 350)
        {
        }

        public ShadowLordsDomainMap(Serial serial)
            : base(serial)
        {
        }
