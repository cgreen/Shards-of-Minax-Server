...
{
    public class BeetleJuiceSummoningCircleMap : MagicMapBase
    {
        ...
        [Constructable]
        public BeetleJuiceSummoningCircleMap()
            : base(0x14EB, "Map to Beetle Juice Summoning Circle", 350)
        {
        }

        public BeetleJuiceSummoningCircleMap(Serial serial)
            : base(serial)
        {
        }
