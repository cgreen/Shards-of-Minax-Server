...
{
    public class BaroqueBarbarianCampMap : MagicMapBase
    {
        ...
        [Constructable]
        public BaroqueBarbarianCampMap()
            : base(0x14EB, "Map to Baroque Barbarian Camp", 350)
        {
        }

        public BaroqueBarbarianCampMap(Serial serial)
            : base(serial)
        {
        }
