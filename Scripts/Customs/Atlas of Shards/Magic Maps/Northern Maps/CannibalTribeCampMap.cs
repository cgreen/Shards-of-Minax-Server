...
{
    public class CannibalTribeCampMap : MagicMapBase
    {
        ...
        [Constructable]
        public CannibalTribeCampMap()
            : base(0x14EB, "Map to Cannibal Tribe Camp", 350)
        {
        }

        public CannibalTribeCampMap(Serial serial)
            : base(serial)
        {
        }
