...
{
    public class TrickShotArtistsArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrickShotArtistsArenaMap()
            : base(0x14EB, "Map to Trick Shot Artists Arena", 350)
        {
        }

        public TrickShotArtistsArenaMap(Serial serial)
            : base(serial)
        {
        }
