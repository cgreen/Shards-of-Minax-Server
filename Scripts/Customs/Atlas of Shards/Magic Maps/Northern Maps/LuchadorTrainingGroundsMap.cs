...
{
    public class LuchadorTrainingGroundsMap : MagicMapBase
    {
        ...
        [Constructable]
        public LuchadorTrainingGroundsMap()
            : base(0x14EB, "Map to Luchador Training Grounds", 350)
        {
        }

        public LuchadorTrainingGroundsMap(Serial serial)
            : base(serial)
        {
        }
