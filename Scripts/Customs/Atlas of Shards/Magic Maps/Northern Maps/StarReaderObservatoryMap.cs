...
{
    public class StarReaderObservatoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public StarReaderObservatoryMap()
            : base(0x14EB, "Map to Star Reader Observatory", 350)
        {
        }

        public StarReaderObservatoryMap(Serial serial)
            : base(serial)
        {
        }
