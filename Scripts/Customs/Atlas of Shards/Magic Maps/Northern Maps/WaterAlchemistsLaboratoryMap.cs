...
{
    public class WaterAlchemistsLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public WaterAlchemistsLaboratoryMap()
            : base(0x14EB, "Map to Water Alchemists Laboratory", 350)
        {
        }

        public WaterAlchemistsLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
