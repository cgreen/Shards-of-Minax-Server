...
{
    public class AirClanSamuraiDojoMap : MagicMapBase
    {
        ...
        [Constructable]
        public AirClanSamuraiDojoMap()
            : base(0x14EB, "Map to Air Clan Samurai Dojo", 350)
        {
        }

        public AirClanSamuraiDojoMap(Serial serial)
            : base(serial)
        {
        }
