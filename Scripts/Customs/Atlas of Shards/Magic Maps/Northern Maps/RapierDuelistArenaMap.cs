...
{
    public class RapierDuelistArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public RapierDuelistArenaMap()
            : base(0x14EB, "Map to Rapier Duelist Arena", 350)
        {
        }

        public RapierDuelistArenaMap(Serial serial)
            : base(serial)
        {
        }
