...
{
    public class StrategistsWarTableMap : MagicMapBase
    {
        ...
        [Constructable]
        public StrategistsWarTableMap()
            : base(0x14EB, "Map to Strategists War Table", 350)
        {
        }

        public StrategistsWarTableMap(Serial serial)
            : base(serial)
        {
        }
