...
{
    public class TreeFellersGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public TreeFellersGroveMap()
            : base(0x14EB, "Map to Tree Fellers Grove", 350)
        {
        }

        public TreeFellersGroveMap(Serial serial)
            : base(serial)
        {
        }
