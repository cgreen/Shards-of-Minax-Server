...
{
    public class QuantumPhysicistResearchFacilityMap : MagicMapBase
    {
        ...
        [Constructable]
        public QuantumPhysicistResearchFacilityMap()
            : base(0x14EB, "Map to Quantum Physicist Research Facility", 350)
        {
        }

        public QuantumPhysicistResearchFacilityMap(Serial serial)
            : base(serial)
        {
        }
