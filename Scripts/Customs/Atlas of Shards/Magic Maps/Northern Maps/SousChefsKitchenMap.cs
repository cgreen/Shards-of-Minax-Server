...
{
    public class SousChefsKitchenMap : MagicMapBase
    {
        ...
        [Constructable]
        public SousChefsKitchenMap()
            : base(0x14EB, "Map to Sous Chefs Kitchen", 350)
        {
        }

        public SousChefsKitchenMap(Serial serial)
            : base(serial)
        {
        }
