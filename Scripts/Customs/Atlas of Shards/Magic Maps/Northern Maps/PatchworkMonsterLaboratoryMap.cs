...
{
    public class PatchworkMonsterLaboratoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public PatchworkMonsterLaboratoryMap()
            : base(0x14EB, "Map to Patchwork Monster Laboratory", 350)
        {
        }

        public PatchworkMonsterLaboratoryMap(Serial serial)
            : base(serial)
        {
        }
