...
{
    public class DiscoDruidFestivalMap : MagicMapBase
    {
        ...
        [Constructable]
        public DiscoDruidFestivalMap()
            : base(0x14EB, "Map to Disco Druid Festival", 350)
        {
        }

        public DiscoDruidFestivalMap(Serial serial)
            : base(serial)
        {
        }
