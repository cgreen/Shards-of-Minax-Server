...
{
    public class ThievesGuildHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThievesGuildHideoutMap()
            : base(0x14EB, "Map to Thieves Guild Hideout", 350)
        {
        }

        public ThievesGuildHideoutMap(Serial serial)
            : base(serial)
        {
        }
