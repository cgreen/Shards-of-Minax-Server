...
{
    public class RelativistObservatoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public RelativistObservatoryMap()
            : base(0x14EB, "Map to Relativist Observatory", 350)
        {
        }

        public RelativistObservatoryMap(Serial serial)
            : base(serial)
        {
        }
