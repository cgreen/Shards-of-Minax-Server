...
{
    public class RuneCasterSanctumMap : MagicMapBase
    {
        ...
        [Constructable]
        public RuneCasterSanctumMap()
            : base(0x14EB, "Map to Rune Caster Sanctum", 350)
        {
        }

        public RuneCasterSanctumMap(Serial serial)
            : base(serial)
        {
        }
