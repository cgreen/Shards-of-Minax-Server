...
{
    public class CorporateExecutiveTowerMap : MagicMapBase
    {
        ...
        [Constructable]
        public CorporateExecutiveTowerMap()
            : base(0x14EB, "Map to Corporate Executive Tower", 350)
        {
        }

        public CorporateExecutiveTowerMap(Serial serial)
            : base(serial)
        {
        }
