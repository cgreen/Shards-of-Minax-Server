...
{
    public class AssassinGuildHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public AssassinGuildHallMap()
            : base(0x14EB, "Map to Assassin Guild Hall", 350)
        {
        }

        public AssassinGuildHallMap(Serial serial)
            : base(serial)
        {
        }
