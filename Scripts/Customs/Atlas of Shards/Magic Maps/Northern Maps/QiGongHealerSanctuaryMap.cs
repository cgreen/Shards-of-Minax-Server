...
{
    public class QiGongHealerSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public QiGongHealerSanctuaryMap()
            : base(0x14EB, "Map to Qi Gong Healer Sanctuary", 350)
        {
        }

        public QiGongHealerSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
