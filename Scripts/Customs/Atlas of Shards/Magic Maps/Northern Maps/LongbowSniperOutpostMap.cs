...
{
    public class LongbowSniperOutpostMap : MagicMapBase
    {
        ...
        [Constructable]
        public LongbowSniperOutpostMap()
            : base(0x14EB, "Map to Longbow Sniper Outpost", 350)
        {
        }

        public LongbowSniperOutpostMap(Serial serial)
            : base(serial)
        {
        }
