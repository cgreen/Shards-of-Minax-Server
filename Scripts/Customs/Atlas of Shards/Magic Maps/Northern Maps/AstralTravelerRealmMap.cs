...
{
    public class AstralTravelerRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public AstralTravelerRealmMap()
            : base(0x14EB, "Map to Astral Traveler Realm", 350)
        {
        }

        public AstralTravelerRealmMap(Serial serial)
            : base(serial)
        {
        }
