...
{
    public class AlienWarriorNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public AlienWarriorNestMap()
            : base(0x14EB, "Map to Alien Warrior Nest", 350)
        {
        }

        public AlienWarriorNestMap(Serial serial)
            : base(serial)
        {
        }
