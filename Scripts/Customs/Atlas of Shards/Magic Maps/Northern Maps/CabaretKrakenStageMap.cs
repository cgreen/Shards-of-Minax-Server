...
{
    public class CabaretKrakenStageMap : MagicMapBase
    {
        ...
        [Constructable]
        public CabaretKrakenStageMap()
            : base(0x14EB, "Map to Cabaret Kraken Stage", 350)
        {
        }

        public CabaretKrakenStageMap(Serial serial)
            : base(serial)
        {
        }
