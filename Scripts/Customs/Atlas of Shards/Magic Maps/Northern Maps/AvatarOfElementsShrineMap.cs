...
{
    public class AvatarOfElementsShrineMap : MagicMapBase
    {
        ...
        [Constructable]
        public AvatarOfElementsShrineMap()
            : base(0x14EB, "Map to Avatar of Elements Shrine", 350)
        {
        }

        public AvatarOfElementsShrineMap(Serial serial)
            : base(serial)
        {
        }
