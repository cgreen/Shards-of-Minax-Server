...
{
    public class SawmillWorkersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public SawmillWorkersDomainMap()
            : base(0x14EB, "Map to Sawmill Workers Domain", 350)
        {
        }

        public SawmillWorkersDomainMap(Serial serial)
            : base(serial)
        {
        }
