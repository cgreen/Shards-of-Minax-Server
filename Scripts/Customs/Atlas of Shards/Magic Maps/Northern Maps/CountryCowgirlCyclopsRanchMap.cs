...
{
    public class CountryCowgirlCyclopsRanchMap : MagicMapBase
    {
        ...
        [Constructable]
        public CountryCowgirlCyclopsRanchMap()
            : base(0x14EB, "Map to Country Cowgirl Cyclops Ranch", 350)
        {
        }

        public CountryCowgirlCyclopsRanchMap(Serial serial)
            : base(serial)
        {
        }
