...
{
    public class WeaponEnchantersSanctumMap : MagicMapBase
    {
        ...
        [Constructable]
        public WeaponEnchantersSanctumMap()
            : base(0x14EB, "Map to Weapon Enchanters Sanctum", 350)
        {
        }

        public WeaponEnchantersSanctumMap(Serial serial)
            : base(serial)
        {
        }
