...
{
    public class RelicHunterExpeditionMap : MagicMapBase
    {
        ...
        [Constructable]
        public RelicHunterExpeditionMap()
            : base(0x14EB, "Map to Relic Hunter Expedition", 350)
        {
        }

        public RelicHunterExpeditionMap(Serial serial)
            : base(serial)
        {
        }
