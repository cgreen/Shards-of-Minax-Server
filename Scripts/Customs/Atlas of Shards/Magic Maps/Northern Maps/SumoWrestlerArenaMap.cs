...
{
    public class SumoWrestlerArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public SumoWrestlerArenaMap()
            : base(0x14EB, "Map to Sumo Wrestler Arena", 350)
        {
        }

        public SumoWrestlerArenaMap(Serial serial)
            : base(serial)
        {
        }
