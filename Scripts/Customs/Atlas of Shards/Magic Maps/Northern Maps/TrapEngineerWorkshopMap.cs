...
{
    public class TrapEngineerWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrapEngineerWorkshopMap()
            : base(0x14EB, "Map to Trap Engineer Workshop", 350)
        {
        }

        public TrapEngineerWorkshopMap(Serial serial)
            : base(serial)
        {
        }
