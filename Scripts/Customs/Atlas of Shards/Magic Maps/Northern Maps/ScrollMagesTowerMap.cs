...
{
    public class ScrollMagesTowerMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScrollMagesTowerMap()
            : base(0x14EB, "Map to Scroll Mages Tower", 350)
        {
        }

        public ScrollMagesTowerMap(Serial serial)
            : base(serial)
        {
        }
