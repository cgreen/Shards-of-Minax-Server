...
{
    public class PastryChefsBakeryMap : MagicMapBase
    {
        ...
        [Constructable]
        public PastryChefsBakeryMap()
            : base(0x14EB, "Map to Pastry Chefs Bakery", 350)
        {
        }

        public PastryChefsBakeryMap(Serial serial)
            : base(serial)
        {
        }
