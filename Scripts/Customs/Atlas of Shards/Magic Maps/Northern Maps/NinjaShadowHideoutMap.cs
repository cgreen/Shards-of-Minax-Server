...
{
    public class NinjaShadowHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public NinjaShadowHideoutMap()
            : base(0x14EB, "Map to Ninja Shadow Hideout", 350)
        {
        }

        public NinjaShadowHideoutMap(Serial serial)
            : base(serial)
        {
        }
