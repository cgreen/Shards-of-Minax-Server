...
{
    public class ShieldBearersBastionMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShieldBearersBastionMap()
            : base(0x14EB, "Map to ShieldBearersBastion", 350)
        {
        }

        public ShieldBearersBastionMap(Serial serial)
            : base(serial)
        {
        }
