...
{
    public class ViolinistsOrchestraMap : MagicMapBase
    {
        ...
        [Constructable]
        public ViolinistsOrchestraMap()
            : base(0x14EB, "Map to Violinists Orchestra", 350)
        {
        }

        public ViolinistsOrchestraMap(Serial serial)
            : base(serial)
        {
        }
