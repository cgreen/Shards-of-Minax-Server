...
{
    public class AirClanNinjaCampMap : MagicMapBase
    {
        ...
        [Constructable]
        public AirClanNinjaCampMap()
            : base(0x14EB, "Map to Air Clan Ninja Camp", 350)
        {
        }

        public AirClanNinjaCampMap(Serial serial)
            : base(serial)
        {
        }
