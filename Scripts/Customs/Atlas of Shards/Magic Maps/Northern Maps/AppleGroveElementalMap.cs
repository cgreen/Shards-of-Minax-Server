...
{
    public class AppleGroveElementalMap : MagicMapBase
    {
        ...
        [Constructable]
        public AppleGroveElementalMap()
            : base(0x14EB, "Map to Apple Grove Elemental", 350)
        {
        }

        public AppleGroveElementalMap(Serial serial)
            : base(serial)
        {
        }
