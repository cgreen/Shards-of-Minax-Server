...
{
    public class TrapSettersHideoutMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrapSettersHideoutMap()
            : base(0x14EB, "Map to Trap Setters Hideout", 350)
        {
        }

        public TrapSettersHideoutMap(Serial serial)
            : base(serial)
        {
        }
