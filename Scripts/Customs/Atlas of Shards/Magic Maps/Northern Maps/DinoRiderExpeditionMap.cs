...
{
    public class DinoRiderExpeditionMap : MagicMapBase
    {
        ...
        [Constructable]
        public DinoRiderExpeditionMap()
            : base(0x14EB, "Map to Dino Rider Expedition", 350)
        {
        }

        public DinoRiderExpeditionMap(Serial serial)
            : base(serial)
        {
        }
