...
{
    public class ToxicologistsKitchenMap : MagicMapBase
    {
        ...
        [Constructable]
        public ToxicologistsKitchenMap()
            : base(0x14EB, "Map to Toxicologists Kitchen", 350)
        {
        }

        public ToxicologistsKitchenMap(Serial serial)
            : base(serial)
        {
        }
