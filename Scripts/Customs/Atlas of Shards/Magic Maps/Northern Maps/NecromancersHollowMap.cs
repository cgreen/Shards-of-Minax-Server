...
{
    public class NecromancersHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public NecromancersHollowMap()
            : base(0x14EB, "Map to Necromancers Hollow", 350)
        {
        }

        public NecromancersHollowMap(Serial serial)
            : base(serial)
        {
        }
