...
{
    public class RuneKeeperChamberMap : MagicMapBase
    {
        ...
        [Constructable]
        public RuneKeeperChamberMap()
            : base(0x14EB, "Map to Rune Keeper Chamber", 350)
        {
        }

        public RuneKeeperChamberMap(Serial serial)
            : base(serial)
        {
        }
