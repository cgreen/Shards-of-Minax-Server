...
{
    public class SpearFishersCoveMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpearFishersCoveMap()
            : base(0x14EB, "Map to Spear Fishers Cove", 350)
        {
        }

        public SpearFishersCoveMap(Serial serial)
            : base(serial)
        {
        }
