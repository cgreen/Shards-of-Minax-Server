...
{
    public class MagiciansArcaneHallMap : MagicMapBase
    {
        ...
        [Constructable]
        public MagiciansArcaneHallMap()
            : base(0x14EB, "Map to Magicians Arcane Hall", 350)
        {
        }

        public MagiciansArcaneHallMap(Serial serial)
            : base(serial)
        {
        }
