...
{
    public class BMovieBeastmasterArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public BMovieBeastmasterArenaMap()
            : base(0x14EB, "Map to B-Movie Beastmaster Arena", 350)
        {
        }

        public BMovieBeastmasterArenaMap(Serial serial)
            : base(serial)
        {
        }
