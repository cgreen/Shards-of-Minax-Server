...
{
    public class TrapMastersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public TrapMastersWorkshopMap()
            : base(0x14EB, "Map to Trap Masters Workshop", 350)
        {
        }

        public TrapMastersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
