...
{
    public class TerrainScoutEncampmentMap : MagicMapBase
    {
        ...
        [Constructable]
        public TerrainScoutEncampmentMap()
            : base(0x14EB, "Map to Terrain Scout Encampment", 350)
        {
        }

        public TerrainScoutEncampmentMap(Serial serial)
            : base(serial)
        {
        }
