...
{
    public class SwordDefenderCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public SwordDefenderCitadelMap()
            : base(0x14EB, "Map to Sword Defender Citadel", 350)
        {
        }

        public SwordDefenderCitadelMap(Serial serial)
            : base(serial)
        {
        }
