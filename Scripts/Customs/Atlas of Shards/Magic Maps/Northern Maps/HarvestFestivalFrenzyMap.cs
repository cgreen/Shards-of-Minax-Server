...
{
    public class HarvestFestivalFrenzyMap : MagicMapBase
    {
        ...
        [Constructable]
        public HarvestFestivalFrenzyMap()
            : base(0x14EB, "Map to Harvest Festival Frenzy", 350)
        {
        }

        public HarvestFestivalFrenzyMap(Serial serial)
            : base(serial)
        {
        }
