...
{
    public class SpellbreakersTrialMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpellbreakersTrialMap()
            : base(0x14EB, "Map to Spellbreakers Trial", 350)
        {
        }

        public SpellbreakersTrialMap(Serial serial)
            : base(serial)
        {
        }
