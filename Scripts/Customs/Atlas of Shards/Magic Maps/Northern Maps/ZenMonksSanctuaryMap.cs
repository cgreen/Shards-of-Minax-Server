...
{
    public class ZenMonksSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public ZenMonksSanctuaryMap()
            : base(0x14EB, "Map to Zen Monks Sanctuary", 350)
        {
        }

        public ZenMonksSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
