...
{
    public class PocketPickersRefugeMap : MagicMapBase
    {
        ...
        [Constructable]
        public PocketPickersRefugeMap()
            : base(0x14EB, "Map to Pocket Pickers Refuge", 350)
        {
        }

        public PocketPickersRefugeMap(Serial serial)
            : base(serial)
        {
        }
