...
{
    public class ShadowPriestLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowPriestLairMap()
            : base(0x14EB, "Map to Shadow Priest Lair", 350)
        {
        }

        public ShadowPriestLairMap(Serial serial)
            : base(serial)
        {
        }
