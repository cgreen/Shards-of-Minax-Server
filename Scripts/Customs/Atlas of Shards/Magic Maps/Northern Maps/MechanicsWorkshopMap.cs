...
{
    public class MechanicsWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public MechanicsWorkshopMap()
            : base(0x14EB, "Map to Mechanics Workshop", 350)
        {
        }

        public MechanicsWorkshopMap(Serial serial)
            : base(serial)
        {
        }
