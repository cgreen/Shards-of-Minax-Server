...
{
    public class BluesSingingGorgonAmphitheaterMap : MagicMapBase
    {
        ...
        [Constructable]
        public BluesSingingGorgonAmphitheaterMap()
            : base(0x14EB, "Map to Blues Singing Gorgon Amphitheater", 350)
        {
        }

        public BluesSingingGorgonAmphitheaterMap(Serial serial)
            : base(serial)
        {
        }
