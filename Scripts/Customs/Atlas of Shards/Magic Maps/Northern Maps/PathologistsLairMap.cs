...
{
    public class PathologistsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public PathologistsLairMap()
            : base(0x14EB, "Map to Pathologists Lair", 350)
        {
        }

        public PathologistsLairMap(Serial serial)
            : base(serial)
        {
        }
