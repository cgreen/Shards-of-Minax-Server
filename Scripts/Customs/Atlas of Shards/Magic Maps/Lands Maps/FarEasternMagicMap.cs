...
{
    public class FarEasternMagicMap : MagicMapBase
    {
        ...
        [Constructable]
        public FarEasternMagicMap()
            : base(0x14EB, "Far Eastern Lands Magic Map", 2411)
        {
        }

        public FarEasternMagicMap(Serial serial)
            : base(serial)
        {
        }
