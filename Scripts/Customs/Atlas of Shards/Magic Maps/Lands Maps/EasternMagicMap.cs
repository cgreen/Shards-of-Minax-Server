...
{
    public class EasternMagicMap : MagicMapBase
    {
        ...
        [Constructable]
        public EasternMagicMap()
            : base(0x14EB, "Eastern Lands Magic Map", 1730)
        {
        }

        public EasternMagicMap(Serial serial)
            : base(serial)
        {
        }
