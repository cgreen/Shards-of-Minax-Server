...
{
    public class SunbeamFerretHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public SunbeamFerretHollowMap()
            : base(0x14EB, "Map to Sunbeam Ferret Hollow", 650)
        {
        }

        public SunbeamFerretHollowMap(Serial serial)
            : base(serial)
        {
        }
