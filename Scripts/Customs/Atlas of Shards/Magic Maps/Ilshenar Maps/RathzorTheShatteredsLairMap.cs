...
{
    public class RathzorTheShatteredsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public RathzorTheShatteredsLairMap()
            : base(0x14EB, "Map to RathZor the Shattereds Lair", 650)
        {
        }

        public RathzorTheShatteredsLairMap(Serial serial)
            : base(serial)
        {
        }
