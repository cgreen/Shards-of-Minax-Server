...
{
    public class ShadowChicksNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowChicksNestMap()
            : base(0x14EB, "Map to Shadow Chicks Nest", 650)
        {
        }

        public ShadowChicksNestMap(Serial serial)
            : base(serial)
        {
        }
