...
{
    public class StoneRoosterCryptMap : MagicMapBase
    {
        ...
        [Constructable]
        public StoneRoosterCryptMap()
            : base(0x14EB, "Map to Stone Rooster Crypt", 650)
        {
        }

        public StoneRoosterCryptMap(Serial serial)
            : base(serial)
        {
        }
