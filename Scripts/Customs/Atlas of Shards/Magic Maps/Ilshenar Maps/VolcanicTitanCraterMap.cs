...
{
    public class VolcanicTitanCraterMap : MagicMapBase
    {
        ...
        [Constructable]
        public VolcanicTitanCraterMap()
            : base(0x14EB, "Map to Volcanic Titan Crater", 650)
        {
        }

        public VolcanicTitanCraterMap(Serial serial)
            : base(serial)
        {
        }
