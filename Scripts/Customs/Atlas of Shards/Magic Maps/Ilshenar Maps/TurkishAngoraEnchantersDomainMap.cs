...
{
    public class TurkishAngoraEnchantersDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public TurkishAngoraEnchantersDomainMap()
            : base(0x14EB, "Map to Turkish Angora Enchanters Domain", 650)
        {
        }

        public TurkishAngoraEnchantersDomainMap(Serial serial)
            : base(serial)
        {
        }
