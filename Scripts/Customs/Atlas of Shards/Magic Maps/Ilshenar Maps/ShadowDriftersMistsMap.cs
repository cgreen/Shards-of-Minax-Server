...
{
    public class ShadowDriftersMistsMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowDriftersMistsMap()
            : base(0x14EB, "Map to Shadow Drifters Mists", 650)
        {
        }

        public ShadowDriftersMistsMap(Serial serial)
            : base(serial)
        {
        }
