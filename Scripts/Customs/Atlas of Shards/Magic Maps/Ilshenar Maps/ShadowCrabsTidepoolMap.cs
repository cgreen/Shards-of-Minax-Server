...
{
    public class ShadowCrabsTidepoolMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowCrabsTidepoolMap()
            : base(0x14EB, "Map to Shadow Crabs Tidepool", 650)
        {
        }

        public ShadowCrabsTidepoolMap(Serial serial)
            : base(serial)
        {
        }
