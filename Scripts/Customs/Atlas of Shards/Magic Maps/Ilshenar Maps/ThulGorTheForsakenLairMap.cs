...
{
    public class ThulGorTheForsakenLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThulGorTheForsakenLairMap()
            : base(0x14EB, "Map to Thul Gor the Forsaken Lair", 650)
        {
        }

        public ThulGorTheForsakenLairMap(Serial serial)
            : base(serial)
        {
        }
