...
{
    public class ToxicReaverNecropolisMap : MagicMapBase
    {
        ...
        [Constructable]
        public ToxicReaverNecropolisMap()
            : base(0x14EB, "Map to Toxic Reaver Necropolis", 650)
        {
        }

        public ToxicReaverNecropolisMap(Serial serial)
            : base(serial)
        {
        }
