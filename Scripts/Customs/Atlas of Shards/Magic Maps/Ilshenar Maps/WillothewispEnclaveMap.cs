...
{
    public class WillothewispEnclaveMap : MagicMapBase
    {
        ...
        [Constructable]
        public WillothewispEnclaveMap()
            : base(0x14EB, "Map to Will-O-The-Wisp Enclave", 650)
        {
        }

        public WillothewispEnclaveMap(Serial serial)
            : base(serial)
        {
        }
