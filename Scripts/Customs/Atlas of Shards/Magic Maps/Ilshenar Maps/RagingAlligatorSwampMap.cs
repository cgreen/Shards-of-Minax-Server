...
{
    public class RagingAlligatorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public RagingAlligatorSwampMap()
            : base(0x14EB, "Map to Raging Alligator Swamp", 650)
        {
        }

        public RagingAlligatorSwampMap(Serial serial)
            : base(serial)
        {
        }
