...
{
    public class SandstormElementalDesertMap : MagicMapBase
    {
        ...
        [Constructable]
        public SandstormElementalDesertMap()
            : base(0x14EB, "Map to Sandstorm Elemental Desert", 650)
        {
        }

        public SandstormElementalDesertMap(Serial serial)
            : base(serial)
        {
        }
