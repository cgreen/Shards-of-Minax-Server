...
{
    public class MysticFerretSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public MysticFerretSanctuaryMap()
            : base(0x14EB, "Map to Mystic Ferret Sanctuary", 650)
        {
        }

        public MysticFerretSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
