...
{
    public class VenomousAlligatorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousAlligatorSwampMap()
            : base(0x14EB, "Map to Venomous Alligator Swamp", 650)
        {
        }

        public VenomousAlligatorSwampMap(Serial serial)
            : base(serial)
        {
        }
