...
{
    public class RagdollGuardianCitadelMap : MagicMapBase
    {
        ...
        [Constructable]
        public RagdollGuardianCitadelMap()
            : base(0x14EB, "Map to Ragdoll Guardian Citadel", 650)
        {
        }

        public RagdollGuardianCitadelMap(Serial serial)
            : base(serial)
        {
        }
