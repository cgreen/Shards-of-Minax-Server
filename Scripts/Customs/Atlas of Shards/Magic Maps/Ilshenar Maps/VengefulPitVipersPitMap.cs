...
{
    public class VengefulPitVipersPitMap : MagicMapBase
    {
        ...
        [Constructable]
        public VengefulPitVipersPitMap()
            : base(0x14EB, "Map to Vengeful Pit Vipers Pit", 650)
        {
        }

        public VengefulPitVipersPitMap(Serial serial)
            : base(serial)
        {
        }
