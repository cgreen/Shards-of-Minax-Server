...
{
    public class ThunderbirdMountainMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThunderbirdMountainMap()
            : base(0x14EB, "Map to Thunderbird Mountain", 650)
        {
        }

        public ThunderbirdMountainMap(Serial serial)
            : base(serial)
        {
        }
