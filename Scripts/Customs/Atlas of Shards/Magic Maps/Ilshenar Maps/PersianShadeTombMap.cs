...
{
    public class PersianShadeTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public PersianShadeTombMap()
            : base(0x14EB, "Map to Persian Shade Tomb", 650)
        {
        }

        public PersianShadeTombMap(Serial serial)
            : base(serial)
        {
        }
