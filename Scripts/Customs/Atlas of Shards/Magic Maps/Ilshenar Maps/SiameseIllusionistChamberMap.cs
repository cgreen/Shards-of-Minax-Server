...
{
    public class SiameseIllusionistChamberMap : MagicMapBase
    {
        ...
        [Constructable]
        public SiameseIllusionistChamberMap()
            : base(0x14EB, "Map to Siamese Illusionist Chamber", 650)
        {
        }

        public SiameseIllusionistChamberMap(Serial serial)
            : base(serial)
        {
        }
