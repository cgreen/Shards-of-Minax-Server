...
{
    public class ScottishFoldSentinelDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScottishFoldSentinelDenMap()
            : base(0x14EB, "Map to Scottish Fold Sentinel Den", 650)
        {
        }

        public ScottishFoldSentinelDenMap(Serial serial)
            : base(serial)
        {
        }
