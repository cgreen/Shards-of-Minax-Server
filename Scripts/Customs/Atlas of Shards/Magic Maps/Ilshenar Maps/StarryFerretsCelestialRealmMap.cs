...
{
    public class StarryFerretsCelestialRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public StarryFerretsCelestialRealmMap()
            : base(0x14EB, "Map to Starry Ferrets Celestial Realm", 650)
        {
        }

        public StarryFerretsCelestialRealmMap(Serial serial)
            : base(serial)
        {
        }
