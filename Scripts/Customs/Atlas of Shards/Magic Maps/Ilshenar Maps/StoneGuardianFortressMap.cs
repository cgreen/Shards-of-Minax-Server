...
{
    public class StoneGuardianFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public StoneGuardianFortressMap()
            : base(0x14EB, "Map to Stone Guardian Fortress", 650)
        {
        }

        public StoneGuardianFortressMap(Serial serial)
            : base(serial)
        {
        }
