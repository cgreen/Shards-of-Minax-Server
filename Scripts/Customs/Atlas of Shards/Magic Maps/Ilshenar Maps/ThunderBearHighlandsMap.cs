...
{
    public class ThunderBearHighlandsMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThunderBearHighlandsMap()
            : base(0x14EB, "Map to Thunder Bear Highlands", 650)
        {
        }

        public ThunderBearHighlandsMap(Serial serial)
            : base(serial)
        {
        }
