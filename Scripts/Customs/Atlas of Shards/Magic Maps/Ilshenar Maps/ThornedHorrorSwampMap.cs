...
{
    public class ThornedHorrorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThornedHorrorSwampMap()
            : base(0x14EB, "Map to Thorned Horror Swamp", 650)
        {
        }

        public ThornedHorrorSwampMap(Serial serial)
            : base(serial)
        {
        }
