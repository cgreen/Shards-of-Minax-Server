...
{
    public class NatureDragonsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public NatureDragonsLairMap()
            : base(0x14EB, "Map to Nature Dragons Lair", 650)
        {
        }

        public NatureDragonsLairMap(Serial serial)
            : base(serial)
        {
        }
