...
{
    public class PuffyFerretHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public PuffyFerretHollowMap()
            : base(0x14EB, "Map to Puffy Ferret Hollow", 650)
        {
        }

        public PuffyFerretHollowMap(Serial serial)
            : base(serial)
        {
        }
