...
{
    public class QuakeBringerCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public QuakeBringerCavernMap()
            : base(0x14EB, "Map to Quake Bringer Cavern", 650)
        {
        }

        public QuakeBringerCavernMap(Serial serial)
            : base(serial)
        {
        }
