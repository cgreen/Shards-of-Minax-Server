...
{
    public class TarantulaWarriorLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public TarantulaWarriorLairMap()
            : base(0x14EB, "Map to Tarantula Warrior Lair", 650)
        {
        }

        public TarantulaWarriorLairMap(Serial serial)
            : base(serial)
        {
        }
