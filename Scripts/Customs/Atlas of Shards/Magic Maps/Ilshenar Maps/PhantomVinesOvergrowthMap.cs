...
{
    public class PhantomVinesOvergrowthMap : MagicMapBase
    {
        ...
        [Constructable]
        public PhantomVinesOvergrowthMap()
            : base(0x14EB, "Map to Phantom Vines Overgrowth", 650)
        {
        }

        public PhantomVinesOvergrowthMap(Serial serial)
            : base(serial)
        {
        }
