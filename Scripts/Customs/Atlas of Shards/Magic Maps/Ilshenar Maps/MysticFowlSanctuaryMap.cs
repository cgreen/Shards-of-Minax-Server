...
{
    public class MysticFowlSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public MysticFowlSanctuaryMap()
            : base(0x14EB, "Map to Mystic Fowl Sanctuary", 650)
        {
        }

        public MysticFowlSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
