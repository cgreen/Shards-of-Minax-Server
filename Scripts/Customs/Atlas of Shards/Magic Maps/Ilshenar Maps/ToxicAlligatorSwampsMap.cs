...
{
    public class ToxicAlligatorSwampsMap : MagicMapBase
    {
        ...
        [Constructable]
        public ToxicAlligatorSwampsMap()
            : base(0x14EB, "Map to Toxic Alligator Swamps", 650)
        {
        }

        public ToxicAlligatorSwampsMap(Serial serial)
            : base(serial)
        {
        }
