...
{
    public class WhirlwindFiendAbyssMap : MagicMapBase
    {
        ...
        [Constructable]
        public WhirlwindFiendAbyssMap()
            : base(0x14EB, "Map to Whirlwind Fiend Abyss", 650)
        {
        }

        public WhirlwindFiendAbyssMap(Serial serial)
            : base(serial)
        {
        }
