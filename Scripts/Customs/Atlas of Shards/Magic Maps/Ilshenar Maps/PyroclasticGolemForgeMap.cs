...
{
    public class PyroclasticGolemForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public PyroclasticGolemForgeMap()
            : base(0x14EB, "Map to Pyroclastic Golem Forge", 650)
        {
        }

        public PyroclasticGolemForgeMap(Serial serial)
            : base(serial)
        {
        }
