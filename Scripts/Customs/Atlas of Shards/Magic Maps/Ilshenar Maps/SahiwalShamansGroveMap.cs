...
{
    public class SahiwalShamansGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public SahiwalShamansGroveMap()
            : base(0x14EB, "Map to Sahiwal Shamans Grove", 650)
        {
        }

        public SahiwalShamansGroveMap(Serial serial)
            : base(serial)
        {
        }
