...
{
    public class TempestSpiritDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public TempestSpiritDomainMap()
            : base(0x14EB, "Map to Tempest Spirit Domain", 650)
        {
        }

        public TempestSpiritDomainMap(Serial serial)
            : base(serial)
        {
        }
