...
{
    public class NightshadeBrambleGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public NightshadeBrambleGroveMap()
            : base(0x14EB, "Map to Nightshade Bramble Grove", 650)
        {
        }

        public NightshadeBrambleGroveMap(Serial serial)
            : base(serial)
        {
        }
