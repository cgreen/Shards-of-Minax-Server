...
{
    public class TwinTerrorEttinsFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public TwinTerrorEttinsFortressMap()
            : base(0x14EB, "Map to Twin Terror Ettins Fortress", 650)
        {
        }

        public TwinTerrorEttinsFortressMap(Serial serial)
            : base(serial)
        {
        }
