...
{
    public class ShadowDragonsRoostMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowDragonsRoostMap()
            : base(0x14EB, "Map to Shadow Dragons Roost", 650)
        {
        }

        public ShadowDragonsRoostMap(Serial serial)
            : base(serial)
        {
        }
