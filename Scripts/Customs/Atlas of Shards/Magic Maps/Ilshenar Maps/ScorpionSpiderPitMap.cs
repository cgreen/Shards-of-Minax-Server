...
{
    public class ScorpionSpiderPitMap : MagicMapBase
    {
        ...
        [Constructable]
        public ScorpionSpiderPitMap()
            : base(0x14EB, "Map to Scorpion Spider Pit", 650)
        {
        }

        public ScorpionSpiderPitMap(Serial serial)
            : base(serial)
        {
        }
