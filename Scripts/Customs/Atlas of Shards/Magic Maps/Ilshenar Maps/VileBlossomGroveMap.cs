...
{
    public class VileBlossomGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public VileBlossomGroveMap()
            : base(0x14EB, "Map to Vile Blossom Grove", 650)
        {
        }

        public VileBlossomGroveMap(Serial serial)
            : base(serial)
        {
        }
