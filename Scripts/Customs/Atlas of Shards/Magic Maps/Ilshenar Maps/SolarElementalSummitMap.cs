...
{
    public class SolarElementalSummitMap : MagicMapBase
    {
        ...
        [Constructable]
        public SolarElementalSummitMap()
            : base(0x14EB, "Map to Solar Elemental Summit", 650)
        {
        }

        public SolarElementalSummitMap(Serial serial)
            : base(serial)
        {
        }
