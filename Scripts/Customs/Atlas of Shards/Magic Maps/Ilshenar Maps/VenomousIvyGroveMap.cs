...
{
    public class VenomousIvyGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousIvyGroveMap()
            : base(0x14EB, "Map to Venomous Ivy Grove", 650)
        {
        }

        public VenomousIvyGroveMap(Serial serial)
            : base(serial)
        {
        }
