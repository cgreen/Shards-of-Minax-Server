...
{
    public class VorgathTheDestroyerMap : MagicMapBase
    {
        ...
        [Constructable]
        public VorgathTheDestroyerMap()
            : base(0x14EB, "Map to Vorgath the Destroyer", 650)
        {
        }

        public VorgathTheDestroyerMap(Serial serial)
            : base(serial)
        {
        }
