...
{
    public class ShadowAlligatorSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public ShadowAlligatorSwampMap()
            : base(0x14EB, "Map to Shadow Alligator Swamp", 650)
        {
        }

        public ShadowAlligatorSwampMap(Serial serial)
            : base(serial)
        {
        }
