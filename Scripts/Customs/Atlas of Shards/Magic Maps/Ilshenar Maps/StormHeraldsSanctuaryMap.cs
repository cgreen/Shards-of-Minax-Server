...
{
    public class StormHeraldsSanctuaryMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormHeraldsSanctuaryMap()
            : base(0x14EB, "Map to Storm Heralds Sanctuary", 650)
        {
        }

        public StormHeraldsSanctuaryMap(Serial serial)
            : base(serial)
        {
        }
