...
{
    public class PoisonousCrabCoveMap : MagicMapBase
    {
        ...
        [Constructable]
        public PoisonousCrabCoveMap()
            : base(0x14EB, "Map to Poisonous Crab Cove", 650)
        {
        }

        public PoisonousCrabCoveMap(Serial serial)
            : base(serial)
        {
        }
