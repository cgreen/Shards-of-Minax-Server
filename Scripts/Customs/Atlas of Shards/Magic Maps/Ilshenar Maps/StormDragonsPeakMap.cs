...
{
    public class StormDragonsPeakMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormDragonsPeakMap()
            : base(0x14EB, "Map to Storm Dragons Peak", 650)
        {
        }

        public StormDragonsPeakMap(Serial serial)
            : base(serial)
        {
        }
