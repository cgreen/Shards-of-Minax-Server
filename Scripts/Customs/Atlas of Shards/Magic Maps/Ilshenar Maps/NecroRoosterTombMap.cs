...
{
    public class NecroRoosterTombMap : MagicMapBase
    {
        ...
        [Constructable]
        public NecroRoosterTombMap()
            : base(0x14EB, "Map to Necro Rooster Tomb", 650)
        {
        }

        public NecroRoosterTombMap(Serial serial)
            : base(serial)
        {
        }
