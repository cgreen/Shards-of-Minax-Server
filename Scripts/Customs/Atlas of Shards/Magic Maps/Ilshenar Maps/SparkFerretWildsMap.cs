...
{
    public class SparkFerretWildsMap : MagicMapBase
    {
        ...
        [Constructable]
        public SparkFerretWildsMap()
            : base(0x14EB, "Map to Spark Ferret Wilds", 650)
        {
        }

        public SparkFerretWildsMap(Serial serial)
            : base(serial)
        {
        }
