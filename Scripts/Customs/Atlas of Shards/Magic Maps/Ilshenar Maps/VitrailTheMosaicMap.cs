...
{
    public class VitrailTheMosaicMap : MagicMapBase
    {
        ...
        [Constructable]
        public VitrailTheMosaicMap()
            : base(0x14EB, "Map to Vitrail the Mosaic", 650)
        {
        }

        public VitrailTheMosaicMap(Serial serial)
            : base(serial)
        {
        }
