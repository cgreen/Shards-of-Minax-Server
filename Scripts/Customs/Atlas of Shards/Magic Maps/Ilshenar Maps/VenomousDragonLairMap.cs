...
{
    public class VenomousDragonLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousDragonLairMap()
            : base(0x14EB, "Map to Venomous Dragon Lair", 650)
        {
        }

        public VenomousDragonLairMap(Serial serial)
            : base(serial)
        {
        }
