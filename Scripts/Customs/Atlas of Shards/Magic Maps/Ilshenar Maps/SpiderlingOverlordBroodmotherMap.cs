...
{
    public class SpiderlingOverlordBroodmotherMap : MagicMapBase
    {
        ...
        [Constructable]
        public SpiderlingOverlordBroodmotherMap()
            : base(0x14EB, "Map to Spiderling Overlord Broodmother", 650)
        {
        }

        public SpiderlingOverlordBroodmotherMap(Serial serial)
            : base(serial)
        {
        }
