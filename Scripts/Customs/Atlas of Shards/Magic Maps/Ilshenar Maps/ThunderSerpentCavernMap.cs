...
{
    public class ThunderSerpentCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public ThunderSerpentCavernMap()
            : base(0x14EB, "Map to Thunder Serpent Cavern", 650)
        {
        }

        public ThunderSerpentCavernMap(Serial serial)
            : base(serial)
        {
        }
