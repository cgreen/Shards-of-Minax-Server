...
{
    public class SinisterRootHollowMap : MagicMapBase
    {
        ...
        [Constructable]
        public SinisterRootHollowMap()
            : base(0x14EB, "Map to Sinister Root Hollow", 650)
        {
        }

        public SinisterRootHollowMap(Serial serial)
            : base(serial)
        {
        }
