...
{
    public class ZelvrakStrongholdMap : MagicMapBase
    {
        ...
        [Constructable]
        public ZelvrakStrongholdMap()
            : base(0x14EB, "Map to ZelVrak Stronghold", 650)
        {
        }

        public ZelvrakStrongholdMap(Serial serial)
            : base(serial)
        {
        }
