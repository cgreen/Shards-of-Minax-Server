...
{
    public class SphinxCatsRiddleMap : MagicMapBase
    {
        ...
        [Constructable]
        public SphinxCatsRiddleMap()
            : base(0x14EB, "Map to Sphinx Cats Riddle", 650)
        {
        }

        public SphinxCatsRiddleMap(Serial serial)
            : base(serial)
        {
        }
