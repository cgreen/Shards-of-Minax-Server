...
{
    public class TarantulaWorriorCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public TarantulaWorriorCavernMap()
            : base(0x14EB, "Map to Tarantula Worrior Cavern", 650)
        {
        }

        public TarantulaWorriorCavernMap(Serial serial)
            : base(serial)
        {
        }
