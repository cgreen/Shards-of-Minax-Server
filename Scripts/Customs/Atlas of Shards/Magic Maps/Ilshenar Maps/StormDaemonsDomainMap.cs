...
{
    public class StormDaemonsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public StormDaemonsDomainMap()
            : base(0x14EB, "Map to Storm Daemons Domain", 650)
        {
        }

        public StormDaemonsDomainMap(Serial serial)
            : base(serial)
        {
        }
