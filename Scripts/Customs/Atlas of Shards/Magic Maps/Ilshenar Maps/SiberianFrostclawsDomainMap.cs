...
{
    public class SiberianFrostclawsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public SiberianFrostclawsDomainMap()
            : base(0x14EB, "Map to Siberian Frostclaws Domain", 650)
        {
        }

        public SiberianFrostclawsDomainMap(Serial serial)
            : base(serial)
        {
        }
