...
{
    public class MoltenGolemCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public MoltenGolemCavernMap()
            : base(0x14EB, "Map to Molten Golem Cavern", 650)
        {
        }

        public MoltenGolemCavernMap(Serial serial)
            : base(serial)
        {
        }
