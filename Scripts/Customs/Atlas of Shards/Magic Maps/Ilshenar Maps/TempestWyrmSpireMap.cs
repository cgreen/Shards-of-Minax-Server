...
{
    public class TempestWyrmSpireMap : MagicMapBase
    {
        ...
        [Constructable]
        public TempestWyrmSpireMap()
            : base(0x14EB, "Map to Tempest Wyrm Spire", 650)
        {
        }

        public TempestWyrmSpireMap(Serial serial)
            : base(serial)
        {
        }
