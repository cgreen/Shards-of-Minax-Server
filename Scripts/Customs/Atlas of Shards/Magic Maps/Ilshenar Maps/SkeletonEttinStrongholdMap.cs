...
{
    public class SkeletonEttinStrongholdMap : MagicMapBase
    {
        ...
        [Constructable]
        public SkeletonEttinStrongholdMap()
            : base(0x14EB, "Map to Skeleton Ettin Stronghold", 650)
        {
        }

        public SkeletonEttinStrongholdMap(Serial serial)
            : base(serial)
        {
        }
