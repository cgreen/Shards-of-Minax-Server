...
{
    public class VortexGuardianKeepMap : MagicMapBase
    {
        ...
        [Constructable]
        public VortexGuardianKeepMap()
            : base(0x14EB, "Map to Vortex Guardian Keep", 650)
        {
        }

        public VortexGuardianKeepMap(Serial serial)
            : base(serial)
        {
        }
