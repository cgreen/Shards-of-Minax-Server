...
{
    public class VenomousEttinCaveMap : MagicMapBase
    {
        ...
        [Constructable]
        public VenomousEttinCaveMap()
            : base(0x14EB, "Map to Venomous Ettin Cave", 650)
        {
        }

        public VenomousEttinCaveMap(Serial serial)
            : base(serial)
        {
        }
