...
{
    public class LairOfTheEnigmaticSatyrGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEnigmaticSatyrGroveMap()
            : base(0x14EB, "Map to Lair of the Enigmatic Satyr Grove", 550)
        {
        }

        public LairOfTheEnigmaticSatyrGroveMap(Serial serial)
            : base(serial)
        {
        }
