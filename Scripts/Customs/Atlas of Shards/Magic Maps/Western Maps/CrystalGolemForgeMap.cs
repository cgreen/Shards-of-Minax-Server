...
{
    public class CrystalGolemForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrystalGolemForgeMap()
            : base(0x14EB, "Map to Crystal Golem Forge", 550)
        {
        }

        public CrystalGolemForgeMap(Serial serial)
            : base(serial)
        {
        }
