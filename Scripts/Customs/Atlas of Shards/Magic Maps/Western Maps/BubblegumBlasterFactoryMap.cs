...
{
    public class BubblegumBlasterFactoryMap : MagicMapBase
    {
        ...
        [Constructable]
        public BubblegumBlasterFactoryMap()
            : base(0x14EB, "Map to Bubblegum Blaster Factory", 550)
        {
        }

        public BubblegumBlasterFactoryMap(Serial serial)
            : base(serial)
        {
        }
