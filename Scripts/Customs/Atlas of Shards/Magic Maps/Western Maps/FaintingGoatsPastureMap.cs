...
{
    public class FaintingGoatsPastureMap : MagicMapBase
    {
        ...
        [Constructable]
        public FaintingGoatsPastureMap()
            : base(0x14EB, "Map to Fainting Goats Pasture", 550)
        {
        }

        public FaintingGoatsPastureMap(Serial serial)
            : base(serial)
        {
        }
