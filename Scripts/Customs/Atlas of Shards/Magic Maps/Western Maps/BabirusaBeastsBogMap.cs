...
{
    public class BabirusaBeastsBogMap : MagicMapBase
    {
        ...
        [Constructable]
        public BabirusaBeastsBogMap()
            : base(0x14EB, "Map to Babirusa Beasts Bog", 550)
        {
        }

        public BabirusaBeastsBogMap(Serial serial)
            : base(serial)
        {
        }
