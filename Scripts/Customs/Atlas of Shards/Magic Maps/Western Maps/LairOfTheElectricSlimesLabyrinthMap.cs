...
{
    public class LairOfTheElectricSlimesLabyrinthMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheElectricSlimesLabyrinthMap()
            : base(0x14EB, "Map to Lair of the Electric Slimes Labyrinth", 550)
        {
        }

        public LairOfTheElectricSlimesLabyrinthMap(Serial serial)
            : base(serial)
        {
        }
