...
{
    public class FlamebringerOgreLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public FlamebringerOgreLairMap()
            : base(0x14EB, "Map to Flamebringer Ogre Lair", 550)
        {
        }

        public FlamebringerOgreLairMap(Serial serial)
            : base(serial)
        {
        }
