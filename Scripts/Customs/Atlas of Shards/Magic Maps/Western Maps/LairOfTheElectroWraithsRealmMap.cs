...
{
    public class LairOfTheElectroWraithsRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheElectroWraithsRealmMap()
            : base(0x14EB, "Map to Lair of the Electro Wraiths Realm", 550)
        {
        }

        public LairOfTheElectroWraithsRealmMap(Serial serial)
            : base(serial)
        {
        }
