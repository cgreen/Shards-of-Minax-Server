...
{
    public class CholeraRatInfestationMap : MagicMapBase
    {
        ...
        [Constructable]
        public CholeraRatInfestationMap()
            : base(0x14EB, "Map to Cholera Rat Infestation", 550)
        {
        }

        public CholeraRatInfestationMap(Serial serial)
            : base(serial)
        {
        }
