...
{
    public class AzureMiragesRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public AzureMiragesRealmMap()
            : base(0x14EB, "Map to Azure Mirages Realm", 550)
        {
        }

        public AzureMiragesRealmMap(Serial serial)
            : base(serial)
        {
        }
