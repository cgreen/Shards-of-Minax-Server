...
{
    public class EtherealPanthrasLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public EtherealPanthrasLairMap()
            : base(0x14EB, "Map to Ethereal Panthras Lair", 550)
        {
        }

        public EtherealPanthrasLairMap(Serial serial)
            : base(serial)
        {
        }
