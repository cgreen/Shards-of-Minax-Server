...
{
    public class LairOfTheChocolateTruffleMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheChocolateTruffleMap()
            : base(0x14EB, "Map to Lair of the  Chocolate Truffle", 550)
        {
        }

        public LairOfTheChocolateTruffleMap(Serial serial)
            : base(serial)
        {
        }
