...
{
    public class CelestialWolfDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialWolfDenMap()
            : base(0x14EB, "Map to Celestial Wolf Den", 550)
        {
        }

        public CelestialWolfDenMap(Serial serial)
            : base(serial)
        {
        }
