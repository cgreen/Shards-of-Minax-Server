...
{
    public class AcidicSlimesLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public AcidicSlimesLairMap()
            : base(0x14EB, "Map to Acidic Slimes Lair", 550)
        {
        }

        public AcidicSlimesLairMap(Serial serial)
            : base(serial)
        {
        }
