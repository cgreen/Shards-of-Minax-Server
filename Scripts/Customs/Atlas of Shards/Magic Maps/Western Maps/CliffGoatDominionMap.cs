...
{
    public class CliffGoatDominionMap : MagicMapBase
    {
        ...
        [Constructable]
        public CliffGoatDominionMap()
            : base(0x14EB, "Map to Cliff Goat Dominion", 550)
        {
        }

        public CliffGoatDominionMap(Serial serial)
            : base(serial)
        {
        }
