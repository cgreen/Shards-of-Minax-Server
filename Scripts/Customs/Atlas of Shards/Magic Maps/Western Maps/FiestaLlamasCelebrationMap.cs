...
{
    public class FiestaLlamasCelebrationMap : MagicMapBase
    {
        ...
        [Constructable]
        public FiestaLlamasCelebrationMap()
            : base(0x14EB, "Map to Fiesta Llamas Celebration", 550)
        {
        }

        public FiestaLlamasCelebrationMap(Serial serial)
            : base(serial)
        {
        }
