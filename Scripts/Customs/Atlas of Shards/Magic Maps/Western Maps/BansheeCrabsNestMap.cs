...
{
    public class BansheeCrabsNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public BansheeCrabsNestMap()
            : base(0x14EB, "Map to Banshee Crabs Nest", 550)
        {
        }

        public BansheeCrabsNestMap(Serial serial)
            : base(serial)
        {
        }
