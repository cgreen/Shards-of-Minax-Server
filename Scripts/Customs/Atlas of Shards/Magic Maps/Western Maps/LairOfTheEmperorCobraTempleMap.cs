...
{
    public class LairOfTheEmperorCobraTempleMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEmperorCobraTempleMap()
            : base(0x14EB, "Map to Lair of the Emperor Cobra Temple", 550)
        {
        }

        public LairOfTheEmperorCobraTempleMap(Serial serial)
            : base(serial)
        {
        }
