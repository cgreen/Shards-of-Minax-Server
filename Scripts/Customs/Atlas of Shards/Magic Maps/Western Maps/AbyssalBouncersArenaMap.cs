...
{
    public class AbyssalBouncersArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public AbyssalBouncersArenaMap()
            : base(0x14EB, "Map to Abyssal Bouncers Arena", 550)
        {
        }

        public AbyssalBouncersArenaMap(Serial serial)
            : base(serial)
        {
        }
