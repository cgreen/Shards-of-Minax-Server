...
{
    public class AlbertsSquirrelGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public AlbertsSquirrelGladeMap()
            : base(0x14EB, "Map to Alberts Squirrel Glade", 550)
        {
        }

        public AlbertsSquirrelGladeMap(Serial serial)
            : base(serial)
        {
        }
