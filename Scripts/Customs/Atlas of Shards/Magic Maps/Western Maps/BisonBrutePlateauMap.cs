...
{
    public class BisonBrutePlateauMap : MagicMapBase
    {
        ...
        [Constructable]
        public BisonBrutePlateauMap()
            : base(0x14EB, "Map to Bison Brute Plateau", 550)
        {
        }

        public BisonBrutePlateauMap(Serial serial)
            : base(serial)
        {
        }
