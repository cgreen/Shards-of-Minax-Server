...
{
    public class AbyssalTidesSurgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public AbyssalTidesSurgeMap()
            : base(0x14EB, "Map to Abyssal Tides Surge", 550)
        {
        }

        public AbyssalTidesSurgeMap(Serial serial)
            : base(serial)
        {
        }
