...
{
    public class AkhenatensHereticShrineMap : MagicMapBase
    {
        ...
        [Constructable]
        public AkhenatensHereticShrineMap()
            : base(0x14EB, "Map to Akhenatens Heretic Shrine", 550)
        {
        }

        public AkhenatensHereticShrineMap(Serial serial)
            : base(serial)
        {
        }
