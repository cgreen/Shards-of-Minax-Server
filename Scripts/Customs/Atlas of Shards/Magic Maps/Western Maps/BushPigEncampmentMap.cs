...
{
    public class BushPigEncampmentMap : MagicMapBase
    {
        ...
        [Constructable]
        public BushPigEncampmentMap()
            : base(0x14EB, "Map to Bush Pig Encampment", 550)
        {
        }

        public BushPigEncampmentMap(Serial serial)
            : base(serial)
        {
        }
