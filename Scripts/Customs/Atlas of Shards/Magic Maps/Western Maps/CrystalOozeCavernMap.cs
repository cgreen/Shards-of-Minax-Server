...
{
    public class CrystalOozeCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrystalOozeCavernMap()
            : base(0x14EB, "Map to Crystal Ooze Cavern", 550)
        {
        }

        public CrystalOozeCavernMap(Serial serial)
            : base(serial)
        {
        }
