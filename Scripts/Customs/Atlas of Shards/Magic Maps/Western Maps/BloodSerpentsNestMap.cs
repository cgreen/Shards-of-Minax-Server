...
{
    public class BloodSerpentsNestMap : MagicMapBase
    {
        ...
        [Constructable]
        public BloodSerpentsNestMap()
            : base(0x14EB, "Map to Blood Serpents Nest", 550)
        {
        }

        public BloodSerpentsNestMap(Serial serial)
            : base(serial)
        {
        }
