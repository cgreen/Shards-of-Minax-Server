...
{
    public class CactusLlamaGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public CactusLlamaGroveMap()
            : base(0x14EB, "Map to Cactus Llama Grove", 550)
        {
        }

        public CactusLlamaGroveMap(Serial serial)
            : base(serial)
        {
        }
