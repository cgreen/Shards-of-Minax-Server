...
{
    public class LairOfTheChaosHareMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheChaosHareMap()
            : base(0x14EB, "Map to Lair of the  Chaos Hare", 550)
        {
        }

        public LairOfTheChaosHareMap(Serial serial)
            : base(serial)
        {
        }
