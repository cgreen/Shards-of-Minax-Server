...
{
    public class CursedWhiteTailForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public CursedWhiteTailForestMap()
            : base(0x14EB, "Map to Cursed White Tail Forest", 550)
        {
        }

        public CursedWhiteTailForestMap(Serial serial)
            : base(serial)
        {
        }
