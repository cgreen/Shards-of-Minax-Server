...
{
    public class AlphaBaboonTroopMap : MagicMapBase
    {
        ...
        [Constructable]
        public AlphaBaboonTroopMap()
            : base(0x14EB, "Map to Alpha Baboon Troop", 550)
        {
        }

        public AlphaBaboonTroopMap(Serial serial)
            : base(serial)
        {
        }
