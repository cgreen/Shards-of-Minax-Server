...
{
    public class EasternGraySquirrelGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public EasternGraySquirrelGroveMap()
            : base(0x14EB, "Map to Eastern Gray Squirrel Grove", 550)
        {
        }

        public EasternGraySquirrelGroveMap(Serial serial)
            : base(serial)
        {
        }
