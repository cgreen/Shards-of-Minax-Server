...
{
    public class CancerHarpyAerieMap : MagicMapBase
    {
        ...
        [Constructable]
        public CancerHarpyAerieMap()
            : base(0x14EB, "Map to Cancer Harpy Aerie", 550)
        {
        }

        public CancerHarpyAerieMap(Serial serial)
            : base(serial)
        {
        }
