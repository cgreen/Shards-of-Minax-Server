...
{
    public class LairOfTheEldritchHaresWarrenMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEldritchHaresWarrenMap()
            : base(0x14EB, "Map to Lair of the Eldritch Hares Warren", 550)
        {
        }

        public LairOfTheEldritchHaresWarrenMap(Serial serial)
            : base(serial)
        {
        }
