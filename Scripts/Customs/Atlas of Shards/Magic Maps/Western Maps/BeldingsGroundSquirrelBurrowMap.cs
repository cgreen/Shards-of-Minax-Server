...
{
    public class BeldingsGroundSquirrelBurrowMap : MagicMapBase
    {
        ...
        [Constructable]
        public BeldingsGroundSquirrelBurrowMap()
            : base(0x14EB, "Map to Beldings Ground Squirrel Burrow", 550)
        {
        }

        public BeldingsGroundSquirrelBurrowMap(Serial serial)
            : base(serial)
        {
        }
