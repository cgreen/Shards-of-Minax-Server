...
{
    public class BoneGolemsWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public BoneGolemsWorkshopMap()
            : base(0x14EB, "Map to Bone Golems Workshop", 550)
        {
        }

        public BoneGolemsWorkshopMap(Serial serial)
            : base(serial)
        {
        }
