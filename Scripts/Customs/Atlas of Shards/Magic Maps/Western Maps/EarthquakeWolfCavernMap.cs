...
{
    public class EarthquakeWolfCavernMap : MagicMapBase
    {
        ...
        [Constructable]
        public EarthquakeWolfCavernMap()
            : base(0x14EB, "Map to Earthquake Wolf Cavern", 550)
        {
        }

        public EarthquakeWolfCavernMap(Serial serial)
            : base(serial)
        {
        }
