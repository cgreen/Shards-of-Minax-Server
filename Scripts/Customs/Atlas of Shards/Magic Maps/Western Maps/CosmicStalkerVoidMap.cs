...
{
    public class CosmicStalkerVoidMap : MagicMapBase
    {
        ...
        [Constructable]
        public CosmicStalkerVoidMap()
            : base(0x14EB, "Map to Cosmic Stalker Void", 550)
        {
        }

        public CosmicStalkerVoidMap(Serial serial)
            : base(serial)
        {
        }
