...
{
    public class CaramelConjurersWorkshopMap : MagicMapBase
    {
        ...
        [Constructable]
        public CaramelConjurersWorkshopMap()
            : base(0x14EB, "Map to Caramel Conjurers Workshop", 550)
        {
        }

        public CaramelConjurersWorkshopMap(Serial serial)
            : base(serial)
        {
        }
