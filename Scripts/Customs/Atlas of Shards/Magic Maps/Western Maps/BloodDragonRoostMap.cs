...
{
    public class BloodDragonRoostMap : MagicMapBase
    {
        ...
        [Constructable]
        public BloodDragonRoostMap()
            : base(0x14EB, "Map to Blood Dragon Roost", 550)
        {
        }

        public BloodDragonRoostMap(Serial serial)
            : base(serial)
        {
        }
