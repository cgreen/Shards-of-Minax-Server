...
{
    public class CoralSentinelsReefMap : MagicMapBase
    {
        ...
        [Constructable]
        public CoralSentinelsReefMap()
            : base(0x14EB, "Map to Coral Sentinels Reef", 550)
        {
        }

        public CoralSentinelsReefMap(Serial serial)
            : base(serial)
        {
        }
