...
{
    public class CelestialHorrorRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialHorrorRealmMap()
            : base(0x14EB, "Map to Celestial Horror Realm", 550)
        {
        }

        public CelestialHorrorRealmMap(Serial serial)
            : base(serial)
        {
        }
