...
{
    public class CancerShellBearDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public CancerShellBearDenMap()
            : base(0x14EB, "Map to Cancer Shell Bear Den", 550)
        {
        }

        public CancerShellBearDenMap(Serial serial)
            : base(serial)
        {
        }
