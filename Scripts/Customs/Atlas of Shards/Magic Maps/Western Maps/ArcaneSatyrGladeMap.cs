...
{
    public class ArcaneSatyrGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public ArcaneSatyrGladeMap()
            : base(0x14EB, "Map to Arcane Satyr Glade", 550)
        {
        }

        public ArcaneSatyrGladeMap(Serial serial)
            : base(serial)
        {
        }
