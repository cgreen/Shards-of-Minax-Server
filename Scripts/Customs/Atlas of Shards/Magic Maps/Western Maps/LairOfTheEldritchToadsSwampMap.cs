...
{
    public class LairOfTheEldritchToadsSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEldritchToadsSwampMap()
            : base(0x14EB, "Map to Lair of the Eldritch Toads Swamp", 550)
        {
        }

        public LairOfTheEldritchToadsSwampMap(Serial serial)
            : base(serial)
        {
        }
