...
{
    public class AbyssalPanthersProwlMap : MagicMapBase
    {
        ...
        [Constructable]
        public AbyssalPanthersProwlMap()
            : base(0x14EB, "Map to Abyssal Panthers Prowl", 550)
        {
        }

        public AbyssalPanthersProwlMap(Serial serial)
            : base(serial)
        {
        }
