...
{
    public class FlameborneKnightsFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public FlameborneKnightsFortressMap()
            : base(0x14EB, "Map to Flameborne Knights Fortress", 550)
        {
        }

        public FlameborneKnightsFortressMap(Serial serial)
            : base(serial)
        {
        }
