...
{
    public class LairOfTheEmberWolfDenMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEmberWolfDenMap()
            : base(0x14EB, "Map to Lair of the Ember Wolf Den", 550)
        {
        }

        public LairOfTheEmberWolfDenMap(Serial serial)
            : base(serial)
        {
        }
