...
{
    public class DreadnaughtFortressMap : MagicMapBase
    {
        ...
        [Constructable]
        public DreadnaughtFortressMap()
            : base(0x14EB, "Map to Dreadnaught Fortress", 550)
        {
        }

        public DreadnaughtFortressMap(Serial serial)
            : base(serial)
        {
        }
