...
{
    public class LairOfTheEnigmaticSkipperReefMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEnigmaticSkipperReefMap()
            : base(0x14EB, "Map to Lair of the Enigmatic Skipper Reef", 550)
        {
        }

        public LairOfTheEnigmaticSkipperReefMap(Serial serial)
            : base(serial)
        {
        }
