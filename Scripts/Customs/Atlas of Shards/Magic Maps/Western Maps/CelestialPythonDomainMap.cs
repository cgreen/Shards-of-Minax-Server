...
{
    public class CelestialPythonDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialPythonDomainMap()
            : base(0x14EB, "Map to Celestial Python Domain", 550)
        {
        }

        public CelestialPythonDomainMap(Serial serial)
            : base(serial)
        {
        }
