...
{
    public class CapricornMountainBearsDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public CapricornMountainBearsDomainMap()
            : base(0x14EB, "Map to Capricorn Mountain Bears Domain", 550)
        {
        }

        public CapricornMountainBearsDomainMap(Serial serial)
            : base(serial)
        {
        }
