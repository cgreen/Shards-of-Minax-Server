...
{
    public class BengalStormsJungleMap : MagicMapBase
    {
        ...
        [Constructable]
        public BengalStormsJungleMap()
            : base(0x14EB, "Map to Bengal Storms Jungle", 550)
        {
        }

        public BengalStormsJungleMap(Serial serial)
            : base(serial)
        {
        }
