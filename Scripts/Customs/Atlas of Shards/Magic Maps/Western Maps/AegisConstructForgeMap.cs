...
{
    public class AegisConstructForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public AegisConstructForgeMap()
            : base(0x14EB, "Map to Aegis Construct Forge", 550)
        {
        }

        public AegisConstructForgeMap(Serial serial)
            : base(serial)
        {
        }
