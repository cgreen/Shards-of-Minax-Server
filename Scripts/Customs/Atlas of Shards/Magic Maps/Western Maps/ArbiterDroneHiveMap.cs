...
{
    public class ArbiterDroneHiveMap : MagicMapBase
    {
        ...
        [Constructable]
        public ArbiterDroneHiveMap()
            : base(0x14EB, "Map to Arbiter Drone Hive", 550)
        {
        }

        public ArbiterDroneHiveMap(Serial serial)
            : base(serial)
        {
        }
