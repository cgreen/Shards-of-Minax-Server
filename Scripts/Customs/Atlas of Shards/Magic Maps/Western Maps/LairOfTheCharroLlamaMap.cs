...
{
    public class LairOfTheCharroLlamaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheCharroLlamaMap()
            : base(0x14EB, "Map to Lair of the  Charro Llama", 550)
        {
        }

        public LairOfTheCharroLlamaMap(Serial serial)
            : base(serial)
        {
        }
