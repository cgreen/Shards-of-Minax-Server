...
{
    public class CosmicBouncerArenaMap : MagicMapBase
    {
        ...
        [Constructable]
        public CosmicBouncerArenaMap()
            : base(0x14EB, "Map to Cosmic Bouncer Arena", 550)
        {
        }

        public CosmicBouncerArenaMap(Serial serial)
            : base(serial)
        {
        }
