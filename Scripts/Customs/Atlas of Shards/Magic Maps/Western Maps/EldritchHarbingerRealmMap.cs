...
{
    public class EldritchHarbingerRealmMap : MagicMapBase
    {
        ...
        [Constructable]
        public EldritchHarbingerRealmMap()
            : base(0x14EB, "Map to Eldritch Harbinger Realm", 550)
        {
        }

        public EldritchHarbingerRealmMap(Serial serial)
            : base(serial)
        {
        }
