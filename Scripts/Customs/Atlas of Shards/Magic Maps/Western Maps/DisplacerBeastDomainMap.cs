...
{
    public class DisplacerBeastDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public DisplacerBeastDomainMap()
            : base(0x14EB, "Map to Displacer Beast Domain", 550)
        {
        }

        public DisplacerBeastDomainMap(Serial serial)
            : base(serial)
        {
        }
