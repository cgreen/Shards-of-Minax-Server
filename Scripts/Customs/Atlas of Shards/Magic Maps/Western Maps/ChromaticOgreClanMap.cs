...
{
    public class ChromaticOgreClanMap : MagicMapBase
    {
        ...
        [Constructable]
        public ChromaticOgreClanMap()
            : base(0x14EB, "Map to Chromatic Ogre Clan", 550)
        {
        }

        public ChromaticOgreClanMap(Serial serial)
            : base(serial)
        {
        }
