...
{
    public class BloodthirstyVinesThicketMap : MagicMapBase
    {
        ...
        [Constructable]
        public BloodthirstyVinesThicketMap()
            : base(0x14EB, "Map to Bloodthirsty Vines Thicket", 550)
        {
        }

        public BloodthirstyVinesThicketMap(Serial serial)
            : base(serial)
        {
        }
