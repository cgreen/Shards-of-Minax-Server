...
{
    public class BlackDeathRatSewersMap : MagicMapBase
    {
        ...
        [Constructable]
        public BlackDeathRatSewersMap()
            : base(0x14EB, "Map to Black Death Rat Sewers", 550)
        {
        }

        public BlackDeathRatSewersMap(Serial serial)
            : base(serial)
        {
        }
