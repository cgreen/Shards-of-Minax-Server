...
{
    public class AriesRamBearPlateauMap : MagicMapBase
    {
        ...
        [Constructable]
        public AriesRamBearPlateauMap()
            : base(0x14EB, "Map to Aries Ram Bear Plateau", 550)
        {
        }

        public AriesRamBearPlateauMap(Serial serial)
            : base(serial)
        {
        }
