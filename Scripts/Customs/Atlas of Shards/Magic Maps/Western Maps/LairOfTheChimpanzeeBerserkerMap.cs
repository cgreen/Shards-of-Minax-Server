...
{
    public class LairOfTheChimpanzeeBerserkerMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheChimpanzeeBerserkerMap()
            : base(0x14EB, "Map to Lair of the  Chimpanzee Berserker", 550)
        {
        }

        public LairOfTheChimpanzeeBerserkerMap(Serial serial)
            : base(serial)
        {
        }
