...
{
    public class CelestialSatyrGroveMap : MagicMapBase
    {
        ...
        [Constructable]
        public CelestialSatyrGroveMap()
            : base(0x14EB, "Map to Celestial Satyr Grove", 550)
        {
        }

        public CelestialSatyrGroveMap(Serial serial)
            : base(serial)
        {
        }
