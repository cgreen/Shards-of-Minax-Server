...
{
    public class BlightedToadSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public BlightedToadSwampMap()
            : base(0x14EB, "Map to Blighted Toad Swamp", 550)
        {
        }

        public BlightedToadSwampMap(Serial serial)
            : base(serial)
        {
        }
