...
{
    public class EclipseReindeerGladeMap : MagicMapBase
    {
        ...
        [Constructable]
        public EclipseReindeerGladeMap()
            : base(0x14EB, "Map to Eclipse Reindeer Glade", 550)
        {
        }

        public EclipseReindeerGladeMap(Serial serial)
            : base(serial)
        {
        }
