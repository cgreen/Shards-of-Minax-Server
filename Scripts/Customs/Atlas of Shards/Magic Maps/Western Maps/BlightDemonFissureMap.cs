...
{
    public class BlightDemonFissureMap : MagicMapBase
    {
        ...
        [Constructable]
        public BlightDemonFissureMap()
            : base(0x14EB, "Map to Blight Demon Fissure", 550)
        {
        }

        public BlightDemonFissureMap(Serial serial)
            : base(serial)
        {
        }
