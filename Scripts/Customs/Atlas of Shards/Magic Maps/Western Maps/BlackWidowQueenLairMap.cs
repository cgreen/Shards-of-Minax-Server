...
{
    public class BlackWidowQueenLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public BlackWidowQueenLairMap()
            : base(0x14EB, "Map to Black Widow Queen Lair", 550)
        {
        }

        public BlackWidowQueenLairMap(Serial serial)
            : base(serial)
        {
        }
