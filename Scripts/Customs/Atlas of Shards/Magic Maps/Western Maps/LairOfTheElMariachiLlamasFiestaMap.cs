...
{
    public class LairOfTheElMariachiLlamasFiestaMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheElMariachiLlamasFiestaMap()
            : base(0x14EB, "Map to Lair of the El Mariachi Llamas Fiesta", 550)
        {
        }

        public LairOfTheElMariachiLlamasFiestaMap(Serial serial)
            : base(serial)
        {
        }
