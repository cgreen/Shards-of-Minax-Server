...
{
    public class LairOfTheEmberAxisForgeMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheEmberAxisForgeMap()
            : base(0x14EB, "Map to Lair of the Ember Axis Forge", 550)
        {
        }

        public LairOfTheEmberAxisForgeMap(Serial serial)
            : base(serial)
        {
        }
