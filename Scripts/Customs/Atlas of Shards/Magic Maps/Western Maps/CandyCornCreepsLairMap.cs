...
{
    public class CandyCornCreepsLairMap : MagicMapBase
    {
        ...
        [Constructable]
        public CandyCornCreepsLairMap()
            : base(0x14EB, "Map to Candy Corn Creeps Lair", 550)
        {
        }

        public CandyCornCreepsLairMap(Serial serial)
            : base(serial)
        {
        }
