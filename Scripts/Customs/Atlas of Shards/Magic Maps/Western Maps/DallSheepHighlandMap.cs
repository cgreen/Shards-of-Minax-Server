...
{
    public class DallSheepHighlandMap : MagicMapBase
    {
        ...
        [Constructable]
        public DallSheepHighlandMap()
            : base(0x14EB, "Map to Dall Sheep Highland", 550)
        {
        }

        public DallSheepHighlandMap(Serial serial)
            : base(serial)
        {
        }
