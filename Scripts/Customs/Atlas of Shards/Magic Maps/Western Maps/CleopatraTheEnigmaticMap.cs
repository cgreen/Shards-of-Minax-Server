...
{
    public class CleopatraTheEnigmaticMap : MagicMapBase
    {
        ...
        [Constructable]
        public CleopatraTheEnigmaticMap()
            : base(0x14EB, "Map to Cleopatra the Enigmatic", 550)
        {
        }

        public CleopatraTheEnigmaticMap(Serial serial)
            : base(serial)
        {
        }
