...
{
    public class CrimsonMuleValleyMap : MagicMapBase
    {
        ...
        [Constructable]
        public CrimsonMuleValleyMap()
            : base(0x14EB, "Map to Crimson Mule Valley", 550)
        {
        }

        public CrimsonMuleValleyMap(Serial serial)
            : base(serial)
        {
        }
