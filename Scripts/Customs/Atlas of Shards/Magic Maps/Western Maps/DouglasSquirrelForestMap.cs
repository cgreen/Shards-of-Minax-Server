...
{
    public class DouglasSquirrelForestMap : MagicMapBase
    {
        ...
        [Constructable]
        public DouglasSquirrelForestMap()
            : base(0x14EB, "Map to Douglas Squirrel Forest", 550)
        {
        }

        public DouglasSquirrelForestMap(Serial serial)
            : base(serial)
        {
        }
