...
{
    public class BonecrusherOgresDomainMap : MagicMapBase
    {
        ...
        [Constructable]
        public BonecrusherOgresDomainMap()
            : base(0x14EB, "Map to Bonecrusher Ogres Domain", 550)
        {
        }

        public BonecrusherOgresDomainMap(Serial serial)
            : base(serial)
        {
        }
