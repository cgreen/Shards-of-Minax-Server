...
{
    public class CorrosiveToadSwampMap : MagicMapBase
    {
        ...
        [Constructable]
        public CorrosiveToadSwampMap()
            : base(0x14EB, "Map to Corrosive Toad Swamp", 550)
        {
        }

        public CorrosiveToadSwampMap(Serial serial)
            : base(serial)
        {
        }
