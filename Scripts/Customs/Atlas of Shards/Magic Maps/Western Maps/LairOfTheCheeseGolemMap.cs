...
{
    public class LairOfTheCheeseGolemMap : MagicMapBase
    {
        ...
        [Constructable]
        public LairOfTheCheeseGolemMap()
            : base(0x14EB, "Map to Lair of the  Cheese Golem", 550)
        {
        }

        public LairOfTheCheeseGolemMap(Serial serial)
            : base(serial)
        {
        }
