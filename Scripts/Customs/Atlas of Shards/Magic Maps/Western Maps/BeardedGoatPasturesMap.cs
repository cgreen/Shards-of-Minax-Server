...
{
    public class BeardedGoatPasturesMap : MagicMapBase
    {
        ...
        [Constructable]
        public BeardedGoatPasturesMap()
            : base(0x14EB, "Map to Bearded Goat Pastures", 550)
        {
        }

        public BeardedGoatPasturesMap(Serial serial)
            : base(serial)
        {
        }
