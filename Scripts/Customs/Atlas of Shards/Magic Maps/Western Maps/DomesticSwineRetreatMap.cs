...
{
    public class DomesticSwineRetreatMap : MagicMapBase
    {
        ...
        [Constructable]
        public DomesticSwineRetreatMap()
            : base(0x14EB, "Map to Domestic Swine Retreat", 550)
        {
        }

        public DomesticSwineRetreatMap(Serial serial)
            : base(serial)
        {
        }
