...
{
    public class AcereraksNecropolisMap : MagicMapBase
    {
        ...
        [Constructable]
        public AcereraksNecropolisMap()
            : base(0x14EB, "Map to Acereraks Necropolis", 550)
        {
        }

        public AcereraksNecropolisMap(Serial serial)
            : base(serial)
        {
        }
