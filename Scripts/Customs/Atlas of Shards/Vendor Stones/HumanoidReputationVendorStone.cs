...
{
    public class HumanoidReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public HumanoidReputationVendorStone()
        {
            Name = "Humanoid Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Humanoid‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Humanoid property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Humanoid", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Humanoid faction level.
            //
			// inside HumanoidReputationVendorStone()
			// Humanoid Faction Powerscroll Vendor Stock
        ...
        public HumanoidReputationVendorStone(Serial serial) : base(serial) { }
