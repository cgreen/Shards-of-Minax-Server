...
{
    public class FairieReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public FairieReputationVendorStone()
        {
            Name = "Fairie Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Fairie‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Fairie property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Fairie", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Fairie faction level.
            //
			// inside FairieReputationVendorStone()
        ...
        public FairieReputationVendorStone(Serial serial) : base(serial) { }
