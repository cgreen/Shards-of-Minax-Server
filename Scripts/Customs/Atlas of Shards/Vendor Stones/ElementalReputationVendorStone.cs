...
{
    public class ElementalReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public ElementalReputationVendorStone()
        {
            Name = "Elemental Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Elemental‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Elemental property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Elemental", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Elemental faction level.
            //
			// inside ElementalReputationVendorStone()
        ...
        public ElementalReputationVendorStone(Serial serial) : base(serial) { }
