...
{
    public class ReptilianReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public ReptilianReputationVendorStone()
        {
            Name = "Reptilian Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Reptilian‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Reptilian property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Reptilian", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Reptilian faction level.
            //
			// inside ReptilianReputationVendorStone()
        ...
        public ReptilianReputationVendorStone(Serial serial) : base(serial) { }
