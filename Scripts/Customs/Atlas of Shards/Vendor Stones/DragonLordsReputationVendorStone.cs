...
{
    public class DragonLordsReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public DragonLordsReputationVendorStone()
        {
            Name = "DragonLords Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s DragonLords‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.DragonLords property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("DragonLords", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their DragonLords faction level.
            //
			// inside DragonLordsReputationVendorStone()
        ...
        public DragonLordsReputationVendorStone(Serial serial) : base(serial) { }
