...
{
    public class ArachnidReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public ArachnidReputationVendorStone()
        {
            Name = "Arachnid Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Arachnid‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Arachnid property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Arachnid", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Arachnid faction level.
            //
			// inside ArachnidReputationVendorStone()
        ...
        public ArachnidReputationVendorStone(Serial serial) : base(serial) { }
