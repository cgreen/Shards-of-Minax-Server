...
{
    public class UnderworldReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public UnderworldReputationVendorStone()
        {
            Name = "Underworld Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Underworld‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Underworld property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Underworld", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Underworld faction level.
            //
			// inside UnderworldReputationVendorStone()
        ...
        public UnderworldReputationVendorStone(Serial serial) : base(serial) { }
