...
{
    public class AbyssReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public AbyssReputationVendorStone()
        {
            Name = "Abyss Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s Abyss‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.Abyss property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("Abyss", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their Abyss faction level.
            //
			// inside AbyssReputationVendorStone()
        ...
        public AbyssReputationVendorStone(Serial serial) : base(serial) { }
