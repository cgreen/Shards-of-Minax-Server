...
{
    public class NecroMastersReputationVendorStone : StoneRewardVendor
    {
        [Constructable]
        public NecroMastersReputationVendorStone()
        {
            Name = "NecroMasters Reputation Vendor";
            Hue  = 1161;    // choose whatever hue you like
            Movable = false;

            //
            // 1) Bind our vendor’s “coins” to the player’s NecroMasters‐faction value.
            //
            ...
            //    - attachProp: the XmlMobFactions.NecroMasters property
            //
            var attachType = typeof(XmlMobFactions);
            var prop       = attachType.GetProperty("NecroMasters", BindingFlags.Public | BindingFlags.Instance);
            ...
            //
            // 2) Add whatever stock you like.  Players will “pay” by reducing their NecroMasters faction level.
            //
			// inside NecroMastersReputationVendorStone()
        ...
        public NecroMastersReputationVendorStone(Serial serial) : base(serial) { }
