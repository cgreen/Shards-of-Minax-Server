...
namespace Server.Items
{
    ...
    public abstract class FillableContainer : LockableContainer
    {
		...
		private static readonly FillableEntry[] SpecialItems = new FillableEntry[]
		{
			...
			new FillableEntry(1, typeof(UnidentifiedArmor)),
			new FillableEntry(1, typeof(UnidentifiedShield)),
			new FillableEntry(1, typeof(UnidentifiedJewelry)),
			new FillableEntry(1, typeof(UnidentifiedClothing)),
			new FillableEntry(1, typeof(UnidentifiedWeapon)),
			new FillableEntry(1, typeof(UnidentifiedPotion)),
			new FillableEntry(1, typeof(UnidentifiedCrystal)),
			new FillableEntry(1, typeof(UnidentifiedCuriosity)),
			new FillableEntry(1, typeof(UnidentifiedMagicMap)),
			new FillableEntry(1, typeof(UnidentifiedOrb)),
			new FillableEntry(1, typeof(UnidentifiedDocument)),
			new FillableEntry(1, typeof(UnidentifiedTreasure)),
			new FillableEntry(1, typeof(UnidentifiedArmor)),
			new FillableEntry(1, typeof(UnidentifiedShield)),
			new FillableEntry(1, typeof(UnidentifiedJewelry)),
			new FillableEntry(1, typeof(UnidentifiedClothing)),
