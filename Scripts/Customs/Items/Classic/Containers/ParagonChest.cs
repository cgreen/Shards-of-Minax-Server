...
namespace Server.Items
{
    ...
    public class ParagonChest : LockableContainer
    {
        ...
        {
            typeof(Apple),
			typeof(UnidentifiedArmor),
			typeof(UnidentifiedShield),
			typeof(UnidentifiedJewelry),
			typeof(UnidentifiedClothing),
			typeof(UnidentifiedWeapon),
			typeof(UnidentifiedPotion),
			typeof(UnidentifiedCrystal),
			typeof(UnidentifiedCuriosity),
			typeof(UnidentifiedMagicMap),
			typeof(UnidentifiedOrb),
			typeof(UnidentifiedDocument),
			typeof(UnidentifiedTreasure),
			typeof(UnidentifiedArmor),
			typeof(UnidentifiedShield),
			typeof(UnidentifiedJewelry),
			typeof(UnidentifiedClothing),
