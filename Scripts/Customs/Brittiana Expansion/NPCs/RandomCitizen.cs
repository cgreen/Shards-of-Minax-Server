...
namespace Server.Mobiles
{
    ...
    public class RandomCitizen : BaseCreature
    {
        ...
        {
            private readonly RandomCitizen _npc;
            private readonly Mobile _from;

            public QuestEntry(Mobile from, RandomCitizen npc)
        ...
        // Persistence
        public RandomCitizen(Serial serial) : base(serial) { }
