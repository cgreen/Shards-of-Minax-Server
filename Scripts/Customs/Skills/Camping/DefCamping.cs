...
namespace Server.Engines.Craft
{
    ...
    public class DefCamping : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(PoisonersKit), "Thieves Tools", "Poisoners Kit", 100.0, 100.0, typeof(Leather), "Leather", 12, 1044037);
            AddSkill(index, SkillName.Alchemy, 50.0, 50.0);
        }
    }
}
