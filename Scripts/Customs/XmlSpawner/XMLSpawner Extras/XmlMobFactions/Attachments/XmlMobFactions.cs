...
namespace Server.Engines.XmlSpawner2
{
	public class XmlMobFactions : XmlAttachment
	{
		...
		public static new void Initialize()
		{
			...
			Group BritainGroup = new Group();
			Group TrinsicGroup = new Group();
			Group VesperGroup = new Group();
			Group YewGroup = new Group();
			Group MinocGroup = new Group();
			Group JhelomGroup = new Group();
			Group MoonglowGroup = new Group();
			Group MaginciaGroup = new Group();
			Group SkaraBraeGroup = new Group();
			Group CoveGroup = new Group();
			Group BuccaneersDenGroup = new Group();
			Group NujelmGroup = new Group();
			Group OclloGroup = new Group();
			Group SerpentsHoldGroup = new Group();
			Group WindGroup = new Group();
			Group NewHavenGroup = new Group();
			Group EldermoorGroup = new Group();
			Group FrostmereGroup = new Group();
			Group AerilonGroup = new Group();
			Group HinokamiGroup = new Group();
			Group VerdantTribesGroup = new Group();
			Group QasariaGroup = new Group();
			Group SunreachGroup = new Group();			
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public int Britain { get { return GetFactionLevel(GroupTypes.Britain); } set { SetFactionLevel(GroupTypes.Britain,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Trinsic { get { return GetFactionLevel(GroupTypes.Trinsic); } set { SetFactionLevel(GroupTypes.Trinsic,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Vesper { get { return GetFactionLevel(GroupTypes.Vesper); } set { SetFactionLevel(GroupTypes.Vesper,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Yew { get { return GetFactionLevel(GroupTypes.Yew); } set { SetFactionLevel(GroupTypes.Yew,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Minoc { get { return GetFactionLevel(GroupTypes.Minoc); } set { SetFactionLevel(GroupTypes.Minoc,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Jhelom { get { return GetFactionLevel(GroupTypes.Jhelom); } set { SetFactionLevel(GroupTypes.Jhelom,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Moonglow { get { return GetFactionLevel(GroupTypes.Moonglow); } set { SetFactionLevel(GroupTypes.Moonglow,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Magincia { get { return GetFactionLevel(GroupTypes.Magincia); } set { SetFactionLevel(GroupTypes.Magincia,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int SkaraBrae { get { return GetFactionLevel(GroupTypes.SkaraBrae); } set { SetFactionLevel(GroupTypes.SkaraBrae,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Cove { get { return GetFactionLevel(GroupTypes.Cove); } set { SetFactionLevel(GroupTypes.Cove,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int BuccaneersDen { get { return GetFactionLevel(GroupTypes.BuccaneersDen); } set { SetFactionLevel(GroupTypes.BuccaneersDen,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Nujelm { get { return GetFactionLevel(GroupTypes.Nujelm); } set { SetFactionLevel(GroupTypes.Nujelm,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Ocllo { get { return GetFactionLevel(GroupTypes.Ocllo); } set { SetFactionLevel(GroupTypes.Ocllo,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int SerpentsHold { get { return GetFactionLevel(GroupTypes.SerpentsHold); } set { SetFactionLevel(GroupTypes.SerpentsHold,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Wind { get { return GetFactionLevel(GroupTypes.Wind); } set { SetFactionLevel(GroupTypes.Wind,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int NewHaven { get { return GetFactionLevel(GroupTypes.NewHaven); } set { SetFactionLevel(GroupTypes.NewHaven,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Eldermoor { get { return GetFactionLevel(GroupTypes.Eldermoor); } set { SetFactionLevel(GroupTypes.Eldermoor,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Frostmere { get { return GetFactionLevel(GroupTypes.Frostmere); } set { SetFactionLevel(GroupTypes.Frostmere,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Aerilon { get { return GetFactionLevel(GroupTypes.Aerilon); } set { SetFactionLevel(GroupTypes.Aerilon,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Hinokami { get { return GetFactionLevel(GroupTypes.Hinokami); } set { SetFactionLevel(GroupTypes.Hinokami,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int VerdantTribes { get { return GetFactionLevel(GroupTypes.VerdantTribes); } set { SetFactionLevel(GroupTypes.VerdantTribes,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Qasaria { get { return GetFactionLevel(GroupTypes.Qasaria); } set { SetFactionLevel(GroupTypes.Qasaria,value); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int Sunreach { get { return GetFactionLevel(GroupTypes.Sunreach); } set { SetFactionLevel(GroupTypes.Sunreach,value); } }
		...
		public override void OnKill(Mobile killed, Mobile killer )
		{
			...
			foreach(List<XmlMobFactions.Group> al in alist)
			{
				...
				{
					int honorLoss = Math.Max(1, (int)value);   // value = Fame / 1000 earlier
					FactionHonorSystem.LoseHonor(g.GroupType, honorLoss);
