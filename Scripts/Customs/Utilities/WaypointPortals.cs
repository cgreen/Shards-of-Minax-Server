...
namespace Server.PortalWaypoints
{
    ...
    public class WaypointPortal : Item
    {
        ...
        static WaypointPortal()
        {
            ...
            new WaypointEntry("New Haven T", new Point3D(3504, 2566, 20), Map.Trammel ),
            ...
            new WaypointEntry("Hinokami", new Point3D(1973, 3202, 6), Map.Trammel ),
            new WaypointEntry("Eldermoor", new Point3D(2335, 3306, 0), Map.Trammel ),
            new WaypointEntry("Frostmere", new Point3D(4436, 370, 19), Map.Trammel ),
            new WaypointEntry("Qasaria", new Point3D(3980, 1649, 0), Map.Trammel ),
            new WaypointEntry("Sunreach", new Point3D(4586, 2108, 0), Map.Trammel ),
            new WaypointEntry("Verdant Tribes", new Point3D(1855, 3378, 0), Map.Trammel ),
            new WaypointEntry("Verdant Tribes 2", new Point3D(1855, 3378, 0), Map.Trammel )
