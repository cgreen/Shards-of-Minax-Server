...
{
    public class BrickHomeWithLargePorch : BaseHouse
    {
        ...
        public BrickHomeWithLargePorch(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new BrickHomeWithLargePorchAddon();
        ...
        public BrickHomeWithLargePorch(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new BrickHomeWithLargePorchDeed();
        }
