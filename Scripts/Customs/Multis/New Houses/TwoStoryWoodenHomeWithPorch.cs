...
{
    public class TwoStoryWoodenHomeWithPorch : BaseHouse
    {
        ...
        public TwoStoryWoodenHomeWithPorch(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
            uint keyValue = CreateKeys(owner);
			
			AddSouthDoors(true, -3, 3, 5);
			AddEastDoors(true, 1, 1, 25);			
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStoryWoodenHomeWithPorchAddon();
        ...
        public TwoStoryWoodenHomeWithPorch(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStoryWoodenHomeWithPorchDeed();
        }
