...
{
    public class SmallLogCabin : BaseHouse
    {
        ...
        public SmallLogCabin(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallLogCabinAddon();
        ...
        public SmallLogCabin(Serial serial)
            : base(serial)
        {
        }
