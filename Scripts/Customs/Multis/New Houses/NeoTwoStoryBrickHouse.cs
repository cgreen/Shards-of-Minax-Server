...
{
    public class NeoTwoStoryBrickHouse : BaseHouse
    {
            ...
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new NeoTwoStoryBrickHouseAddon();
        ...
        public NeoTwoStoryBrickHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new NeoTwoStoryBrickHouseDeed();
        }
