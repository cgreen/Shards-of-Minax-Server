...
{
    public class NeoTwoStorySandstoneHouse : BaseHouse
    {
        ...
        public NeoTwoStorySandstoneHouse(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
            uint keyValue = CreateKeys(owner);
			
			AddEastDoors(6, -1, 6, keyValue);
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new NeoTwoStorySandstoneHouseAddon();
        ...
        public NeoTwoStorySandstoneHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new NeoTwoStorySandstoneHouseDeed();
        }
