...
{
    public class SmallStoneTemple : BaseHouse
    {
        ...
        public SmallStoneTemple(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallStoneTempleAddon();
        ...
        public SmallStoneTemple(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallStoneTempleDeed();
        }
