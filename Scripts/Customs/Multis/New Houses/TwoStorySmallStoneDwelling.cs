...
{
    public class TwoStorySmallStoneDwelling : BaseHouse
    {
        ...
        public TwoStorySmallStoneDwelling(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStorySmallStoneDwellingAddon();
        ...
        public TwoStorySmallStoneDwelling(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStorySmallStoneDwellingDeed();
        }
