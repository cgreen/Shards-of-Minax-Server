...
{
    public class SmallBrickCastle : BaseHouse
    {
        ...
        public SmallBrickCastle(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallBrickCastleAddon();
        ...
        public SmallBrickCastle(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallBrickCastleDeed();
        }
