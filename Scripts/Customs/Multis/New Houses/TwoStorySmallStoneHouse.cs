...
{
    public class TwoStorySmallStoneHouse : BaseHouse
    {
        ...
        public TwoStorySmallStoneHouse(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStorySmallStoneHouseAddon();
        ...
        public TwoStorySmallStoneHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStorySmallStoneHouseDeed();
        }
