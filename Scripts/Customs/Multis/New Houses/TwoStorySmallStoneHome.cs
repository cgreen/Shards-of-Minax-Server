...
{
    public class TwoStorySmallStoneHome : BaseHouse
    {
        ...
        public TwoStorySmallStoneHome(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStorySmallStoneHomeAddon();
        ...
        public TwoStorySmallStoneHome(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStorySmallStoneHomeDeed();
        }
