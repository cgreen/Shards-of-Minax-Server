...
{
    public class SmallStoneTower : BaseHouse
    {
        ...
        public SmallStoneTower(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallStoneTowerAddon();
        ...
        public SmallStoneTower(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallStoneTowerDeed();
        }
