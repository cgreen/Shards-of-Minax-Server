...
{
    public class StoneHomeWithEnclosedPatio : BaseHouse
    {
        ...
        public StoneHomeWithEnclosedPatio(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {

			SetSign( 7, 0, 0 );

			AddSouthDoor( 0, 3, 5, 0x6A5 );
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new StoneHomeWithEnclosedPatioAddon();
        ...
        public StoneHomeWithEnclosedPatio(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new StoneHomeWithEnclosedPatioDeed();
        }
