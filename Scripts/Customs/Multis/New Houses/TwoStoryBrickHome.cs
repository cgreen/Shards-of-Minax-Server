...
{
    public class TwoStoryBrickHome : BaseHouse
    {
        ...
        public TwoStoryBrickHome(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
            uint keyValue = CreateKeys(owner);
			
			AddSouthDoors(true, 0, 6, 5);
			
			AddSouthDoor( 2, -1, 5, 0x6A7 );
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStoryBrickHomeAddon();
        ...
        public TwoStoryBrickHome(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStoryBrickHomeDeed();
        }
