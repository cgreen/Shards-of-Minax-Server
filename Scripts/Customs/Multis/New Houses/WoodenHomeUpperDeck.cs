...
{
    public class WoodenHomeUpperDeck : BaseHouse
    {
        ...
        public WoodenHomeUpperDeck(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new WoodenHomeUpperDeckAddon();
        ...
        public WoodenHomeUpperDeck(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new WoodenHomeUpperDeckDeed();
        }
