...
{
    public class FancyWoodenStoneHouse : BaseHouse
    {
        ...
        public FancyWoodenStoneHouse(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new FancyWoodenStoneHouseAddon();
        ...
        public FancyWoodenStoneHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new FancyWoodenStoneHouseDeed();
        }
