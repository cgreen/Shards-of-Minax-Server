...
{
    public class PlainStoneHouse : BaseHouse
    {
        ...
        public PlainStoneHouse(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new PlainStoneHouseAddon();
        ...
        public PlainStoneHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new PlainStoneHouseDeed();
        }
