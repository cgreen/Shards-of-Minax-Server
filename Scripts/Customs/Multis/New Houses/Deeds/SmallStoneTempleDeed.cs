...
{
    public class SmallStoneTempleDeed : HouseDeed
    {
        [Constructable]
        public SmallStoneTempleDeed()
        ...
        {
			Name = "Small Stone Temple Deed";
        }

        public SmallStoneTempleDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallStoneTemple.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallStoneTemple(owner);
        }
