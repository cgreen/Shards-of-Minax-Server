...
{
    public class NeoTwoStoryBrickHouseDeed : HouseDeed
    {
        [Constructable]
        public NeoTwoStoryBrickHouseDeed()
        ...
        {
			Name = "Neo TwoStory BrickHouse Deed";
        }

        public NeoTwoStoryBrickHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return NeoTwoStoryBrickHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new NeoTwoStoryBrickHouse(owner);
        }
