...
{
    public class BrickHomeWithFrontDeckDeed : HouseDeed
    {
        [Constructable]
        public BrickHomeWithFrontDeckDeed()
        ...
        {
			Name = "Brick Home With Front Deck Deed";
        }

        public BrickHomeWithFrontDeckDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return BrickHomeWithFrontDeck.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new BrickHomeWithFrontDeck(owner);
        }
