...
{
    public class TwoStoryStoneVillaDeed : HouseDeed
    {
        [Constructable]
        public TwoStoryStoneVillaDeed()
        ...
        {
			Name = "Two-Story Stone Villa Deed";
        }

        public TwoStoryStoneVillaDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStoryStoneVilla.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStoryStoneVilla(owner);
        }
