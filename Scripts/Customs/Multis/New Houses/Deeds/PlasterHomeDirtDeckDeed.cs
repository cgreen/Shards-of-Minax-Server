...
{
    public class PlasterHomeDirtDeckDeed : HouseDeed
    {
        [Constructable]
        public PlasterHomeDirtDeckDeed()
        ...
        {
			Name = "Plaster Home Dirt-Deck Deed";
        }

        public PlasterHomeDirtDeckDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return PlasterHomeDirtDeck.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new PlasterHomeDirtDeck(owner);
        }
