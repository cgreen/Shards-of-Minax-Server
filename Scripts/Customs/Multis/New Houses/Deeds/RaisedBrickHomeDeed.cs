...
{
    public class RaisedBrickHomeDeed : HouseDeed
    {
        [Constructable]
        public RaisedBrickHomeDeed()
        ...
        {
			Name = "Raised Brick Home Deed";
        }

        public RaisedBrickHomeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return RaisedBrickHome.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new RaisedBrickHome(owner);
        }
