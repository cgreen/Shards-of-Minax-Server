...
{
    public class OldStoneHomeShoppeDeed : HouseDeed
    {
        [Constructable]
        public OldStoneHomeShoppeDeed()
        ...
        {
			Name = "Old Stone Home Shoppe Deed";
        }

        public OldStoneHomeShoppeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return OldStoneHomeShoppe.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new OldStoneHomeShoppe(owner);
        }
