...
{
    public class SmallWoodenShackPorchDeed : HouseDeed
    {
        [Constructable]
        public SmallWoodenShackPorchDeed()
        ...
        {
			Name = "Small Wooden Shack Porch Deed";
        }

        public SmallWoodenShackPorchDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallWoodenShackPorch.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallWoodenShackPorch(owner);
        }
