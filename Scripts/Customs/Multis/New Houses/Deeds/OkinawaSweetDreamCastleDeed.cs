...
{
    public class OkinawaSweetDreamCastleDeed : HouseDeed
    {
        [Constructable]
        public OkinawaSweetDreamCastleDeed()
        ...
        {
			Name = "Okinawa Sweet Dream Castle Deed";
        }

        public OkinawaSweetDreamCastleDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return OkinawaSweetDreamCastle.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new OkinawaSweetDreamCastle(owner);
        }
