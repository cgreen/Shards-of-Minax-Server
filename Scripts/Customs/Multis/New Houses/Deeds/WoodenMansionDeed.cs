...
{
    public class WoodenMansionDeed : HouseDeed
    {
        [Constructable]
        public WoodenMansionDeed()
        ...
        {
			Name = "Wooden Mansion Deed";
        }

        public WoodenMansionDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return WoodenMansion.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new WoodenMansion(owner);
        }
