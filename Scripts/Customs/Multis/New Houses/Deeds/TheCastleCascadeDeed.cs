...
{
    public class TheCastleCascadeDeed : HouseDeed
    {
        [Constructable]
        public TheCastleCascadeDeed()
        ...
        {
			Name = "The Castle Cascade Deed";
        }

        public TheCastleCascadeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheCastleCascade(owner);
        }
