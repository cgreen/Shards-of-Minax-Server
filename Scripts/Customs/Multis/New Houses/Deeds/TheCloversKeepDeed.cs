...
{
    public class TheCloversKeepDeed : HouseDeed
    {
        [Constructable]
        public TheCloversKeepDeed()
        ...
        {
			Name = "The Clovers Keep Deed";
        }

        public TheCloversKeepDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TheCloversKeep.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TheCloversKeep(owner);
        }
