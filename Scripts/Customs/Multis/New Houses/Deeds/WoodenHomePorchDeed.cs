...
{
    public class WoodenHomePorchDeed : HouseDeed
    {
        [Constructable]
        public WoodenHomePorchDeed()
        ...
        {
			Name = "Wooden Home Porch Deed";
        }

        public WoodenHomePorchDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return WoodenHomePorch.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new WoodenHomePorch(owner);
        }
