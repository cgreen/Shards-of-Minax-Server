...
{
    public class SmallWizardTowerDeed : HouseDeed
    {
        [Constructable]
        public SmallWizardTowerDeed()
        ...
        {
			Name = "Small Wizard Tower Deed";
        }

        public SmallWizardTowerDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallWizardTower.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallWizardTower(owner);
        }
