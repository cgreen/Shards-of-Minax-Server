...
{
    public class SmallStoneTowerDeed : HouseDeed
    {
        [Constructable]
        public SmallStoneTowerDeed()
        ...
        public SmallStoneTowerDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallStoneTower.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallStoneTower(owner);
        }
