...
{
    public class TwoStorySmallStoneHouseDeed : HouseDeed
    {
        [Constructable]
        public TwoStorySmallStoneHouseDeed()
        ...
        {
			Name = "Two-Story Small Stone House Deed";
        }

        public TwoStorySmallStoneHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStorySmallStoneHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStorySmallStoneHouse(owner);
        }
