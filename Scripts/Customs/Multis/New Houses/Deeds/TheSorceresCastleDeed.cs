...
{
    public class TheSorceresCastleDeed : HouseDeed
    {
        [Constructable]
        public TheSorceresCastleDeed()
        ...
        {
			Name = "The Sorceres Castle Deed";
        }

        public TheSorceresCastleDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheSorceresCastle(owner);
        }
