...
{
    public class BrickArenaDeed : HouseDeed
    {
        [Constructable]
        public BrickArenaDeed()
        ...
        {
			Name = "Brick Arena Deed";
        }

        public BrickArenaDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return BrickArena.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new BrickArena(owner);
        }
