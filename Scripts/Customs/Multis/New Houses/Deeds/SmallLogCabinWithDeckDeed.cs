...
{
    public class SmallLogCabinWithDeckDeed : HouseDeed
    {
        [Constructable]
        public SmallLogCabinWithDeckDeed()
        ...
        {
			Name = "Small Log Cabin With Deck Deed";
        }

        public SmallLogCabinWithDeckDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallLogCabinWithDeck.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallLogCabinWithDeck(owner);
        }
