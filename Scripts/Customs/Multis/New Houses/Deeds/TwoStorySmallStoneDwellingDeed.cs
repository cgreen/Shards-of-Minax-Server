...
{
    public class TwoStorySmallStoneDwellingDeed : HouseDeed
    {
        [Constructable]
        public TwoStorySmallStoneDwellingDeed()
        ...
        {
			Name = "Two-Story Small Stone Dwelling Deed";
        }

        public TwoStorySmallStoneDwellingDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStorySmallStoneDwelling.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStorySmallStoneDwelling(owner);
        }
