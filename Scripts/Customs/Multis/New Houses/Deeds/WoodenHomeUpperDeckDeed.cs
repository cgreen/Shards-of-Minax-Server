...
{
    public class WoodenHomeUpperDeckDeed : HouseDeed
    {
        [Constructable]
        public WoodenHomeUpperDeckDeed()
        ...
        {
			Name = "Wooden Home Upper-Deck Deed";
        }

        public WoodenHomeUpperDeckDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return WoodenHomeUpperDeck.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new WoodenHomeUpperDeck(owner);
        }
