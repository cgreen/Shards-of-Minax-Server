...
{
    public class TheHouseBuiltOnTheRuinsDeed : HouseDeed
    {
        [Constructable]
        public TheHouseBuiltOnTheRuinsDeed()
        ...
        {
			Name = "The House Built On The Ruins";
        }

        public TheHouseBuiltOnTheRuinsDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TheHouseBuiltOnTheRuins.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TheHouseBuiltOnTheRuins(owner);
        }
