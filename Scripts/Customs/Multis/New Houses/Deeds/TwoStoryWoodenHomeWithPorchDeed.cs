...
{
    public class TwoStoryWoodenHomeWithPorchDeed : HouseDeed
    {
        [Constructable]
        public TwoStoryWoodenHomeWithPorchDeed()
        ...
        public TwoStoryWoodenHomeWithPorchDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStoryWoodenHomeWithPorch.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStoryWoodenHomeWithPorch(owner);
        }
