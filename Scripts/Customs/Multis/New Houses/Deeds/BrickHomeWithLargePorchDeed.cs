...
{
    public class BrickHomeWithLargePorchDeed : HouseDeed
    {
        [Constructable]
        public BrickHomeWithLargePorchDeed()
        ...
        {
			Name = "Brick Home With Large Porch Deed";
        }

        public BrickHomeWithLargePorchDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return BrickHomeWithLargePorch.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new BrickHomeWithLargePorch(owner);
        }
