...
{
    public class TheTerraceGardensDeed : HouseDeed
    {
        [Constructable]
        public TheTerraceGardensDeed()
        ...
        {
			Name = "The Terrace Gardens Deed";
        }

        public TheTerraceGardensDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TheTerraceGardens.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TheTerraceGardens(owner);
        }
