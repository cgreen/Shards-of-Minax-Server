...
{
    public class SmallStoneStoreFrontDeed : HouseDeed
    {
        [Constructable]
        public SmallStoneStoreFrontDeed()
        ...
        {
			Name = "Small Stone Store-Front Deed";
        }

        public SmallStoneStoreFrontDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallStoneStoreFront.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallStoneStoreFront(owner);
        }
