...
{
    public class FancyWoodenStoneHouseDeed : HouseDeed
    {
        [Constructable]
        public FancyWoodenStoneHouseDeed()
        ...
        {
			Name = "Fancy Wooden-Stone House Deed";
        }

        public FancyWoodenStoneHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return FancyWoodenStoneHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new FancyWoodenStoneHouse(owner);
        }
