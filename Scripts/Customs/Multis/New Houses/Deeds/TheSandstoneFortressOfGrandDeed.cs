...
{
    public class TheSandstoneFortressOfGrandDeed : HouseDeed
    {
        [Constructable]
        public TheSandstoneFortressOfGrandDeed()
        ...
        {
			Name = "The Sandstone Fortress Of Grand Deed";
        }

        public TheSandstoneFortressOfGrandDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheSandstoneFortressOfGrand(owner);
        }
