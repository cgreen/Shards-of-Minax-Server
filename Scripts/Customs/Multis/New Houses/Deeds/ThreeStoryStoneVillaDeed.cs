...
{
    public class ThreeStoryStoneVillaDeed : HouseDeed
    {
        [Constructable]
        public ThreeStoryStoneVillaDeed()
        ...
        {
			Name = "Three-Story Stone Villa Deed";
        }

        public ThreeStoryStoneVillaDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return ThreeStoryStoneVilla.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new ThreeStoryStoneVilla(owner);
        }
