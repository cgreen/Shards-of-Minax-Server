...
{
    public class KeepIncarceratedDeed : HouseDeed
    {
        [Constructable]
        public KeepIncarceratedDeed()
        ...
        {
			Name = "Keep Incarcerated Deed";
        }

        public KeepIncarceratedDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return KeepIncarcerated.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new KeepIncarcerated(owner);
        }
