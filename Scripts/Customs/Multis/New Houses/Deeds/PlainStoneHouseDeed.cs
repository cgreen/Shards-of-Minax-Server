...
{
    public class PlainStoneHouseDeed : HouseDeed
    {
        [Constructable]
        public PlainStoneHouseDeed()
        ...
        {
			Name = "Plain Stone-House Deed";
        }

        public PlainStoneHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return PlainStoneHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new PlainStoneHouse(owner);
        }
