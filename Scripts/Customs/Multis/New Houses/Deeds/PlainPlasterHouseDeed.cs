...
{
    public class PlainPlasterHouseDeed : HouseDeed
    {
        [Constructable]
        public PlainPlasterHouseDeed()
        ...
        {
			Name = "Plain Plaster-House Deed";
        }

        public PlainPlasterHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return PlainPlasterHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new PlainPlasterHouse(owner);
        }
