...
{
    public class TheRavenloftKeepDeed : HouseDeed
    {
        [Constructable]
        public TheRavenloftKeepDeed()
        ...
        {
			Name = "The Ravenloft Keep Deed";
        }

        public TheRavenloftKeepDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheRavenloftKeep(owner);
        }
