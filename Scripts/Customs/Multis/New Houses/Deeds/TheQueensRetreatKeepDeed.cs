...
{
    public class TheQueensRetreatKeepDeed : HouseDeed
    {
        [Constructable]
        public TheQueensRetreatKeepDeed()
        ...
        {
			Name = "The Queens Retreat Keep Deed";
        }

        public TheQueensRetreatKeepDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheQueensRetreatKeep(owner);
        }
