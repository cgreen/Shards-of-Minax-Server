...
{
    public class StoneHomeWithEnclosedPatioDeed : HouseDeed
    {
        [Constructable]
        public StoneHomeWithEnclosedPatioDeed()
        ...
        {
			Name = "Stone Home With Enclosed Patio Deed";
        }

        public StoneHomeWithEnclosedPatioDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return StoneHomeWithEnclosedPatio.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new StoneHomeWithEnclosedPatio(owner);
        }
