...
{
    public class PlasterHousePictureWindowDeed : HouseDeed
    {
        [Constructable]
        public PlasterHousePictureWindowDeed()
        ...
        {
			Name = "Plaster House with Picture Window Deed";
        }

        public PlasterHousePictureWindowDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return PlasterHousePictureWindow.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new PlasterHousePictureWindow(owner);
        }
