...
{
    public class MarbleShoppeDeed : HouseDeed
    {
        [Constructable]
        public MarbleShoppeDeed()
        ...
        {
			Name = "Marble Shoppe Deed";
        }

        public MarbleShoppeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return MarbleShoppe.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new MarbleShoppe(owner);
        }
