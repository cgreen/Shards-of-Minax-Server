...
{
    public class TheSandstoneCastleDeed : HouseDeed
    {
        [Constructable]
        public TheSandstoneCastleDeed()
        ...
        {
			Name = "The Sandstone Castle Deed";
        }

        public TheSandstoneCastleDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TheSandstoneCastle(owner);
        }
