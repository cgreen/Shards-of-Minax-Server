...
{
    public class SmallLogCabinDeed : HouseDeed
    {
        [Constructable]
        public SmallLogCabinDeed()
        ...
        {
			Name = "Small Log Cabin Deed";
        }

        public SmallLogCabinDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallLogCabin.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallLogCabin(owner);
        }
