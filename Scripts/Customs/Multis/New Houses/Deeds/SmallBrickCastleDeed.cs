...
{
    public class SmallBrickCastleDeed : HouseDeed
    {
        [Constructable]
        public SmallBrickCastleDeed()
        ...
        {
			Name = "Small Brick Castle Deed";
        }

        public SmallBrickCastleDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallBrickCastle.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallBrickCastle(owner);
        }
