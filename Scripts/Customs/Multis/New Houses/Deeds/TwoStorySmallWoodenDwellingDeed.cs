...
{
    public class TwoStorySmallWoodenDwellingDeed : HouseDeed
    {
        [Constructable]
        public TwoStorySmallWoodenDwellingDeed()
        ...
        {
			Name = "Two-Story Small Wooden Dwelling Deed";
        }

        public TwoStorySmallWoodenDwellingDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStorySmallWoodenDwelling.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStorySmallWoodenDwelling(owner);
        }
