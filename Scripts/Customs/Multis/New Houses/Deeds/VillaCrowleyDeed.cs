...
{
    public class VillaCrowleyDeed : HouseDeed
    {
        [Constructable]
        public VillaCrowleyDeed()
        ...
        {
			Name = "Villa Crowley Deed";
        }

        public VillaCrowleyDeed(Serial serial)
            : base(serial)
        {
        }
