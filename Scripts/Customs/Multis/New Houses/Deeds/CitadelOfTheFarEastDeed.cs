...
{
    public class CitadelOfTheFarEastDeed : HouseDeed
    {
        [Constructable]
        public CitadelOfTheFarEastDeed()
        ...
        {
			Name = "Citadel Of The Far East Deed";
        }

        public CitadelOfTheFarEastDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new CitadelOfTheFarEast(owner);
        }
