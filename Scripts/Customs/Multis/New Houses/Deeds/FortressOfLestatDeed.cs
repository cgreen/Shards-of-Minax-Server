...
{
    public class FortressOfLestatDeed : HouseDeed
    {
        [Constructable]
        public FortressOfLestatDeed()
        ...
        {
			Name = "Fortress Of Lestat Deed";
        }

        public FortressOfLestatDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new FortressOfLestat(owner);
        }
