...
{
    public class GrimswindSistersDeed : HouseDeed
    {
        [Constructable]
        public GrimswindSistersDeed()
        ...
        {
			Name = "Grimswind Sisters Deed";
        }

        public GrimswindSistersDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return GrimswindSisters.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new GrimswindSisters(owner);
        }
