...
{
    public class SmallStoneShoppeDeed : HouseDeed
    {
        [Constructable]
        public SmallStoneShoppeDeed()
        ...
        {
			Name = "Small Stone Shoppe Deed";
        }

        public SmallStoneShoppeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return SmallStoneShoppe.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new SmallStoneShoppe(owner);
        }
