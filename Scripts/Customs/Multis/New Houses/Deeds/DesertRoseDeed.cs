...
{
    public class DesertRoseDeed : HouseDeed
    {
        [Constructable]
        public DesertRoseDeed()
        ...
        {
			Name = "Desert Rose Deed";
        }

        public DesertRoseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return DesertRose.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new DesertRose(owner);
        }
