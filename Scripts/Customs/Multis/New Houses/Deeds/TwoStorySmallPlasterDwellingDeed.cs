...
{
    public class TwoStorySmallPlasterDwellingDeed : HouseDeed
    {
        [Constructable]
        public TwoStorySmallPlasterDwellingDeed()
        ...
        {
			Name = "Two-Story Small Plaster Dwelling Deed";
        }

        public TwoStorySmallPlasterDwellingDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStorySmallPlasterDwelling.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStorySmallPlasterDwelling(owner);
        }
