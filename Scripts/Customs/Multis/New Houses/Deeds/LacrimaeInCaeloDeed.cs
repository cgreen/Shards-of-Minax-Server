...
{
    public class LacrimaeInCaeloDeed : HouseDeed
    {
        [Constructable]
        public LacrimaeInCaeloDeed()
        ...
        {
			Name = "Lacrimae In Caelo Deed";
        }

        public LacrimaeInCaeloDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new LacrimaeInCaelo(owner);
        }
