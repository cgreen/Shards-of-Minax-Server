...
{
    public class NewCastleTowerDeed : HouseDeed
    {
        [Constructable]
        public NewCastleTowerDeed()
        ...
        {
			Name = "Castle Tower Deed";
        }

        public NewCastleTowerDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return NewCastleTower.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new NewCastleTower(owner);
        }
