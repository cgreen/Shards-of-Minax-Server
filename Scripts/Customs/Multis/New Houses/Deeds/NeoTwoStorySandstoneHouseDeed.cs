...
{
    public class NeoTwoStorySandstoneHouseDeed : HouseDeed
    {
        [Constructable]
        public NeoTwoStorySandstoneHouseDeed()
        ...
        {
			Name = "Two-Story Sandstone House Deed";
        }

        public NeoTwoStorySandstoneHouseDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return NeoTwoStorySandstoneHouse.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new NeoTwoStorySandstoneHouse(owner);
        }
