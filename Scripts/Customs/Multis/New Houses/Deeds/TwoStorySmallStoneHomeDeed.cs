...
{
    public class TwoStorySmallStoneHomeDeed : HouseDeed
    {
        [Constructable]
        public TwoStorySmallStoneHomeDeed()
        ...
        {
			Name = "Two-Story Small Stone Home Deed";
        }

        public TwoStorySmallStoneHomeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return TwoStorySmallStoneHome.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new TwoStorySmallStoneHome(owner);
        }
