...
{
    public class StoneFortDeed : HouseDeed
    {
        [Constructable]
        public StoneFortDeed()
        ...
        {
			Name = "Stone Fort Deed";
        }

        public StoneFortDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            get { return StoneFort.AreaArray; }
        }

        public override BaseHouse GetHouse(Mobile owner)
        {
            return new StoneFort(owner);
        }
