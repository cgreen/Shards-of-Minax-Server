...
{
    public class TwoStorySmallWoodenDwelling : BaseHouse
    {
        ...
        public TwoStorySmallWoodenDwelling(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStorySmallWoodenDwellingAddon();
        ...
        public TwoStorySmallWoodenDwelling(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStorySmallWoodenDwellingDeed();
        }
