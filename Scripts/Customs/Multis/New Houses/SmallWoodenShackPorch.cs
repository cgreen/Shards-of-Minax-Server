...
{
    public class SmallWoodenShackPorch : BaseHouse
    {
            ...
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallWoodenShackPorchAddon();
        ...
        public SmallWoodenShackPorch(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallWoodenShackPorchDeed();
        }
