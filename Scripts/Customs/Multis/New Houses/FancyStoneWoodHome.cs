...
{
    public class FancyStoneWoodHome : BaseHouse
    {
        ...
        public FancyStoneWoodHome(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new FancyStoneWoodHomeAddon();
        ...
        public FancyStoneWoodHome(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new FancyStoneWoodHomeDeed();
        }
