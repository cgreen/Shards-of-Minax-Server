...
{
    public class BrickArena : BaseHouse
    {
        ...
        public BrickArena(Mobile owner)
        ...
        public BrickArena(Serial serial)
            : base(serial)
        {
        }
