...
{
    public class PlainPlasterHouse : BaseHouse
    {
        ...
        public PlainPlasterHouse(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new PlainPlasterHouseAddon();
        ...
        public PlainPlasterHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new PlainPlasterHouseDeed();
        }
