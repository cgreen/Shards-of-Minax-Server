...
{
    public class BrickHomeWithFrontDeck : BaseHouse
    {
        ...
        public BrickHomeWithFrontDeck(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new BrickHomeWithFrontDeckAddon();
        ...
        public BrickHomeWithFrontDeck(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new BrickHomeWithFrontDeckDeed();
        }
