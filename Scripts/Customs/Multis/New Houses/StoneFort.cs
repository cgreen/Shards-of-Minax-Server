...
{
    public class StoneFort : BaseHouse
    {
            ...
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			AddSouthDoors(false,  0, 5, 7, keyValue);
        ...
        public StoneFort(Serial serial)
            : base(serial)
        {
        }
