...
{
    public class SmallStoneStoreFront : BaseHouse
    {
        ...
        public SmallStoneStoreFront(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallStoneStoreFrontAddon();
        ...
        public SmallStoneStoreFront(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallStoneStoreFrontDeed();
        }
