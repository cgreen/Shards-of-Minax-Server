...
{
    public class TwoStoryStoneVilla : BaseHouse
    {
        ...
        public TwoStoryStoneVilla(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new TwoStoryStoneVillaAddon();
        ...
        public TwoStoryStoneVilla(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new TwoStoryStoneVillaDeed();
        }
