...
{
    public class OldStoneHomeShoppe : BaseHouse
    {
        ...
        public OldStoneHomeShoppe(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new OldStoneHomeShoppeAddon();
        ...
        public OldStoneHomeShoppe(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new OldStoneHomeShoppeDeed();
        }
