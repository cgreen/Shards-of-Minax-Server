...
{
    public class MarbleShoppe : BaseHouse
    {
        ...
        public MarbleShoppe(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
			...
			AddEastDoor( -1, -3, 5, 0x6AF );
			AddSouthDoor( -2, -1, 5, 0x6A5 );
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new MarbleShoppeAddon();
        ...
        public MarbleShoppe(Serial serial)
            : base(serial)
        {
        }
