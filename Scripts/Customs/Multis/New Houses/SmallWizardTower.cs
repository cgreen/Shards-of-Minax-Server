...
{
    public class SmallWizardTower : BaseHouse
    {
        ...
        public SmallWizardTower(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
            ...
            AddSouthDoors(false, 1, 5, 5, keyValue);
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new SmallWizardTowerAddon();
        ...
        public SmallWizardTower(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new SmallWizardTowerDeed();
        }
