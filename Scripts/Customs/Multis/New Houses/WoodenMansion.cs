...
{
    public class WoodenMansion : BaseHouse
    {
        ...
        public WoodenMansion(Mobile owner)
            : base(0x4A, owner, 1370, 10) // <--- Adjust the lockdowns/secures as you wish
        {
            uint keyValue = CreateKeys(owner);
			
            AddEastDoors(1, 2, 5, keyValue);
			AddSouthDoors(true, 0, 0, 45);
			
			AddSouthDoor( -1, 0, 25, 0x6A5 );
			AddSouthDoor( 3, 0, 25, 0x6A7 );
			AddEastDoor( 0, -1, 25, 0x6AF );
			AddEastDoor( 1, -1, 5, 0x6AF );	
			...
			Timer.DelayCall( TimeSpan.Zero, () =>
			{
				...
				var addon = new WoodenMansionAddon();
        ...
        public WoodenMansion(Serial serial)
            : base(serial)
        {
        }
