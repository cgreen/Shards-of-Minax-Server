...
*/
		...
		public override void OnAfterSpawn()
		{
			...
			XmlSockets.ConfigureRandom(
				this, 20.0, 0.1, 0.5, 3.0, 15.0, 50.0,
        ...
        */
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
			...
			// --- make sockets visible ---
			if (XmlAttach.FindAttachment(this, typeof(XmlSockets)) is XmlSockets socks)
			{
				list.Add($"Sockets : {socks.NSockets}  ({socks.NFree} free)");
				//  └─ use any format / hue you prefer
			}
        ...
        public override void OnDeath(Container c)
        {
			...
			{
				LevelItemManager.CheckItems(killer, this);
			}
