...
{
    [CorpseName("an Magery master's corpse")]
    public class UltimateMageryMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateMageryMaster()
        {
            ...
            Title = "the ultimate Magery master";
            CantWalk = true;
        }

        public UltimateMageryMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Magery, "Magery", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Magery Master", "Magery"));
        }
    }
}
